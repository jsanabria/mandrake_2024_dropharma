 ...
 * Page class
 */
class PagoDestinoReglaDelete extends PagoDestinoRegla
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PagoDestinoReglaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PagoDestinoReglaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PagoDestinoReglaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("PagoDestinoReglaList"); // Return to list
                return;
            }
        }
