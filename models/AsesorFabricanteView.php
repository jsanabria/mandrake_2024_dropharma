 ...
 * Page class
 */
class AsesorFabricanteView extends AsesorFabricante
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AsesorFabricanteView";
    ...
    // CSS class/style
    public $CurrentPageName = "AsesorFabricanteView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "AsesorFabricanteList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "AsesorFabricanteList"; // No matching record, return to list
                    } else {
