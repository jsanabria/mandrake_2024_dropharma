 ...
 * Page class
 */
class FtpFactPediProcesadoView extends FtpFactPediProcesado
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FtpFactPediProcesadoView";
    ...
    // CSS class/style
    public $CurrentPageName = "FtpFactPediProcesadoView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "FtpFactPediProcesadoList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "FtpFactPediProcesadoList"; // No matching record, return to list
                    } else {
