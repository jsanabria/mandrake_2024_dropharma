 ...
 * Page class
 */
class ContPlanctaDelete extends ContPlancta
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContPlanctaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ContPlanctaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ContPlanctaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ContPlanctaList"); // Return to list
                return;
            }
        }
