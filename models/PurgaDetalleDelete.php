 ...
 * Page class
 */
class PurgaDetalleDelete extends PurgaDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PurgaDetalleDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PurgaDetalleDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PurgaDetalleList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("PurgaDetalleList"); // Return to list
                return;
            }
        }
