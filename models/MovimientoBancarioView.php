 ...
 * Page class
 */
class MovimientoBancarioView extends MovimientoBancario
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MovimientoBancarioView";
    ...
    // CSS class/style
    public $CurrentPageName = "MovimientoBancarioView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "MovimientoBancarioList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "MovimientoBancarioList"; // No matching record, return to list
                    } else {
