...
/**
 * Table class for nota_salida
 */
class NotaSalida extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "nota_salida";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("NotaSalidaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "NotaSalidaView" => $Language->phrase("View"),
            "NotaSalidaEdit" => $Language->phrase("Edit"),
            "NotaSalidaAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "NotaSalidaView",
            Config("API_ADD_ACTION") => "NotaSalidaAdd",
            Config("API_EDIT_ACTION") => "NotaSalidaEdit",
            Config("API_DELETE_ACTION") => "NotaSalidaDelete",
            Config("API_LIST_ACTION") => "NotaSalidaList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("NotaSalidaView", $parm);
        } else {
            $url = $this->keyUrl("NotaSalidaView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NotaSalidaEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NotaSalidaList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NotaSalidaAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NotaSalidaList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("NotaSalidaDelete", $parm);
        }
    }
