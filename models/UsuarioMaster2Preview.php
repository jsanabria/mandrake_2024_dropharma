 ...
 * Page class
 */
class UsuarioMaster2Preview extends UsuarioMaster2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UsuarioMaster2Preview";
    ...
    // CSS class/style
    public $CurrentPageName = "UsuarioMaster2Preview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "usuario") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=usuario&" . GetForeignKeyUrl("fk__username", $this->_username->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "usuario") {
            $this->_username->setQueryStringValue($keys[0] ?? "");
        }
    }
