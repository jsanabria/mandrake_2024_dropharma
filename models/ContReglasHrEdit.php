 ...
 * Page class
 */
class ContReglasHrEdit extends ContReglasHr
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContReglasHrEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ContReglasHrEdit";
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ContReglasHrList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "ContReglasHrList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ContReglasHrList") {
                            ...
                            $returnUrl = "ContReglasHrList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function validateForm()
    {
        ...
        if (in_array("cont_reglas", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("ContReglasGrid");
            if (in_array("cont_reglas", $detailTblVar) && $detailPage->DetailEdit && $editRow) {
                $Security->loadCurrentUserLevel($this->ProjectID . "cont_reglas"); // Load user level of detail table
