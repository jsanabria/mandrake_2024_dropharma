...
/**
 * Table class for items_deco
 */
class ItemsDeco extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // ITEM_NAME
        $this->ITEM_NAME = new DbField(
            $this, // Table
            'x_ITEM_NAME', // Variable name
            'ITEM_NAME', // Name
            '`ITEM_NAME`', // Expression
            '`ITEM_NAME`', // Basic search expression
            200, // Type
            150, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`ITEM_NAME`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->ITEM_NAME->InputTextType = "text";
        $this->ITEM_NAME->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "items_deco";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ItemsDecoList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ItemsDecoView" => $Language->phrase("View"),
            "ItemsDecoEdit" => $Language->phrase("Edit"),
            "ItemsDecoAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ItemsDecoView",
            Config("API_ADD_ACTION") => "ItemsDecoAdd",
            Config("API_EDIT_ACTION") => "ItemsDecoEdit",
            Config("API_DELETE_ACTION") => "ItemsDecoDelete",
            Config("API_LIST_ACTION") => "ItemsDecoList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ItemsDecoView", $parm);
        } else {
            $url = $this->keyUrl("ItemsDecoView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ItemsDecoEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ItemsDecoList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ItemsDecoAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ItemsDecoList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ItemsDecoDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        // ITEM_NAME
        $this->ITEM_NAME->setupEditAttributes();
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->ITEM_NAME);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->ITEM_NAME);
