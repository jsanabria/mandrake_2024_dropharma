...
/**
 * Table class for tarifa_art
 */
class TarifaArt extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "tarifa_art";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TarifaArtList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "TarifaArtView" => $Language->phrase("View"),
            "TarifaArtEdit" => $Language->phrase("Edit"),
            "TarifaArtAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "TarifaArtView",
            Config("API_ADD_ACTION") => "TarifaArtAdd",
            Config("API_EDIT_ACTION") => "TarifaArtEdit",
            Config("API_DELETE_ACTION") => "TarifaArtDelete",
            Config("API_LIST_ACTION") => "TarifaArtList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TarifaArtView", $parm);
        } else {
            $url = $this->keyUrl("TarifaArtView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifaArtEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifaArtList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifaArtAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifaArtList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TarifaArtDelete", $parm);
        }
    }
