 ...
 * Page class
 */
class TarifaDescuentoUtilidadEdit extends TarifaDescuentoUtilidad
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TarifaDescuentoUtilidadEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "TarifaDescuentoUtilidadEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("TarifaDescuentoUtilidadList"); // Return to list page
                        return;
    ...
    protected function getEditRow($rsold)
    {
        ...
        // utilidad
        $this->utilidad->setDbValueDef($rsnew, $this->utilidad->CurrentValue, $this->utilidad->ReadOnly);
        return $rsnew;
    }
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['utilidad'])) { // utilidad
            $this->utilidad->CurrentValue = $row['utilidad'];
        }
    }
