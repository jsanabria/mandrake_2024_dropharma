...
/**
 * Table class for view_facturas_vencidas
 */
class ViewFacturasVencidas extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_facturas_vencidas";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_facturas_vencidas";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewFacturasVencidasList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewFacturasVencidasView" => $Language->phrase("View"),
            "ViewFacturasVencidasEdit" => $Language->phrase("Edit"),
            "ViewFacturasVencidasAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "ViewFacturasVencidasList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewFacturasVencidasView",
            Config("API_ADD_ACTION") => "ViewFacturasVencidasAdd",
            Config("API_EDIT_ACTION") => "ViewFacturasVencidasEdit",
            Config("API_DELETE_ACTION") => "ViewFacturasVencidasDelete",
            Config("API_LIST_ACTION") => "ViewFacturasVencidasList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewFacturasVencidasView", $parm);
        } else {
            $url = $this->keyUrl("ViewFacturasVencidasView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewFacturasVencidasAdd?" . $parm;
        } else {
            $url = "ViewFacturasVencidasAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFacturasVencidasEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFacturasVencidasList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFacturasVencidasAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFacturasVencidasList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewFacturasVencidasDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ViewFacturasVencidasList";
    ...
    public function renderEditRow()
    {
        ...
        if (strval($this->dias_vencidos->EditValue) != "" && is_numeric($this->dias_vencidos->EditValue)) {
            $this->dias_vencidos->EditValue = $this->dias_vencidos->EditValue;
        }
