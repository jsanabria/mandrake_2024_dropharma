...
/**
 * Table class for cont_tercero_mdk
 */
class ContTerceroMdk extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "cont_tercero_mdk";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->tipo->Lookup = new Lookup($this->tipo, 'cont_tercero_mdk', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->origen_tabla->Nullable = false; // NOT NULL field
        $this->origen_tabla->Required = true; // Required field
        $this->origen_tabla->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->origen_id->Nullable = false; // NOT NULL field
        $this->origen_id->Required = true; // Required field
        $this->origen_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->origen_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->estado->Lookup = new Lookup($this->estado, 'cont_tercero_mdk', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "cont_tercero_mdk";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ContTerceroMdkList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ContTerceroMdkView" => $Language->phrase("View"),
            "ContTerceroMdkEdit" => $Language->phrase("Edit"),
            "ContTerceroMdkAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ContTerceroMdkView",
            Config("API_ADD_ACTION") => "ContTerceroMdkAdd",
            Config("API_EDIT_ACTION") => "ContTerceroMdkEdit",
            Config("API_DELETE_ACTION") => "ContTerceroMdkDelete",
            Config("API_LIST_ACTION") => "ContTerceroMdkList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ContTerceroMdkView", $parm);
        } else {
            $url = $this->keyUrl("ContTerceroMdkView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ContTerceroMdkAdd?" . $parm;
        } else {
            $url = "ContTerceroMdkAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContTerceroMdkEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContTerceroMdkList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContTerceroMdkAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContTerceroMdkList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ContTerceroMdkDelete", $parm);
        }
    }
