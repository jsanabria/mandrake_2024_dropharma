 ...
 * Page class
 */
class AdjuntoSalidaAdd extends AdjuntoSalida
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AdjuntoSalidaAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "AdjuntoSalidaAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "AdjuntoSalidaView") {
    ...
    protected function getAddRow()
    {
        ...
        // foto
        $this->foto->setDbValueDef($rsnew, $this->foto->CurrentValue, false);
