 ...
 * Page class
 */
class UnidadMedidaAdd extends UnidadMedida
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UnidadMedidaAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "UnidadMedidaAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "UnidadMedidaView") {
