...
/**
 * Table class for view_cuentas_por_pagar
 */
class ViewCuentasPorPagar extends DbTable
{
    protected $SqlFrom = "";
    ...
    public $total_pagado_bs;
    public $total_pagado_usd;
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_cuentas_por_pagar";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->proveedor->Lookup = new Lookup($this->proveedor, 'proveedor', false, 'id', ["nombre","ci_rif","",""], '', '', [], [], [], [], [], [], false, '`nombre`', '', "CONCAT(COALESCE(`nombre`, ''),'" . ValueSeparator(1, $this->proveedor) . "',COALESCE(`ci_rif`,''))");
        ...
        // proveedor_rif
        $this->proveedor_rif = new DbField(
            $this, // Table
            'x_proveedor_rif', // Variable name
            'proveedor_rif', // Name
            '`proveedor_rif`', // Expression
            '`proveedor_rif`', // Basic search expression
            200, // Type
            30, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`proveedor_rif`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->proveedor_rif->InputTextType = "text";
        $this->proveedor_rif->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['proveedor_rif'] = &$this->proveedor_rif;

        // proveedor_nombre
        $this->proveedor_nombre = new DbField(
            $this, // Table
            'x_proveedor_nombre', // Variable name
            'proveedor_nombre', // Name
            '`proveedor_nombre`', // Expression
            '`proveedor_nombre`', // Basic search expression
            200, // Type
            80, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`proveedor_nombre`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->proveedor_nombre->InputTextType = "text";
        $this->proveedor_nombre->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['proveedor_nombre'] = &$this->proveedor_nombre;
        ...
        $this->tipo_documento->Lookup = new Lookup($this->tipo_documento, 'view_cuentas_por_pagar', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->tipo_documento->OptionCount = 4;
        ...
        // fecha_ultimo_pago
        $this->fecha_ultimo_pago = new DbField(
            $this, // Table
            'x_fecha_ultimo_pago', // Variable name
            'fecha_ultimo_pago', // Name
            '`fecha_ultimo_pago`', // Expression
            CastDateFieldForLike("`fecha_ultimo_pago`", 7, "DB"), // Basic search expression
            133, // Type
            40, // Size
            7, // Date/Time format
            false, // Is upload field
            '`fecha_ultimo_pago`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->fecha_ultimo_pago->InputTextType = "text";
        $this->fecha_ultimo_pago->Raw = true;
        $this->fecha_ultimo_pago->DefaultErrorMessage = str_replace("%s", DateFormat(7), $Language->phrase("IncorrectDate"));
        $this->fecha_ultimo_pago->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['fecha_ultimo_pago'] = &$this->fecha_ultimo_pago;
        ...
        $this->anulado->Lookup = new Lookup($this->anulado, 'view_cuentas_por_pagar', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->pagado->Lookup = new Lookup($this->pagado, 'view_cuentas_por_pagar', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->monto_documento_bs->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->monto_aplicado_bs->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        // total_pagado_bs
        $this->total_pagado_bs = new DbField(
            $this, // Table
            'x_total_pagado_bs', // Variable name
            'total_pagado_bs', // Name
            '`total_pagado_bs`', // Expression
            '`total_pagado_bs`', // Basic search expression
            131, // Type
            61, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`total_pagado_bs`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->total_pagado_bs->addMethod("getDefault", fn() => 0.00);
        $this->total_pagado_bs->InputTextType = "text";
        $this->total_pagado_bs->Raw = true;
        $this->total_pagado_bs->Nullable = false; // NOT NULL field
        $this->total_pagado_bs->FormatPattern = "#,##0.00"; // Format pattern
        $this->total_pagado_bs->DefaultNumberFormat = $this->total_pagado_bs->FormatPattern;
        $this->total_pagado_bs->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->total_pagado_bs->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['total_pagado_bs'] = &$this->total_pagado_bs;

        // total_pagado_usd
        $this->total_pagado_usd = new DbField(
            $this, // Table
            'x_total_pagado_usd', // Variable name
            'total_pagado_usd', // Name
            '`total_pagado_usd`', // Expression
            '`total_pagado_usd`', // Basic search expression
            131, // Type
            63, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`total_pagado_usd`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->total_pagado_usd->addMethod("getDefault", fn() => 0.00);
        $this->total_pagado_usd->InputTextType = "text";
        $this->total_pagado_usd->Raw = true;
        $this->total_pagado_usd->Nullable = false; // NOT NULL field
        $this->total_pagado_usd->FormatPattern = "#,##0.00"; // Format pattern
        $this->total_pagado_usd->DefaultNumberFormat = $this->total_pagado_usd->FormatPattern;
        $this->total_pagado_usd->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->total_pagado_usd->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['total_pagado_usd'] = &$this->total_pagado_usd;

        // cantidad_pagos
        $this->cantidad_pagos = new DbField(
            $this, // Table
            'x_cantidad_pagos', // Variable name
            'cantidad_pagos', // Name
            '`cantidad_pagos`', // Expression
            '`cantidad_pagos`', // Basic search expression
            20, // Type
            21, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`cantidad_pagos`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->cantidad_pagos->addMethod("getDefault", fn() => 0);
        $this->cantidad_pagos->InputTextType = "text";
        $this->cantidad_pagos->Raw = true;
        $this->cantidad_pagos->Nullable = false; // NOT NULL field
        $this->cantidad_pagos->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->cantidad_pagos->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['cantidad_pagos'] = &$this->cantidad_pagos;
    ...
    public function getMasterFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "view_cuentas_por_pagar_resumen") {
            $masterTable = Container("view_cuentas_por_pagar_resumen");
            if ($this->proveedor->getSessionValue() != "") {
                $masterFilter .= "" . GetKeyFilter($masterTable->proveedor, $this->proveedor->getSessionValue(), $masterTable->proveedor->DataType, $masterTable->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "view_cuentas_por_pagar_resumen") {
            $masterTable = Container("view_cuentas_por_pagar_resumen");
            if ($this->proveedor->getSessionValue() != "") {
                $detailFilter .= "" . GetKeyFilter($this->proveedor, $this->proveedor->getSessionValue(), $masterTable->proveedor->DataType, $this->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getMasterFilter($masterTable, $keys)
    {
        ...
        switch ($masterTable->TableVar) {
            case "view_cuentas_por_pagar_resumen":
                $key = $keys["proveedor"] ?? "";
                if (EmptyValue($key)) {
                    if ($masterTable->proveedor->Required) { // Required field and empty value
                ...
                if ($validKeys) {
                    return GetKeyFilter($masterTable->proveedor, $keys["proveedor"], $this->proveedor->DataType, $this->Dbid);
                }
                break;
        }
    ...
    public function getDetailFilter($masterTable)
    {
        switch ($masterTable->TableVar) {
            case "view_cuentas_por_pagar_resumen":
                return GetKeyFilter($this->proveedor, $masterTable->proveedor->DbValue, $masterTable->proveedor->DataType, $masterTable->Dbid);
        }
        return "";
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_cuentas_por_pagar";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->proveedor_rif->DbValue = $row['proveedor_rif'];
        $this->proveedor_nombre->DbValue = $row['proveedor_nombre'];
        $this->tipo_documento->DbValue = $row['tipo_documento'];
        $this->documento->DbValue = $row['documento'];
        $this->nro_control->DbValue = $row['nro_control'];
        $this->fecha->DbValue = $row['fecha'];
        $this->fecha_ultimo_pago->DbValue = $row['fecha_ultimo_pago'];
        ...
        $this->total_pagado_bs->DbValue = $row['total_pagado_bs'];
        $this->total_pagado_usd->DbValue = $row['total_pagado_usd'];
        $this->cantidad_pagos->DbValue = $row['cantidad_pagos'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewCuentasPorPagarList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewCuentasPorPagarView" => $Language->phrase("View"),
            "ViewCuentasPorPagarEdit" => $Language->phrase("Edit"),
            "ViewCuentasPorPagarAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "ViewCuentasPorPagarList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewCuentasPorPagarView",
            Config("API_ADD_ACTION") => "ViewCuentasPorPagarAdd",
            Config("API_EDIT_ACTION") => "ViewCuentasPorPagarEdit",
            Config("API_DELETE_ACTION") => "ViewCuentasPorPagarDelete",
            Config("API_LIST_ACTION") => "ViewCuentasPorPagarList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewCuentasPorPagarView", $parm);
        } else {
            $url = $this->keyUrl("ViewCuentasPorPagarView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewCuentasPorPagarAdd?" . $parm;
        } else {
            $url = "ViewCuentasPorPagarAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewCuentasPorPagarEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewCuentasPorPagarList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewCuentasPorPagarAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewCuentasPorPagarList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewCuentasPorPagarDelete", $parm);
        }
    }
    ...
    {
        if ($this->getCurrentMasterTable() == "view_cuentas_por_pagar_resumen" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_proveedor", $this->proveedor->getSessionValue()); // Use Session Value
        }
        return $url;
    }
    ...
    {
        global $Response;
        $listPage = "ViewCuentasPorPagarList";
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->proveedor_rif->Raw) {
            $this->proveedor_rif->CurrentValue = HtmlDecode($this->proveedor_rif->CurrentValue);
        }
        $this->proveedor_rif->EditValue = $this->proveedor_rif->CurrentValue;
        ...
        if (!$this->proveedor_nombre->Raw) {
            $this->proveedor_nombre->CurrentValue = HtmlDecode($this->proveedor_nombre->CurrentValue);
        }
        $this->proveedor_nombre->EditValue = $this->proveedor_nombre->CurrentValue;
        ...
        $this->fecha_ultimo_pago->EditValue = FormatDateTime($this->fecha_ultimo_pago->CurrentValue, $this->fecha_ultimo_pago->formatPattern());
        ...
        $this->total_pagado_usd->EditValue = $this->total_pagado_usd->CurrentValue;
        $this->total_pagado_usd->PlaceHolder = RemoveHtml($this->total_pagado_usd->caption());
        if (strval($this->total_pagado_usd->EditValue) != "" && is_numeric($this->total_pagado_usd->EditValue)) {
            $this->total_pagado_usd->EditValue = FormatNumber($this->total_pagado_usd->EditValue, null);
        }

        // cantidad_pagos
        $this->cantidad_pagos->setupEditAttributes();
        $this->cantidad_pagos->EditValue = $this->cantidad_pagos->CurrentValue;
        $this->cantidad_pagos->PlaceHolder = RemoveHtml($this->cantidad_pagos->caption());
        if (strval($this->cantidad_pagos->EditValue) != "" && is_numeric($this->cantidad_pagos->EditValue)) {
            $this->cantidad_pagos->EditValue = FormatNumber($this->cantidad_pagos->EditValue, null);
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->proveedor_rif);
                    $doc->exportCaption($this->proveedor_nombre);
                    $doc->exportCaption($this->tipo_documento);
                    $doc->exportCaption($this->documento);
                    $doc->exportCaption($this->nro_control);
                    $doc->exportCaption($this->fecha);
                    $doc->exportCaption($this->fecha_ultimo_pago);
                    ...
                    $doc->exportCaption($this->total_pagado_bs);
                    $doc->exportCaption($this->total_pagado_usd);
                    $doc->exportCaption($this->cantidad_pagos);
        ...
        while (($row = $result->fetch()) && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->proveedor_rif);
                        $doc->exportField($this->proveedor_nombre);
                        $doc->exportField($this->tipo_documento);
                        $doc->exportField($this->documento);
                        $doc->exportField($this->nro_control);
                        $doc->exportField($this->fecha);
                        $doc->exportField($this->fecha_ultimo_pago);
                        ...
                        $doc->exportField($this->total_pagado_bs);
                        $doc->exportField($this->total_pagado_usd);
                        $doc->exportField($this->cantidad_pagos);
