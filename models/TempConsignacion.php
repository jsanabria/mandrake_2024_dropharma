...
/**
 * Table class for temp_consignacion
 */
class TempConsignacion extends DbTable
{
    protected $SqlFrom = "";
    ...
    public $cantidad_entre_fechas;
    public $cantidad_acumulada;
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "temp_consignacion";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->cantidad_entre_fechas = new DbField(
            $this, // Table
            'x_cantidad_entre_fechas', // Variable name
            'cantidad_entre_fechas', // Name
            '`cantidad_entre_fechas`', // Expression
            '`cantidad_entre_fechas`', // Basic search expression
            131, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`cantidad_entre_fechas`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->cantidad_entre_fechas->InputTextType = "text";
        $this->cantidad_entre_fechas->Raw = true;
        $this->cantidad_entre_fechas->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->cantidad_entre_fechas->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['cantidad_entre_fechas'] = &$this->cantidad_entre_fechas;

        // cantidad_acumulada
        $this->cantidad_acumulada = new DbField(
            $this, // Table
            'x_cantidad_acumulada', // Variable name
            'cantidad_acumulada', // Name
            '`cantidad_acumulada`', // Expression
            '`cantidad_acumulada`', // Basic search expression
            131, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`cantidad_acumulada`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->cantidad_acumulada->InputTextType = "text";
        $this->cantidad_acumulada->Raw = true;
        $this->cantidad_acumulada->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->cantidad_acumulada->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['cantidad_acumulada'] = &$this->cantidad_acumulada;

        // cantidad_ajuste
        $this->cantidad_ajuste = new DbField(
            $this, // Table
            'x_cantidad_ajuste', // Variable name
            'cantidad_ajuste', // Name
            '`cantidad_ajuste`', // Expression
            '`cantidad_ajuste`', // Basic search expression
            131, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`cantidad_ajuste`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->cantidad_ajuste->InputTextType = "text";
        $this->cantidad_ajuste->Raw = true;
        $this->cantidad_ajuste->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->cantidad_ajuste->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['cantidad_ajuste'] = &$this->cantidad_ajuste;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "temp_consignacion";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->cantidad_entre_fechas->DbValue = $row['cantidad_entre_fechas'];
        $this->cantidad_acumulada->DbValue = $row['cantidad_acumulada'];
        $this->cantidad_ajuste->DbValue = $row['cantidad_ajuste'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TempConsignacionList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "TempConsignacionView" => $Language->phrase("View"),
            "TempConsignacionEdit" => $Language->phrase("Edit"),
            "TempConsignacionAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "TempConsignacionView",
            Config("API_ADD_ACTION") => "TempConsignacionAdd",
            Config("API_EDIT_ACTION") => "TempConsignacionEdit",
            Config("API_DELETE_ACTION") => "TempConsignacionDelete",
            Config("API_LIST_ACTION") => "TempConsignacionList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TempConsignacionView", $parm);
        } else {
            $url = $this->keyUrl("TempConsignacionView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "TempConsignacionAdd?" . $parm;
        } else {
            $url = "TempConsignacionAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TempConsignacionEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TempConsignacionList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TempConsignacionAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TempConsignacionList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TempConsignacionDelete", $parm);
        }
    }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->cantidad_entre_fechas);
                    $doc->exportCaption($this->cantidad_acumulada);
                    $doc->exportCaption($this->cantidad_ajuste);
                } else {
                    $doc->exportCaption($this->id);
                    $doc->exportCaption($this->_username);
                    $doc->exportCaption($this->nro_documento);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->cantidad_entre_fechas);
                        $doc->exportField($this->cantidad_acumulada);
                        $doc->exportField($this->cantidad_ajuste);
                    } else {
                        $doc->exportField($this->id);
                        $doc->exportField($this->_username);
                        $doc->exportField($this->nro_documento);
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'temp_consignacion');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'temp_consignacion', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'temp_consignacion', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'temp_consignacion', $fldname, $key, $oldvalue);
            }
        }
    }
    ...
    public function recordsetSelecting(&$filter) {
    	...
    	case "TDCFCC":
    		...
    		AddFilter($filter, "(tipo_documento IN ('TDCNRP') OR (tipo_documento IN ('TDCNRP') AND consignacion = 'S' AND consignacion_reportada = 'N'))");
    		break;
    	default:
