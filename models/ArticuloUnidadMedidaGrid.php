 ...
 * Page class
 */
class ArticuloUnidadMedidaGrid extends ArticuloUnidadMedida
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArticuloUnidadMedidaGrid";
    ...
    public $FormName = "farticulo_unidad_medidagrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ArticuloUnidadMedidaGrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "articulo") {
            $this->articulo->Visible = true; // Need to insert foreign key
            $this->articulo->CurrentValue = $this->articulo->getSessionValue();
        }
