 ...
 * Page class
 */
class VisitasView extends Visitas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VisitasView";
    ...
    // CSS class/style
    public $CurrentPageName = "VisitasView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "VisitasList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "VisitasList"; // No matching record, return to list
                    } else {
