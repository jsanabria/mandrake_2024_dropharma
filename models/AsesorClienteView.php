 ...
 * Page class
 */
class AsesorClienteView extends AsesorCliente
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AsesorClienteView";
    ...
    // CSS class/style
    public $CurrentPageName = "AsesorClienteView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "AsesorClienteList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "AsesorClienteList"; // No matching record, return to list
                    } else {
