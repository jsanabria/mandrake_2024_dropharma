...
class ViewFacturasAEntregarEdit extends ViewFacturasAEntregar
{
    ...
    // CSS class/style
    public $CurrentPageName = "ViewFacturasAEntregarEdit";
            ...
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ViewFacturasAEntregarList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ViewFacturasAEntregarList") {
                            ...
                            $returnUrl = "ViewFacturasAEntregarList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->fecha_entrega->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->fecha_entrega->setFormValue($val, true, $validate);
            }
            $this->fecha_entrega->CurrentValue = UnFormatDateTime($this->fecha_entrega->CurrentValue, $this->fecha_entrega->formatPattern());
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->fecha_entrega->EditValue = HtmlEncode(FormatDateTime($this->fecha_entrega->CurrentValue, $this->fecha_entrega->formatPattern()));
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->fecha_entrega->Visible && $this->fecha_entrega->Required) {
            ...
            if (!CheckDate($this->fecha_entrega->FormValue, $this->fecha_entrega->formatPattern())) {
    ...
    protected function getEditRow($rsold)
    {
        ...
        // fecha_entrega
        $this->fecha_entrega->setDbValueDef($rsnew, UnFormatDateTime($this->fecha_entrega->CurrentValue, $this->fecha_entrega->formatPattern()), $this->fecha_entrega->ReadOnly);
        return $rsnew;
    }
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['fecha_entrega'])) { // fecha_entrega
            $this->fecha_entrega->CurrentValue = $row['fecha_entrega'];
        }
    }
