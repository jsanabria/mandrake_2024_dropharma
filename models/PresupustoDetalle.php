...
/**
 * Table class for presupusto_detalle
 */
class PresupustoDetalle extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "presupusto_detalle";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // presupuesto
        $this->presupuesto = new DbField(
            $this, // Table
            'x_presupuesto', // Variable name
            'presupuesto', // Name
            '`presupuesto`', // Expression
            '`presupuesto`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`presupuesto`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->presupuesto->InputTextType = "text";
        $this->presupuesto->Raw = true;
        $this->presupuesto->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->presupuesto->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['presupuesto'] = &$this->presupuesto;

        // grupo1
        $this->grupo1 = new DbField(
            $this, // Table
            'x_grupo1', // Variable name
            'grupo1', // Name
            '`grupo1`', // Expression
            '`grupo1`', // Basic search expression
            200, // Type
            100, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`grupo1`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->grupo1->InputTextType = "text";
        $this->grupo1->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['grupo1'] = &$this->grupo1;

        // grupo2
        $this->grupo2 = new DbField(
            $this, // Table
            'x_grupo2', // Variable name
            'grupo2', // Name
            '`grupo2`', // Expression
            '`grupo2`', // Basic search expression
            200, // Type
            100, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`grupo2`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->grupo2->InputTextType = "text";
        $this->grupo2->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        $this->numero->Raw = true;
        $this->numero->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->numero->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        // linea
        $this->linea = new DbField(
            $this, // Table
            'x_linea', // Variable name
            'linea', // Name
            '`linea`', // Expression
            '`linea`', // Basic search expression
            200, // Type
            20, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`linea`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->linea->InputTextType = "text";
        $this->linea->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['linea'] = &$this->linea;
        ...
        $this->imagen->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "presupusto_detalle";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PresupustoDetalleList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "PresupustoDetalleView" => $Language->phrase("View"),
            "PresupustoDetalleEdit" => $Language->phrase("Edit"),
            "PresupustoDetalleAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "PresupustoDetalleView",
            Config("API_ADD_ACTION") => "PresupustoDetalleAdd",
            Config("API_EDIT_ACTION") => "PresupustoDetalleEdit",
            Config("API_DELETE_ACTION") => "PresupustoDetalleDelete",
            Config("API_LIST_ACTION") => "PresupustoDetalleList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PresupustoDetalleView", $parm);
        } else {
            $url = $this->keyUrl("PresupustoDetalleView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "PresupustoDetalleAdd?" . $parm;
        } else {
            $url = "PresupustoDetalleAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PresupustoDetalleEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PresupustoDetalleList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PresupustoDetalleAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PresupustoDetalleList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("PresupustoDetalleDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "PresupustoDetalleList";
    ...
    public function renderEditRow()
    {
        ...
        $this->grupo1->EditValue = $this->grupo1->CurrentValue;
        ...
        $this->grupo2->EditValue = $this->grupo2->CurrentValue;
        ...
        $this->linea->EditValue = $this->linea->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->presupuesto);
                    $doc->exportCaption($this->grupo1);
                    $doc->exportCaption($this->grupo2);
                    $doc->exportCaption($this->numero);
                    $doc->exportCaption($this->articulo);
                    $doc->exportCaption($this->linea);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->presupuesto);
                        $doc->exportField($this->grupo1);
                        $doc->exportField($this->grupo2);
                        $doc->exportField($this->numero);
                        $doc->exportField($this->articulo);
                        $doc->exportField($this->linea);
