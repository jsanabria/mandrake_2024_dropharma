 ...
 * Page class
 */
class UnidadMedidaView extends UnidadMedida
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UnidadMedidaView";
    ...
    // CSS class/style
    public $CurrentPageName = "UnidadMedidaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "UnidadMedidaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "UnidadMedidaList"; // No matching record, return to list
                    } else {
