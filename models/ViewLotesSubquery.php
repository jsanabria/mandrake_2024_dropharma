...
/**
 * Table class for view_lotes_subquery
 */
class ViewLotesSubquery extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "view_lotes_subquery";
        $this->TableName = 'view_lotes_subquery';
        $this->TableType = "VIEW";
        $this->ImportUseTransaction = $this->supportsTransaction() && Config("IMPORT_USE_TRANSACTION");
        $this->UseTransaction = $this->supportsTransaction() && Config("USE_TRANSACTION");

        // Update Table
        $this->UpdateTable = "view_lotes_subquery";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_lotes_subquery";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewLotesSubqueryList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewLotesSubqueryView" => $Language->phrase("View"),
            "ViewLotesSubqueryEdit" => $Language->phrase("Edit"),
            "ViewLotesSubqueryAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewLotesSubqueryView",
            Config("API_ADD_ACTION") => "ViewLotesSubqueryAdd",
            Config("API_EDIT_ACTION") => "ViewLotesSubqueryEdit",
            Config("API_DELETE_ACTION") => "ViewLotesSubqueryDelete",
            Config("API_LIST_ACTION") => "ViewLotesSubqueryList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewLotesSubqueryView", $parm);
        } else {
            $url = $this->keyUrl("ViewLotesSubqueryView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewLotesSubqueryAdd?" . $parm;
        } else {
            $url = "ViewLotesSubqueryAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewLotesSubqueryEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewLotesSubqueryList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewLotesSubqueryAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewLotesSubqueryList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewLotesSubqueryDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ViewLotesSubqueryList";
