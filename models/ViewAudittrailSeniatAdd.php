 ...
 * Page class
 */
class ViewAudittrailSeniatAdd extends ViewAudittrailSeniat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewAudittrailSeniatAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewAudittrailSeniatAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("ViewAudittrailSeniatList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "ViewAudittrailSeniatList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "ViewAudittrailSeniatView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ViewAudittrailSeniatList") {
                            ...
                            $returnUrl = "ViewAudittrailSeniatList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewAudittrailSeniatList"), "", $this->TableVar, true);
