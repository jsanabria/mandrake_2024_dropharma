...
/**
 * Table class for pagos_compras_detalle
 */
class PagosComprasDetalle extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "pagos_compras_detalle";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // pagos_compras
        $this->pagos_compras = new DbField(
            $this, // Table
            'x_pagos_compras', // Variable name
            'pagos_compras', // Name
            '`pagos_compras`', // Expression
            '`pagos_compras`', // Basic search expression
            19, // Type
            10, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`pagos_compras`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->pagos_compras->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['pagos_compras'] = &$this->pagos_compras;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "pagos_compras_detalle";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->pagos_compras->DbValue = $row['pagos_compras'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PagosComprasDetalleList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "PagosComprasDetalleView" => $Language->phrase("View"),
            "PagosComprasDetalleEdit" => $Language->phrase("Edit"),
            "PagosComprasDetalleAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "PagosComprasDetalleList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "PagosComprasDetalleView",
            Config("API_ADD_ACTION") => "PagosComprasDetalleAdd",
            Config("API_EDIT_ACTION") => "PagosComprasDetalleEdit",
            Config("API_DELETE_ACTION") => "PagosComprasDetalleDelete",
            Config("API_LIST_ACTION") => "PagosComprasDetalleList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PagosComprasDetalleView", $parm);
        } else {
            $url = $this->keyUrl("PagosComprasDetalleView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "PagosComprasDetalleAdd?" . $parm;
        } else {
            $url = "PagosComprasDetalleAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PagosComprasDetalleEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PagosComprasDetalleList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PagosComprasDetalleAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PagosComprasDetalleList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("PagosComprasDetalleDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "PagosComprasDetalleList";
