 ...
 * Page class
 */
class ContTerceroMdkDelete extends ContTerceroMdk
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContTerceroMdkDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ContTerceroMdkDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ContTerceroMdkList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ContTerceroMdkList"); // Return to list
                return;
            }
        }
