...
/**
 * Table class for view_cuentas_por_pagar_resumen
 */
class ViewCuentasPorPagarResumen extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_cuentas_por_pagar_resumen";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->total_pagado_bs->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->total_pagado_usd->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "view_cuentas_por_pagar") {
            $detailUrl = Container("view_cuentas_por_pagar")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_proveedor", $this->proveedor->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "ViewCuentasPorPagarResumenList";
        }
        return $detailUrl;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_cuentas_por_pagar_resumen";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewCuentasPorPagarResumenList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewCuentasPorPagarResumenView" => $Language->phrase("View"),
            "ViewCuentasPorPagarResumenEdit" => $Language->phrase("Edit"),
            "ViewCuentasPorPagarResumenAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "ViewCuentasPorPagarResumenList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewCuentasPorPagarResumenView",
            Config("API_ADD_ACTION") => "ViewCuentasPorPagarResumenAdd",
            Config("API_EDIT_ACTION") => "ViewCuentasPorPagarResumenEdit",
            Config("API_DELETE_ACTION") => "ViewCuentasPorPagarResumenDelete",
            Config("API_LIST_ACTION") => "ViewCuentasPorPagarResumenList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewCuentasPorPagarResumenView", $parm);
        } else {
            $url = $this->keyUrl("ViewCuentasPorPagarResumenView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewCuentasPorPagarResumenAdd?" . $parm;
        } else {
            $url = "ViewCuentasPorPagarResumenAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewCuentasPorPagarResumenEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewCuentasPorPagarResumenList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewCuentasPorPagarResumenAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewCuentasPorPagarResumenList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewCuentasPorPagarResumenDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ViewCuentasPorPagarResumenList";
