 ...
 * Page class
 */
class EntradasSalidasView extends EntradasSalidas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EntradasSalidasView";
    ...
    // CSS class/style
    public $CurrentPageName = "EntradasSalidasView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "EntradasSalidasList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "EntradasSalidasList"; // No matching record, return to list
                    } else {
