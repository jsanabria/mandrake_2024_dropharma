 ...
 * Page class
 */
class EntradasSalidasDelete extends EntradasSalidas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EntradasSalidasDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "EntradasSalidasDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EntradasSalidasList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("EntradasSalidasList"); // Return to list
                return;
            }
        }
