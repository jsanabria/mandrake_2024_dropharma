 ...
 * Page class
 */
class ContMetodoCuentaMdkView extends ContMetodoCuentaMdk
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContMetodoCuentaMdkView";
    ...
    // CSS class/style
    public $CurrentPageName = "ContMetodoCuentaMdkView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ContMetodoCuentaMdkList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ContMetodoCuentaMdkList"; // No matching record, return to list
                    } else {
