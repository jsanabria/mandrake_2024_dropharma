...
class ContLotesPagosDetalle extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // cont_lotes_pago
        $this->cont_lotes_pago = new DbField(
            $this, // Table
            'x_cont_lotes_pago', // Variable name
            'cont_lotes_pago', // Name
            '`cont_lotes_pago`', // Expression
            '`cont_lotes_pago`', // Basic search expression
            19, // Type
            10, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`cont_lotes_pago`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->cont_lotes_pago->InputTextType = "text";
        $this->cont_lotes_pago->Raw = true;
        ...
        $this->cont_lotes_pago->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->proveedor->Lookup = new Lookup($this->proveedor, 'proveedor', false, 'id', ["nombre","","",""], '', '', [], [], [], [], [], [], false, '', '', "`nombre`");
        ...
        // monto_a_pagar
        $this->monto_a_pagar = new DbField(
            $this, // Table
            'x_monto_a_pagar', // Variable name
            'monto_a_pagar', // Name
            '`monto_a_pagar`', // Expression
            '`monto_a_pagar`', // Basic search expression
            131, // Type
            16, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`monto_a_pagar`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->monto_a_pagar->InputTextType = "text";
        $this->monto_a_pagar->Raw = true;
        $this->monto_a_pagar->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->monto_a_pagar->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['monto_a_pagar'] = &$this->monto_a_pagar;

        // monto_pagdo
        $this->monto_pagdo = new DbField(
            $this, // Table
            'x_monto_pagdo', // Variable name
            'monto_pagdo', // Name
            '`monto_pagdo`', // Expression
            '`monto_pagdo`', // Basic search expression
            131, // Type
            16, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`monto_pagdo`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->monto_pagdo->InputTextType = "text";
        $this->monto_pagdo->Raw = true;
        $this->monto_pagdo->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->monto_pagdo->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['monto_pagdo'] = &$this->monto_pagdo;
    ...
    public function getMasterFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "cont_lotes_pagos") {
            $masterTable = Container("cont_lotes_pagos");
            if ($this->cont_lotes_pago->getSessionValue() != "") {
                $masterFilter .= "" . GetKeyFilter($masterTable->id, $this->cont_lotes_pago->getSessionValue(), $masterTable->id->DataType, $masterTable->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "cont_lotes_pagos") {
            $masterTable = Container("cont_lotes_pagos");
            if ($this->cont_lotes_pago->getSessionValue() != "") {
                $detailFilter .= "" . GetKeyFilter($this->cont_lotes_pago, $this->cont_lotes_pago->getSessionValue(), $masterTable->id->DataType, $this->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getMasterFilter($masterTable, $keys)
    {
        ...
        switch ($masterTable->TableVar) {
            case "cont_lotes_pagos":
                $key = $keys["cont_lotes_pago"] ?? "";
                if (EmptyValue($key)) {
                ...
                if ($validKeys) {
                    return GetKeyFilter($masterTable->id, $keys["cont_lotes_pago"], $this->cont_lotes_pago->DataType, $this->Dbid);
                }
                break;
        }
    ...
    public function getDetailFilter($masterTable)
    {
        switch ($masterTable->TableVar) {
            case "cont_lotes_pagos":
                return GetKeyFilter($this->cont_lotes_pago, $masterTable->id->DbValue, $masterTable->id->DataType, $masterTable->Dbid);
        }
        return "";
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ContLotesPagosDetalleView" => $Language->phrase("View"),
            "ContLotesPagosDetalleEdit" => $Language->phrase("Edit"),
            "ContLotesPagosDetalleAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ContLotesPagosDetalleView",
            Config("API_ADD_ACTION") => "ContLotesPagosDetalleAdd",
            Config("API_EDIT_ACTION") => "ContLotesPagosDetalleEdit",
            Config("API_DELETE_ACTION") => "ContLotesPagosDetalleDelete",
            Config("API_LIST_ACTION") => "ContLotesPagosDetalleList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ContLotesPagosDetalleView", $parm);
        } else {
            $url = $this->keyUrl("ContLotesPagosDetalleView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ContLotesPagosDetalleAdd?" . $parm;
        } else {
    ...
    {
        $url = $this->keyUrl("ContLotesPagosDetalleEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContLotesPagosDetalleList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContLotesPagosDetalleAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContLotesPagosDetalleList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ContLotesPagosDetalleDelete", $parm);
        }
    }
    ...
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "cont_lotes_pagos" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            ...
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->cont_lotes_pago->getSessionValue()); // Use Session Value
        }
        return $url;
    }
    ...
    {
        global $Response;
        $listPage = "ContLotesPagosDetalleList";
    ...
    public function renderEditRow()
    {
        ...
        // cont_lotes_pago
        $this->cont_lotes_pago->setupEditAttributes();
        if ($this->cont_lotes_pago->getSessionValue() != "") {
            ...
            if (strval($this->cont_lotes_pago->EditValue) != "" && is_numeric($this->cont_lotes_pago->EditValue)) {
                $this->cont_lotes_pago->EditValue = FormatNumber($this->cont_lotes_pago->EditValue, null);
            }
        }
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'cont_lotes_pagos_detalle');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'cont_lotes_pagos_detalle', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'cont_lotes_pagos_detalle', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'cont_lotes_pagos_detalle', $fldname, $key, $oldvalue);
            }
        }
    }
