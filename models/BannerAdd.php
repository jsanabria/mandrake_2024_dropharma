 ...
 * Page class
 */
class BannerAdd extends Banner
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "BannerAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "BannerView") {
    ...
    protected function getAddRow()
    {
        ...
        // subtitulo
        $this->subtitulo->setDbValueDef($rsnew, $this->subtitulo->CurrentValue, false);
        ...
        $this->activo->setDbValueDef($rsnew, $tmpBool, false);
        return $rsnew;
    }
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['subtitulo'])) { // subtitulo
            $this->subtitulo->setFormValue($row['subtitulo']);
        }
