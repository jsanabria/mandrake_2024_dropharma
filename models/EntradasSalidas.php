...
class EntradasSalidas extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->fabricante->addMethod("getSelectFilter", fn() => 00-0000001);
        ...
        $this->articulo->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->articulo_unidad_medida->OptionCount = 1;
        ...
        $this->cantidad_unidad_medida->Lookup = new Lookup($this->cantidad_unidad_medida, 'entradas_salidas', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->cantidad_unidad_medida->OptionCount = 1;
        ...
        $this->precio_unidad_sin_desc = new DbField(
            $this, // Table
            'x_precio_unidad_sin_desc', // Variable name
            'precio_unidad_sin_desc', // Name
            '`precio_unidad_sin_desc`', // Expression
            '`precio_unidad_sin_desc`', // Basic search expression
            131, // Type
            16, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`precio_unidad_sin_desc`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->precio_unidad_sin_desc->InputTextType = "text";
        $this->precio_unidad_sin_desc->Raw = true;
        ...
        $this->cantidad_movimiento_consignacion = new DbField(
            $this, // Table
            'x_cantidad_movimiento_consignacion', // Variable name
            'cantidad_movimiento_consignacion', // Name
            '`cantidad_movimiento_consignacion`', // Expression
            '`cantidad_movimiento_consignacion`', // Basic search expression
            131, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`cantidad_movimiento_consignacion`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->cantidad_movimiento_consignacion->InputTextType = "text";
        $this->cantidad_movimiento_consignacion->Raw = true;
        $this->cantidad_movimiento_consignacion->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->cantidad_movimiento_consignacion->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['cantidad_movimiento_consignacion'] = &$this->cantidad_movimiento_consignacion;

        // id_consignacion
        $this->id_consignacion = new DbField(
            $this, // Table
            'x_id_consignacion', // Variable name
            'id_consignacion', // Name
            '`id_consignacion`', // Expression
            '`id_consignacion`', // Basic search expression
            21, // Type
            20, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`id_consignacion`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->id_consignacion->InputTextType = "text";
        $this->id_consignacion->Raw = true;
        $this->id_consignacion->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->id_consignacion->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['id_consignacion'] = &$this->id_consignacion;

        // check_ne
        $this->check_ne = new DbField(
            $this, // Table
            'x_check_ne', // Variable name
            'check_ne', // Name
            '`check_ne`', // Expression
            '`check_ne`', // Basic search expression
            200, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`check_ne`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->check_ne->addMethod("getDefault", fn() => "N");
        $this->check_ne->InputTextType = "text";
        $this->check_ne->Raw = true;
        $this->check_ne->Lookup = new Lookup($this->check_ne, 'entradas_salidas', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->check_ne->OptionCount = 2;
        $this->check_ne->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['check_ne'] = &$this->check_ne;

        // packer_cantidad
        $this->packer_cantidad = new DbField(
            $this, // Table
            'x_packer_cantidad', // Variable name
            'packer_cantidad', // Name
            '`packer_cantidad`', // Expression
            '`packer_cantidad`', // Basic search expression
            131, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`packer_cantidad`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->packer_cantidad->InputTextType = "text";
        $this->packer_cantidad->Raw = true;
        $this->packer_cantidad->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->packer_cantidad->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['packer_cantidad'] = &$this->packer_cantidad;

        // newdata
        $this->newdata = new DbField(
            $this, // Table
            'x_newdata', // Variable name
            'newdata', // Name
            '`newdata`', // Expression
            '`newdata`', // Basic search expression
            200, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`newdata`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->newdata->addMethod("getDefault", fn() => "S");
        $this->newdata->InputTextType = "text";
        $this->newdata->Raw = true;
        $this->newdata->Lookup = new Lookup($this->newdata, 'entradas_salidas', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    public function getMasterFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "entradas") {
            $masterTable = Container("entradas");
            if ($this->tipo_documento->getSessionValue() != "") {
                $masterFilter .= "" . GetKeyFilter($masterTable->tipo_documento, $this->tipo_documento->getSessionValue(), $masterTable->tipo_documento->DataType, $masterTable->Dbid);
            } else {
                return "";
            }
            if ($this->id_documento->getSessionValue() != "") {
                $masterFilter .= " AND " . GetKeyFilter($masterTable->id, $this->id_documento->getSessionValue(), $masterTable->id->DataType, $masterTable->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "entradas") {
            $masterTable = Container("entradas");
            if ($this->tipo_documento->getSessionValue() != "") {
                $detailFilter .= "" . GetKeyFilter($this->tipo_documento, $this->tipo_documento->getSessionValue(), $masterTable->tipo_documento->DataType, $this->Dbid);
            } else {
                return "";
            }
            if ($this->id_documento->getSessionValue() != "") {
                $detailFilter .= " AND " . GetKeyFilter($this->id_documento, $this->id_documento->getSessionValue(), $masterTable->id->DataType, $this->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getMasterFilter($masterTable, $keys)
    {
        ...
        switch ($masterTable->TableVar) {
            case "entradas":
                ...
                if ($validKeys) {
                    return GetKeyFilter($masterTable->tipo_documento, $keys["tipo_documento"], $this->tipo_documento->DataType, $this->Dbid) . " AND " . GetKeyFilter($masterTable->id, $keys["id_documento"], $this->id_documento->DataType, $this->Dbid);
                }
                break;
            case "salidas":
                $key = $keys["tipo_documento"] ?? "";
    ...
    public function getDetailFilter($masterTable)
    {
        switch ($masterTable->TableVar) {
            case "entradas":
                return GetKeyFilter($this->tipo_documento, $masterTable->tipo_documento->DbValue, $masterTable->tipo_documento->DataType, $masterTable->Dbid) . " AND " . GetKeyFilter($this->id_documento, $masterTable->id->DbValue, $masterTable->id->DataType, $masterTable->Dbid);
            case "salidas":
                return GetKeyFilter($this->tipo_documento, $masterTable->tipo_documento->DbValue, $masterTable->tipo_documento->DataType, $masterTable->Dbid) . " AND " . GetKeyFilter($this->id_documento, $masterTable->id->DbValue, $masterTable->id->DataType, $masterTable->Dbid);
        }
        return "";
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "EntradasSalidasView" => $Language->phrase("View"),
            "EntradasSalidasEdit" => $Language->phrase("Edit"),
            "EntradasSalidasAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "EntradasSalidasView",
            Config("API_ADD_ACTION") => "EntradasSalidasAdd",
            Config("API_EDIT_ACTION") => "EntradasSalidasEdit",
            Config("API_DELETE_ACTION") => "EntradasSalidasDelete",
            Config("API_LIST_ACTION") => "EntradasSalidasList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EntradasSalidasView", $parm);
        } else {
            $url = $this->keyUrl("EntradasSalidasView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EntradasSalidasEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EntradasSalidasList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EntradasSalidasAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EntradasSalidasList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("EntradasSalidasDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->articulo_unidad_medida->EditValue = $this->articulo_unidad_medida->options(true);
        ...
        if (strval($this->id_consignacion->EditValue) != "" && is_numeric($this->id_consignacion->EditValue)) {
            $this->id_consignacion->EditValue = $this->id_consignacion->EditValue;
        }
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'entradas_salidas');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'entradas_salidas', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'entradas_salidas', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'entradas_salidas', $fldname, $key, $oldvalue);
            }
        }
    }
    ...
    public function rowInserting($rsold, &$rsnew) {
    	...
    	if(CurrentUserLevel() != -1) {
    		if($rsnew["tipo_documento"] == "TDCPDC" or $rsnew["tipo_documento"] == "TDCNRP" or $rsnew["tipo_documento"] == "TDCFCC" or $rsnew["tipo_documento"] == "TDCAEN")
    			$tabla = "entradas";
    		else $tabla = "salidas";
    		$sql = "SELECT estatus FROM $tabla WHERE id = " . $rsnew["id_documento"];
    		if(trim(ExecuteScalar($sql)) != "NUEVO") {
    			$this->CancelMessage = "El documento est&aacute; procesdo o anulada; no se puede modificar.";
    			return FALSE;
    		}
    	}
    	...
    	$old_almacen = isset($rsnew["almacen"]) ? $rsnew["almacen"] : $almacen;
    	...
    	/*** Valido que no ya haya agregado ya el artículo ***/
    	$sql = "SELECT 
    				CONCAT(b.principio_activo, ', ', b.presentacion, ', ', b.nombre_comercial) AS articulo 
    			FROM 
    				entradas_salidas AS a
    				JOIN articulo AS b ON b.id = a.articulo 
    			WHERE 
    				a.tipo_documento = '" . $rsnew["tipo_documento"]. "'
    				AND a.id_documento = '" . $rsnew["id_documento"]. "'
    				AND a.articulo = '" . $rsnew["articulo"]. "';";
    	if($row = ExecuteRow($sql)) {
    		//$this->CancelMessage = "Ya agreg&oacute; el art&iacute;culo $nombre_articulo. Verifique!";
    		//return FALSE;
    	}
    	...
    	if(floatval($rsnew["cantidad_articulo"]) == 0) {
    		/*$salida .= 'La cantidad del art&iacute;culo ' . $row2["principio_activo"] . " - " . $row2["presentacion"]   . " - " . $row2["nombre_comercial"]  . '
    		...
    		if($row2["articulo_inventario"] == "S") {
    			if((floatval($row2["cantidad_en_mano"]) - (floatval($rsnew["cantidad_articulo"]) * floatval($cantidad ))) < 0) {
    				...
    				$salida .= 'La cantidad de ' . number_format($rsnew["cantidad_articulo"], 2, ".", ",") . ' ' . $unidad_medida2 . ' 
    						...
    						es mayor a la existencia actual que es de ' . number_format($row2["cantidad_en_mano"], 2, ".", ",") . ' ' . $unidad_medida;
    				*/
    				$salida .= 'La cantidad de ' . number_format($rsnew["cantidad_articulo"], 2, ".", ",") . ' ' . $unidad_medida2 . ' 
    						solicitada para el art&iacute;culo ' . $row2["principio_activo"]  . " - " . $row2["presentacion"] . " - " . $row2["nombre_comercial"]  . '
    	...
    	//// Junior Sanabria 07/01/2020
    	/**** Tomo el almacen a CONSIGNACION ****/
    	/* Si es AJUSTE DE ENTRADA o FACTURA DE COMPRA a CONSIGNACION */
    	...
    	case "TDCFCV":
    		...
    		$rsnew["costo_unidad"] = ExecuteScalar($sql);
    		$rsnew["costo"] = floatval($rsnew["costo_unidad"]) * intval($rsnew["cantidad_articulo"]);
    		if(floatval($rsnew["descuento"]) == 0)
    			$rsnew["descuento"] = $descuento;
    		else
    			$descuento = floatval($rsnew["descuento"]);
    		...
    		if(floatval($rsnew["precio_unidad"]) > 0) {
    			$rsnew["precio_unidad_sin_desc"] = floatval($rsnew["precio_unidad"]);
    	...
    	case "TDCNET":
    		$rsnew["cantidad_movimiento"] = intval($rsnew["cantidad_movimiento"]) * (-1);
    		$this->CancelMessage = "Una vez creada la Nota de Entrega no se le pueden agregar m&aacute;s art&iacute;culos.";
    		return FALSE;
    		break;
    	case "TDCASA":
    		$rsnew["cantidad_movimiento"] = intval($rsnew["cantidad_movimiento"]) * (-1);
    		...
    		if(floatval($rsnew["costo_unidad"]) > 0) {
    			$sql = "UPDATE
    					...
    					SET
    						...
    						a.descuento = " . floatval($rsnew["descuento"]) . " 
    ...
    public function rowUpdating($rsold, &$rsnew) {
    	...
    	// Cancelo la edición si el documento es distinto de NUEVO a menos que sea un Administrador
    	if(CurrentUserLevel() != -1) {
    		if($rsold["tipo_documento"] == "TDCPDC" or $rsold["tipo_documento"] == "TDCNRP" or $rsold["tipo_documento"] == "TDCFCC" or $rsold["tipo_documento"] == "TDCAEN")
    			$tabla = "entradas";
    		else $tabla = "salidas";
    		$sql = "SELECT estatus FROM $tabla WHERE id = " . $rsold["id_documento"];
    		if(trim(ExecuteScalar($sql)) != "NUEVO") {
    	...
    	/*** Busco la alicuota del IVA asociada al artículo ***/
    	/*
    	$sql = "SELECT alicuota FROM articulo
    			WHERE id = '" . $rsnew["articulo"]. "';";
    	...
    	*/
    	...
    	case "TDCPDV":
    		...
    		/*$sql = "SELECT 
    				...
    				FROM 
    					...
    					JOIN tarifa_articulo d ON d.tarifa = c.tarifa AND d.articulo = b.articulo 
    				WHERE 
    					b.tipo_documento = '" . $rsold["tipo_documento"]. "' AND
    					b.id_documento = '" . $rsold["id_documento"]. "'
    					AND b.articulo = '" . $rsnew["articulo"]. "';";
    		...
    		*/
    		...
    		break;
    	case "TDCFCV":
    		if($rsnew["precio_unidad_sin_desc"] != $rsold["precio_unidad_sin_desc"])
    			$rsnew["precio_unidad_sin_desc"] = $rsold["precio_unidad_sin_desc"];
    		...
    		$rsnew["costo_unidad"] = ExecuteScalar($sql);
    		$rsnew["costo"] = floatval($rsnew["costo_unidad"]) * intval($rsnew["cantidad_articulo"]);
    		$precio_ful = $rsold["precio_unidad_sin_desc"];
    		if($rsold["precio_unidad"] != $rsnew["precio_unidad"]) {
    			$precio = $rsnew["precio_unidad"];
    			$descuento = 0;
    			$precio_ful = $precio;
    		}
    		else
    			$precio = $precio_ful - ($precio_ful * ($descuento/100));
    		$rsnew["precio_unidad"] = round($precio, 2);
    		$rsnew["precio"] = $rsnew["precio_unidad"] * $rsnew["cantidad_articulo"];
    		$rsnew["cantidad_movimiento"] = intval($rsnew["cantidad_movimiento"]) * (-1);
    		$rsnew["precio_unidad_sin_desc"] = $precio_ful;
    		$rsnew["descuento"] = $descuento;
    		break;
    	case "TDCNET":
    		if(trim($rsnew["descuento"]) == "")
    			$rsnew["descuento"] = $rsold["descuento"];
    		if($rsnew["precio_unidad_sin_desc"] != $rsold["precio_unidad_sin_desc"])
    			$rsnew["precio_unidad_sin_desc"] = $rsold["precio_unidad_sin_desc"];

    		// Para no solicitar más de lo que se habia pedido 
    		if($rsnew["cantidad_articulo"] > $rsold["cantidad_articulo"]) {
    			//$rsnew["cantidad_articulo"] = $rsold["cantidad_articulo"];
    			//$rsnew["cantidad_movimiento"] = intval($rsnew["cantidad_articulo"]) * $cantidad_unidad;
    			$this->CancelMessage = "Una vez creada la Nota de Entrega no se le pueden agregar m&aacute;s cantidades a los art&iacute;culos.";
    			return FALSE;
    		}
    		$rsnew["cantidad_movimiento"] = intval($rsnew["cantidad_movimiento"]) * (-1);
        ...
        if(isset($rsnew["almacen"])) {
    	    if(trim($rsnew["almacen"]) == "") $rsnew["almacen"] = $rsold["almacen"];
        }
    	return TRUE;
    }
    ...
    public function gridInserting() {
    	...
    	foreach ($rsnew as $row) {
    		...
    		$sql = "SELECT
    					(cantidad_en_mano+cantidad_en_pedido)-cantidad_en_transito AS cantidad_en_mano,
    					unidad_medida_defecto, principio_activo, nombre_comercial, articulo_inventario 
    				FROM articulo
    		...
    		if($row2["articulo_inventario"] == "S") {
    			if(floatval($row["cantidad_articulo"]) == 0) {
    				$salida .= '<br>';
    				$salida .= 'La cantidad a solicitar del art&iacute;culo ' . $row2["principio_activo"] . " - " . $row2["nombre_comercial"]  . '
    						debe ser mayor a cero (0)';
    			}
    			else {
    				if((floatval($row2["cantidad_en_mano"]) - (floatval($row["cantidad_articulo"]) * floatval($cantidad ))) < 0) {
    					$sql = "SELECT descripcion AS um FROM unidad_medida
    						WHERE codigo = '" . $row["articulo_unidad_medida"] . "';";
    					$unidad_medida2 = ExecuteScalar($sql);
    					$salida .= '<br>';
    					...
    					$salida .= 'La cantidad de ' . number_format($row["cantidad_articulo"], 2, ".", ",") . ' ' . $unidad_medida2 . ' 
    							solicitada para el art&iacute;culo ' . $row2["principio_activo"] . " - " . $row2["nombre_comercial"]  . '
    							es mayor a la existencia actual que es de ' . number_format($row2["cantidad_en_mano"], 2, ".", ",") . ' ' . $unidad_medida;
    					*/
    					$salida .= 'La cantidad de ' . number_format($row["cantidad_articulo"], 2, ".", ",") . ' ' . $unidad_medida2 . ' 
    							solicitada para el art&iacute;culo ' . $row2["principio_activo"] . " - " . $row2["nombre_comercial"]  . '
    ...
    public function rowDeleting(&$rs) {
    	...
    	if($rs["tipo_documento"] == "TDCFCC" or $rs["tipo_documento"] == "TDCFCV") {
    		// Valido cierre de facturación
    		if($rs["tipo_documento"] == "TDCFCC") $tabla = "entradas";
    		else $tabla = "salidas";
    		$sql = "SELECT cerrado, comprobante FROM $tabla WHERE id = '" . $rs["id_documento"] . "';";
    		if($row = ExecuteRow($sql)) {
    			if($row["cerrado"] == "S") {
    				$this->CancelMessage = "El mes en el que est&aacute; la factura est&aacute; cerrado. Verifique!";
    				return FALSE;
