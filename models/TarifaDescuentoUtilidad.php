...
/**
 * Table class for tarifa_descuento_utilidad
 */
class TarifaDescuentoUtilidad extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "tarifa_descuento_utilidad";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->fabricante->Nullable = false; // NOT NULL field
        ...
        $this->fabricante->SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->descuento->Required = true; // Required field
        ...
        // utilidad
        $this->utilidad = new DbField(
            $this, // Table
            'x_utilidad', // Variable name
            'utilidad', // Name
            '`utilidad`', // Expression
            '`utilidad`', // Basic search expression
            131, // Type
            16, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`utilidad`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->utilidad->InputTextType = "text";
        $this->utilidad->Raw = true;
        $this->utilidad->Required = true; // Required field
        $this->utilidad->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->utilidad->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['utilidad'] = &$this->utilidad;
        ...
        $this->tarifa->IsForeignKey = true; // Foreign key field
        $this->tarifa->Nullable = false; // NOT NULL field
        $this->tarifa->Required = true; // Required field
        $this->tarifa->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->tarifa->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    public function getMasterFilterFromSession()
    {
        // Master filter
        $masterFilter = "";
        if ($this->getCurrentMasterTable() == "tarifa") {
            $masterTable = Container("tarifa");
            if ($this->tarifa->getSessionValue() != "") {
                $masterFilter .= "" . GetKeyFilter($masterTable->id, $this->tarifa->getSessionValue(), $masterTable->id->DataType, $masterTable->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "tarifa") {
            $masterTable = Container("tarifa");
            if ($this->tarifa->getSessionValue() != "") {
                $detailFilter .= "" . GetKeyFilter($this->tarifa, $this->tarifa->getSessionValue(), $masterTable->id->DataType, $this->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getMasterFilter($masterTable, $keys)
    {
        ...
        switch ($masterTable->TableVar) {
            case "tarifa":
                ...
                if ($validKeys) {
                    return GetKeyFilter($masterTable->id, $keys["tarifa"], $this->tarifa->DataType, $this->Dbid);
                }
                break;
        }
    ...
    public function getDetailFilter($masterTable)
    {
        switch ($masterTable->TableVar) {
            case "tarifa":
                return GetKeyFilter($this->tarifa, $masterTable->id->DbValue, $masterTable->id->DataType, $masterTable->Dbid);
        }
        return "";
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "tarifa_descuento_utilidad";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->utilidad->DbValue = $row['utilidad'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TarifaDescuentoUtilidadList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "TarifaDescuentoUtilidadView" => $Language->phrase("View"),
            "TarifaDescuentoUtilidadEdit" => $Language->phrase("Edit"),
            "TarifaDescuentoUtilidadAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "TarifaDescuentoUtilidadList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "TarifaDescuentoUtilidadView",
            Config("API_ADD_ACTION") => "TarifaDescuentoUtilidadAdd",
            Config("API_EDIT_ACTION") => "TarifaDescuentoUtilidadEdit",
            Config("API_DELETE_ACTION") => "TarifaDescuentoUtilidadDelete",
            Config("API_LIST_ACTION") => "TarifaDescuentoUtilidadList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TarifaDescuentoUtilidadView", $parm);
        } else {
            $url = $this->keyUrl("TarifaDescuentoUtilidadView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "TarifaDescuentoUtilidadAdd?" . $parm;
        } else {
            $url = "TarifaDescuentoUtilidadAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifaDescuentoUtilidadEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifaDescuentoUtilidadList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifaDescuentoUtilidadAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifaDescuentoUtilidadList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TarifaDescuentoUtilidadDelete", $parm);
        }
    }
    ...
    {
        if ($this->getCurrentMasterTable() == "tarifa" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->tarifa->getSessionValue()); // Use Session Value
        }
        return $url;
    }
    ...
    {
        global $Response;
        $listPage = "TarifaDescuentoUtilidadList";
    ...
    public function renderEditRow()
    {
        ...
        // utilidad
        $this->utilidad->setupEditAttributes();
        $this->utilidad->EditValue = $this->utilidad->CurrentValue;
        $this->utilidad->PlaceHolder = RemoveHtml($this->utilidad->caption());
        if (strval($this->utilidad->EditValue) != "" && is_numeric($this->utilidad->EditValue)) {
            $this->utilidad->EditValue = FormatNumber($this->utilidad->EditValue, null);
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->utilidad);
                } else {
