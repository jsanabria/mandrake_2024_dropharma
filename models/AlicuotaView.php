 ...
 * Page class
 */
class AlicuotaView extends Alicuota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AlicuotaView";
    ...
    // CSS class/style
    public $CurrentPageName = "AlicuotaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "AlicuotaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("AlicuotaList"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "AlicuotaList"; // No matching record, return to list
                    } else {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("AlicuotaList"), "", $this->TableVar, true);
        $pageId = "view";
