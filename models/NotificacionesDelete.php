 ...
 * Page class
 */
class NotificacionesDelete extends Notificaciones
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NotificacionesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "NotificacionesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NotificacionesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("NotificacionesList"); // Return to list
                return;
            }
        }
