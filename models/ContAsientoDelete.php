 ...
 * Page class
 */
class ContAsientoDelete extends ContAsiento
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContAsientoDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ContAsientoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ContAsientoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ContAsientoList"); // Return to list
                return;
            }
        }
