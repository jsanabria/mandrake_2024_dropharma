 ...
 * Page class
 */
class BancoTipoPagoView extends BancoTipoPago
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BancoTipoPagoView";
    ...
    // CSS class/style
    public $CurrentPageName = "BancoTipoPagoView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "BancoTipoPagoList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "BancoTipoPagoList"; // No matching record, return to list
                    } else {
