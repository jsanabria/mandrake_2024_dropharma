...
class AbonoEdit extends Abono
{
            ...
            if ($curVal != "") {
                ...
                if ($this->metodo_pago->ViewValue === null) { // Lookup from database
                    ...
                    $lookupFilter = function() {
                        return CurrentPageID() == "add" ? "`codigo` = '009' AND valor1 <> 'RC' AND valor1 <> 'DV'" : "`codigo` = '009'";
                    };
    ...
    protected function validateForm()
    {
        ...
        if (in_array("recarga", $detailTblVar) && $detailPage->DetailEdit) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // pago
            $this->pago->setDbValueDef($rsnew, $this->pago->CurrentValue, 0, $this->pago->ReadOnly);
            ...
            // pivote
            $this->pivote->setDbValueDef($rsnew, $this->pivote->CurrentValue, null, $this->pivote->ReadOnly);
