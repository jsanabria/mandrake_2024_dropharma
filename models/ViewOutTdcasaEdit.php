 ...
 * Page class
 */
class ViewOutTdcasaEdit extends ViewOutTdcasa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewOutTdcasaEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewOutTdcasaEdit";
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ViewOutTdcasaList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "ViewOutTdcasaList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ViewOutTdcasaList") {
                            ...
                            $returnUrl = "ViewOutTdcasaList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    public function renderRow()
    {
        ...
        // cliente_ci_rif
        $this->cliente_ci_rif->RowCssClass = "row";

        // cliente_nombre
        $this->cliente_nombre->RowCssClass = "row";

        // cliente_direccion
        $this->cliente_direccion->RowCssClass = "row";

        // cliente_telefono
        $this->cliente_telefono->RowCssClass = "row";

        // igtf_alicuota
        $this->igtf_alicuota->RowCssClass = "row";
