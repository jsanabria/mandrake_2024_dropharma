 ...
 * Page class
 */
class ContLotesView extends ContLotes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContLotesView";
    ...
    // CSS class/style
    public $CurrentPageName = "ContLotesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ContLotesList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ContLotesList"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ContLotesList"; // No matching record, return to list
                    } else {
