 ...
 * Page class
 */
class ViewCuentasPorCobrarList extends ViewCuentasPorCobrar
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewCuentasPorCobrarList";
    ...
    public $FormName = "fview_cuentas_por_cobrarlist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ViewCuentasPorCobrarList";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "ViewCuentasPorCobrarDelete";
        $this->MultiUpdateUrl = "ViewCuentasPorCobrarUpdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fview_cuentas_por_cobrarsrch");
        }
        ...
        $filterList = Concat($filterList, $this->tipo_documento_fiscal->AdvancedSearch->toJson(), ","); // Field tipo_documento_fiscal
        ...
        $filterList = Concat($filterList, $this->fecha_documento->AdvancedSearch->toJson(), ","); // Field fecha_documento
        ...
        $filterList = Concat($filterList, $this->monto_igtf_bs->AdvancedSearch->toJson(), ","); // Field monto_igtf_bs
        ...
        $filterList = Concat($filterList, $this->cantidad_cobros->AdvancedSearch->toJson(), ","); // Field cantidad_cobros
        $filterList = Concat($filterList, $this->fecha_ultimo_cobro->AdvancedSearch->toJson(), ","); // Field fecha_ultimo_cobro
        ...
        $filterList = Concat($filterList, $this->dias_vencido->AdvancedSearch->toJson(), ","); // Field dias_vencido
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fview_cuentas_por_cobrarsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        $this->tipo_documento_fiscal->AdvancedSearch->SearchValue = @$filter["x_tipo_documento_fiscal"];
        $this->tipo_documento_fiscal->AdvancedSearch->SearchOperator = @$filter["z_tipo_documento_fiscal"];
        $this->tipo_documento_fiscal->AdvancedSearch->SearchCondition = @$filter["v_tipo_documento_fiscal"];
        $this->tipo_documento_fiscal->AdvancedSearch->SearchValue2 = @$filter["y_tipo_documento_fiscal"];
        $this->tipo_documento_fiscal->AdvancedSearch->SearchOperator2 = @$filter["w_tipo_documento_fiscal"];
        $this->tipo_documento_fiscal->AdvancedSearch->save();
        ...
        $this->fecha_documento->AdvancedSearch->SearchValue = @$filter["x_fecha_documento"];
        $this->fecha_documento->AdvancedSearch->SearchOperator = @$filter["z_fecha_documento"];
        $this->fecha_documento->AdvancedSearch->SearchCondition = @$filter["v_fecha_documento"];
        $this->fecha_documento->AdvancedSearch->SearchValue2 = @$filter["y_fecha_documento"];
        $this->fecha_documento->AdvancedSearch->SearchOperator2 = @$filter["w_fecha_documento"];
        $this->fecha_documento->AdvancedSearch->save();
        ...
        // Field monto_igtf_bs
        $this->monto_igtf_bs->AdvancedSearch->SearchValue = @$filter["x_monto_igtf_bs"];
        $this->monto_igtf_bs->AdvancedSearch->SearchOperator = @$filter["z_monto_igtf_bs"];
        $this->monto_igtf_bs->AdvancedSearch->SearchCondition = @$filter["v_monto_igtf_bs"];
        $this->monto_igtf_bs->AdvancedSearch->SearchValue2 = @$filter["y_monto_igtf_bs"];
        $this->monto_igtf_bs->AdvancedSearch->SearchOperator2 = @$filter["w_monto_igtf_bs"];
        $this->monto_igtf_bs->AdvancedSearch->save();
        ...
        // Field cantidad_cobros
        $this->cantidad_cobros->AdvancedSearch->SearchValue = @$filter["x_cantidad_cobros"];
        $this->cantidad_cobros->AdvancedSearch->SearchOperator = @$filter["z_cantidad_cobros"];
        $this->cantidad_cobros->AdvancedSearch->SearchCondition = @$filter["v_cantidad_cobros"];
        $this->cantidad_cobros->AdvancedSearch->SearchValue2 = @$filter["y_cantidad_cobros"];
        $this->cantidad_cobros->AdvancedSearch->SearchOperator2 = @$filter["w_cantidad_cobros"];
        $this->cantidad_cobros->AdvancedSearch->save();

        // Field fecha_ultimo_cobro
        $this->fecha_ultimo_cobro->AdvancedSearch->SearchValue = @$filter["x_fecha_ultimo_cobro"];
        $this->fecha_ultimo_cobro->AdvancedSearch->SearchOperator = @$filter["z_fecha_ultimo_cobro"];
        $this->fecha_ultimo_cobro->AdvancedSearch->SearchCondition = @$filter["v_fecha_ultimo_cobro"];
        $this->fecha_ultimo_cobro->AdvancedSearch->SearchValue2 = @$filter["y_fecha_ultimo_cobro"];
        $this->fecha_ultimo_cobro->AdvancedSearch->SearchOperator2 = @$filter["w_fecha_ultimo_cobro"];
        $this->fecha_ultimo_cobro->AdvancedSearch->save();
        ...
        // Field dias_vencido
        $this->dias_vencido->AdvancedSearch->SearchValue = @$filter["x_dias_vencido"];
        $this->dias_vencido->AdvancedSearch->SearchOperator = @$filter["z_dias_vencido"];
        $this->dias_vencido->AdvancedSearch->SearchCondition = @$filter["v_dias_vencido"];
        $this->dias_vencido->AdvancedSearch->SearchValue2 = @$filter["y_dias_vencido"];
        $this->dias_vencido->AdvancedSearch->SearchOperator2 = @$filter["w_dias_vencido"];
        $this->dias_vencido->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->tipo_documento_fiscal;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->tipo_documento_fiscal); // tipo_documento_fiscal
            ...
            $this->updateSort($this->dias_vencido); // dias_vencido
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->tipo_documento_fiscal->setSort("");
                ...
                $this->cantidad_cobros->setSort("");
                $this->fecha_ultimo_cobro->setSort("");
                $this->saldo_bs->setSort("");
                $this->saldo_usd->setSort("");
                $this->estado_cuenta->setSort("");
                $this->dias_vencido->setSort("");
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fview_cuentas_por_cobrarlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fview_cuentas_por_cobrarlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "tipo_documento_fiscal");
            ...
            $this->createColumnOption($option, "dias_vencido");
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fview_cuentas_por_cobrarsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fview_cuentas_por_cobrarsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fview_cuentas_por_cobrarlist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" form=\"fview_cuentas_por_cobrarlist\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToExcel") . "</button>";
            } else {
                return "<a href=\"$exportUrl\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" form=\"fview_cuentas_por_cobrarlist\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToWord") . "</button>";
            } else {
                return "<a href=\"$exportUrl\" class=\"btn btn-default ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPdf", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPdf", true)) . "\" form=\"fview_cuentas_por_cobrarlist\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToPdf") . "</button>";
            } else {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fview_cuentas_por_cobrarlist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fview_cuentas_por_cobrarsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    */
    public function exportData($doc)
    {
        ...
        if (Config("EXPORT_MASTER_RECORD") && $this->DbMasterFilter != "" && $this->getCurrentMasterTable() == "view_cuentas_por_cobrar_resumen") {
            $view_cuentas_por_cobrar_resumen = new ViewCuentasPorCobrarResumenList();
            $rsmaster = $view_cuentas_por_cobrar_resumen->loadRs($this->DbMasterFilter); // Load master record
            if ($rsmaster) {
                $exportStyle = $doc->Style;
                $doc->setStyle("v"); // Change to vertical
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    $doc->setTable($view_cuentas_por_cobrar_resumen);
                    $view_cuentas_por_cobrar_resumen->exportDocument($doc, $rsmaster);
                    $doc->exportEmptyRow();
                    $doc->setTable($this);
                }
