 ...
 * Page class
 */
class BancoTipoPagoEdit extends BancoTipoPago
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BancoTipoPagoEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "BancoTipoPagoEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("BancoTipoPagoList"); // Return to list page
                        return;
