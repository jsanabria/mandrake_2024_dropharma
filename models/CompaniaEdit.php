 ...
 * Page class
 */
class CompaniaEdit extends Compania
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CompaniaEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "CompaniaEdit";
    ...
    public function run()
    {
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("CompaniaList"); // Return to list page
                        return;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("CompaniaList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "CompaniaList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "CompaniaList") {
                            ...
                            $returnUrl = "CompaniaList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'agente_retencion' first before field var 'x_agente_retencion'
        $val = $CurrentForm->hasValue("agente_retencion") ? $CurrentForm->getValue("agente_retencion") : $CurrentForm->getValue("x_agente_retencion");
        if (!$this->agente_retencion->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->agente_retencion->Visible = false; // Disable update for API request
            } else {
                $this->agente_retencion->setFormValue($val);
            }
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->agente_retencion->CurrentValue = $this->agente_retencion->FormValue;
    }
    ...
    public function renderRow()
    {
        ...
        // agente_retencion
        $this->agente_retencion->RowCssClass = "row";
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->agente_retencion->Visible && $this->agente_retencion->Required) {
                if (!$this->agente_retencion->IsDetailKey && EmptyValue($this->agente_retencion->FormValue)) {
                    $this->agente_retencion->addErrorMessage(str_replace("%s", $this->agente_retencion->caption(), $this->agente_retencion->RequiredErrorMessage));
                }
            }
        ...
        if (in_array("compania_cuenta", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("CompaniaCuentaGrid");
            if (in_array("compania_cuenta", $detailTblVar) && $detailPage->DetailEdit && $editRow) {
                $Security->loadCurrentUserLevel($this->ProjectID . "compania_cuenta"); // Load user level of detail table
    ...
    protected function getEditRow($rsold)
    {
        ...
        // agente_retencion
        $this->agente_retencion->setDbValueDef($rsnew, $this->agente_retencion->CurrentValue, $this->agente_retencion->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['agente_retencion'])) { // agente_retencion
            $this->agente_retencion->CurrentValue = $row['agente_retencion'];
        }
    ...
    protected function setupDetailParms()
    {
        ...
        if ($detailTblVar != "") {
            ...
            if (in_array("compania_cuenta", $detailTblVar)) {
                ...
                if ($detailPageObj->DetailEdit) {
                    ...
                    $detailPageObj->compania->IsDetailKey = true;
                    $detailPageObj->compania->CurrentValue = $this->id->CurrentValue;
                    $detailPageObj->compania->setSessionValue($detailPageObj->compania->CurrentValue);
                }
            }
        }
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("CompaniaList"), "", $this->TableVar, true);
        $pageId = "edit";
