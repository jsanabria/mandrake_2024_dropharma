...
/**
 * Table class for view_facturas_a_entregar
 */
class ViewFacturasAEntregar extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_facturas_a_entregar";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->codcli->Lookup = new Lookup($this->codcli, 'cliente', false, 'id', ["nombre","","",""], '', '', [], [], [], [], [], [], false, '`nombre` ASC', '', "`nombre`");
        ...
        $this->entregado->Lookup = new Lookup($this->entregado, 'view_facturas_a_entregar', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->fecha_entrega->Required = true; // Required field
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_facturas_a_entregar";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewFacturasAEntregarList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewFacturasAEntregarView" => $Language->phrase("View"),
            "ViewFacturasAEntregarEdit" => $Language->phrase("Edit"),
            "ViewFacturasAEntregarAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "ViewFacturasAEntregarList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewFacturasAEntregarView",
            Config("API_ADD_ACTION") => "ViewFacturasAEntregarAdd",
            Config("API_EDIT_ACTION") => "ViewFacturasAEntregarEdit",
            Config("API_DELETE_ACTION") => "ViewFacturasAEntregarDelete",
            Config("API_LIST_ACTION") => "ViewFacturasAEntregarList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewFacturasAEntregarView", $parm);
        } else {
            $url = $this->keyUrl("ViewFacturasAEntregarView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewFacturasAEntregarAdd?" . $parm;
        } else {
            $url = "ViewFacturasAEntregarAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFacturasAEntregarEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFacturasAEntregarList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFacturasAEntregarAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFacturasAEntregarList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewFacturasAEntregarDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ViewFacturasAEntregarList";
    ...
    public function recordsetSelecting(&$filter) {
    	...
    	if($grupo == "CLIENTE") {
    		...
    		if($asesor > 0) {
    			...
    			$clientes .= "0"; 
    			AddFilter($filter, "codcli IN ($clientes)");
    		}
    		else if($cliente > 0) {
    			AddFilter($filter, "codcli = '$cliente'");
    		}
    	}
    }
