 ...
 * Page class
 */
class EntradasDelete extends Entradas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EntradasDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "EntradasDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EntradasList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("EntradasList"); // Return to list
                return;
            }
        }
