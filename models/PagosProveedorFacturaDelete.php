 ...
 * Page class
 */
class PagosProveedorFacturaDelete extends PagosProveedorFactura
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PagosProveedorFacturaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PagosProveedorFacturaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PagosProveedorFacturaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("PagosProveedorFacturaList"); // Return to list
                return;
            }
        }
