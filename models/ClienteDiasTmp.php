...
/**
 * Table class for cliente_dias_tmp
 */
class ClienteDiasTmp extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "cliente_dias_tmp";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "cliente_dias_tmp";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ClienteDiasTmpList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ClienteDiasTmpView" => $Language->phrase("View"),
            "ClienteDiasTmpEdit" => $Language->phrase("Edit"),
            "ClienteDiasTmpAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ClienteDiasTmpView",
            Config("API_ADD_ACTION") => "ClienteDiasTmpAdd",
            Config("API_EDIT_ACTION") => "ClienteDiasTmpEdit",
            Config("API_DELETE_ACTION") => "ClienteDiasTmpDelete",
            Config("API_LIST_ACTION") => "ClienteDiasTmpList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ClienteDiasTmpView", $parm);
        } else {
            $url = $this->keyUrl("ClienteDiasTmpView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ClienteDiasTmpAdd?" . $parm;
        } else {
            $url = "ClienteDiasTmpAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ClienteDiasTmpEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ClienteDiasTmpList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ClienteDiasTmpAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ClienteDiasTmpList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ClienteDiasTmpDelete", $parm);
        }
    }
