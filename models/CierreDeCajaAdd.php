 ...
 * Page class
 */
class CierreDeCajaAdd extends CierreDeCaja
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CierreDeCajaAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "CierreDeCajaAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "CierreDeCajaView") {
