...
/**
 * Table class for adjunto_salida
 */
class AdjuntoSalida extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "adjunto_salida";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // salida
        $this->salida = new DbField(
            $this, // Table
            'x_salida', // Variable name
            'salida', // Name
            '`salida`', // Expression
            '`salida`', // Basic search expression
            19, // Type
            10, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`salida`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->salida->InputTextType = "text";
        $this->salida->Raw = true;
        $this->salida->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->salida->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->usuario->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "adjunto_salida";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("AdjuntoSalidaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "AdjuntoSalidaView" => $Language->phrase("View"),
            "AdjuntoSalidaEdit" => $Language->phrase("Edit"),
            "AdjuntoSalidaAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "AdjuntoSalidaView",
            Config("API_ADD_ACTION") => "AdjuntoSalidaAdd",
            Config("API_EDIT_ACTION") => "AdjuntoSalidaEdit",
            Config("API_DELETE_ACTION") => "AdjuntoSalidaDelete",
            Config("API_LIST_ACTION") => "AdjuntoSalidaList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AdjuntoSalidaView", $parm);
        } else {
            $url = $this->keyUrl("AdjuntoSalidaView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "AdjuntoSalidaAdd?" . $parm;
        } else {
            $url = "AdjuntoSalidaAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AdjuntoSalidaEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AdjuntoSalidaList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AdjuntoSalidaAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AdjuntoSalidaList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("AdjuntoSalidaDelete", $parm);
        }
    }
