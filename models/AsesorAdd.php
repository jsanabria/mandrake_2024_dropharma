...
class AsesorAdd extends Asesor
{
    ...
    // CSS class/style
    public $CurrentPageName = "AsesorAdd";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("AsesorClienteGrid");
            if (in_array("asesor_cliente", $detailTblVar) && $detailPage->DetailAdd && $addRow) {
            ...
            $detailPage = Container("AsesorFabricanteGrid");
            if (in_array("asesor_fabricante", $detailTblVar) && $detailPage->DetailAdd && $addRow) {
                $detailPage->asesor->setSessionValue($this->id->CurrentValue); // Set master key
