 ...
 * Page class
 */
class PurgaDetalleGrid extends PurgaDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PurgaDetalleGrid";
    ...
    public $FormName = "fpurga_detallegrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "PurgaDetalleGrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "purga") {
            $this->purga->Visible = true; // Need to insert foreign key
            $this->purga->CurrentValue = $this->purga->getSessionValue();
        }
