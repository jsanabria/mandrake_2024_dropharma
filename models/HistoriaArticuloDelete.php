 ...
 * Page class
 */
class HistoriaArticuloDelete extends HistoriaArticulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HistoriaArticuloDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("HistoriaArticuloList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("HistoriaArticuloList"); // Return to list
                return;
            }
        }
