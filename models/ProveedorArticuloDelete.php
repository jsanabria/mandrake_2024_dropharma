 ...
 * Page class
 */
class ProveedorArticuloDelete extends ProveedorArticulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProveedorArticuloDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ProveedorArticuloDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ProveedorArticuloList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ProveedorArticuloList"); // Return to list
                return;
            }
        }
