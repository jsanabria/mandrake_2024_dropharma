 ...
 * Page class
 */
class ContComprobanteEdit extends ContComprobante
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContComprobanteEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ContComprobanteEdit";
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'contabilizacion' first before field var 'x_contabilizacion'
        $val = $CurrentForm->hasValue("contabilizacion") ? $CurrentForm->getValue("contabilizacion") : $CurrentForm->getValue("x_contabilizacion");
        if (!$this->contabilizacion->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->contabilizacion->Visible = false; // Disable update for API request
            } else {
                $this->contabilizacion->setFormValue($val);
            }
            $this->contabilizacion->CurrentValue = UnFormatDateTime($this->contabilizacion->CurrentValue, $this->contabilizacion->formatPattern());
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        $this->contabilizacion->CurrentValue = $this->contabilizacion->FormValue;
        $this->contabilizacion->CurrentValue = UnFormatDateTime($this->contabilizacion->CurrentValue, $this->contabilizacion->formatPattern());
    }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->contabilizacion->Visible && $this->contabilizacion->Required) {
                if (!$this->contabilizacion->IsDetailKey && EmptyValue($this->contabilizacion->FormValue)) {
                    $this->contabilizacion->addErrorMessage(str_replace("%s", $this->contabilizacion->caption(), $this->contabilizacion->RequiredErrorMessage));
                }
            }
        ...
        if (in_array("cont_asiento", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("ContAsientoGrid");
            if (in_array("cont_asiento", $detailTblVar) && $detailPage->DetailEdit && $editRow) {
