...
/**
 * Table class for tmp_art
 */
class TmpArt extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "tmp_art";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TmpArtList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "TmpArtView" => $Language->phrase("View"),
            "TmpArtEdit" => $Language->phrase("Edit"),
            "TmpArtAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "TmpArtView",
            Config("API_ADD_ACTION") => "TmpArtAdd",
            Config("API_EDIT_ACTION") => "TmpArtEdit",
            Config("API_DELETE_ACTION") => "TmpArtDelete",
            Config("API_LIST_ACTION") => "TmpArtList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TmpArtView", $parm);
        } else {
            $url = $this->keyUrl("TmpArtView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TmpArtEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TmpArtList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TmpArtAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TmpArtList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TmpArtDelete", $parm);
        }
    }
