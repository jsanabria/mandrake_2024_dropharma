 ...
 * Page class
 */
class TarifaDescuentoUtilidadView extends TarifaDescuentoUtilidad
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TarifaDescuentoUtilidadView";
    ...
    // CSS class/style
    public $CurrentPageName = "TarifaDescuentoUtilidadView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Id") ?? Route("Id")) !== null) {
            ...
            $returnUrl = "TarifaDescuentoUtilidadList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "TarifaDescuentoUtilidadList"; // No matching record, return to list
                    } else {
