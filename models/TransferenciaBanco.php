...
/**
 * Table class for transferencia_banco
 */
class TransferenciaBanco extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "transferencia_banco";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->banco_origen->Raw = true;
        $this->banco_origen->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->banco_origen->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->banco_destino->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "transferencia_banco";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TransferenciaBancoList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "TransferenciaBancoView" => $Language->phrase("View"),
            "TransferenciaBancoEdit" => $Language->phrase("Edit"),
            "TransferenciaBancoAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "TransferenciaBancoView",
            Config("API_ADD_ACTION") => "TransferenciaBancoAdd",
            Config("API_EDIT_ACTION") => "TransferenciaBancoEdit",
            Config("API_DELETE_ACTION") => "TransferenciaBancoDelete",
            Config("API_LIST_ACTION") => "TransferenciaBancoList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TransferenciaBancoView", $parm);
        } else {
            $url = $this->keyUrl("TransferenciaBancoView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "TransferenciaBancoAdd?" . $parm;
        } else {
            $url = "TransferenciaBancoAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TransferenciaBancoEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TransferenciaBancoList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TransferenciaBancoAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TransferenciaBancoList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TransferenciaBancoDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "TransferenciaBancoList";
