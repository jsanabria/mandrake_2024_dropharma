 ...
 * Page class
 */
class ReporteSeniatNeView extends ReporteSeniatNe
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReporteSeniatNeView";
    ...
    // CSS class/style
    public $CurrentPageName = "ReporteSeniatNeView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ReporteSeniatNeList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ReporteSeniatNeList"; // No matching record, return to list
                    } else {
