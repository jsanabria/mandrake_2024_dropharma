 ...
 * Page class
 */
class PedidoOnlineDelete extends PedidoOnline
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PedidoOnlineDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PedidoOnlineDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PedidoOnlineList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("PedidoOnlineList"); // Return to list
                return;
            }
        }
