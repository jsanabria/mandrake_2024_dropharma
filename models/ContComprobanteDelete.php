 ...
 * Page class
 */
class ContComprobanteDelete extends ContComprobante
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContComprobanteDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ContComprobanteDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ContComprobanteList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ContComprobanteList"); // Return to list
                return;
            }
        }
