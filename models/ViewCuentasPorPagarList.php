 ...
 * Page class
 */
class ViewCuentasPorPagarList extends ViewCuentasPorPagar
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewCuentasPorPagarList";
    ...
    public $FormName = "fview_cuentas_por_pagarlist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ViewCuentasPorPagarList";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "ViewCuentasPorPagarDelete";
        $this->MultiUpdateUrl = "ViewCuentasPorPagarUpdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fview_cuentas_por_pagarsrch");
        }
        $filterList = Concat($filterList, $this->id->AdvancedSearch->toJson(), ","); // Field id
        $filterList = Concat($filterList, $this->proveedor->AdvancedSearch->toJson(), ","); // Field proveedor
        $filterList = Concat($filterList, $this->proveedor_rif->AdvancedSearch->toJson(), ","); // Field proveedor_rif
        $filterList = Concat($filterList, $this->proveedor_nombre->AdvancedSearch->toJson(), ","); // Field proveedor_nombre
        ...
        $filterList = Concat($filterList, $this->fecha_ultimo_pago->AdvancedSearch->toJson(), ","); // Field fecha_ultimo_pago
        ...
        $filterList = Concat($filterList, $this->signo_documento->AdvancedSearch->toJson(), ","); // Field signo_documento
        $filterList = Concat($filterList, $this->monto_documento_moneda->AdvancedSearch->toJson(), ","); // Field monto_documento_moneda
        $filterList = Concat($filterList, $this->monto_documento_bs->AdvancedSearch->toJson(), ","); // Field monto_documento_bs
        $filterList = Concat($filterList, $this->monto_documento_usd->AdvancedSearch->toJson(), ","); // Field monto_documento_usd
        $filterList = Concat($filterList, $this->monto_aplicado_bs->AdvancedSearch->toJson(), ","); // Field monto_aplicado_bs
        $filterList = Concat($filterList, $this->monto_aplicado_usd->AdvancedSearch->toJson(), ","); // Field monto_aplicado_usd
        $filterList = Concat($filterList, $this->total_pagado_bs->AdvancedSearch->toJson(), ","); // Field total_pagado_bs
        $filterList = Concat($filterList, $this->total_pagado_usd->AdvancedSearch->toJson(), ","); // Field total_pagado_usd
        $filterList = Concat($filterList, $this->cantidad_pagos->AdvancedSearch->toJson(), ","); // Field cantidad_pagos
        ...
        $filterList = Concat($filterList, $this->estado_cuenta->AdvancedSearch->toJson(), ","); // Field estado_cuenta
        $filterList = Concat($filterList, $this->dias_transcurridos->AdvancedSearch->toJson(), ","); // Field dias_transcurridos
        $filterList = Concat($filterList, $this->antiguedad->AdvancedSearch->toJson(), ","); // Field antiguedad
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fview_cuentas_por_pagarsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field proveedor_rif
        $this->proveedor_rif->AdvancedSearch->SearchValue = @$filter["x_proveedor_rif"];
        $this->proveedor_rif->AdvancedSearch->SearchOperator = @$filter["z_proveedor_rif"];
        $this->proveedor_rif->AdvancedSearch->SearchCondition = @$filter["v_proveedor_rif"];
        $this->proveedor_rif->AdvancedSearch->SearchValue2 = @$filter["y_proveedor_rif"];
        $this->proveedor_rif->AdvancedSearch->SearchOperator2 = @$filter["w_proveedor_rif"];
        $this->proveedor_rif->AdvancedSearch->save();

        // Field proveedor_nombre
        $this->proveedor_nombre->AdvancedSearch->SearchValue = @$filter["x_proveedor_nombre"];
        $this->proveedor_nombre->AdvancedSearch->SearchOperator = @$filter["z_proveedor_nombre"];
        $this->proveedor_nombre->AdvancedSearch->SearchCondition = @$filter["v_proveedor_nombre"];
        $this->proveedor_nombre->AdvancedSearch->SearchValue2 = @$filter["y_proveedor_nombre"];
        $this->proveedor_nombre->AdvancedSearch->SearchOperator2 = @$filter["w_proveedor_nombre"];
        $this->proveedor_nombre->AdvancedSearch->save();
        ...
        $this->fecha_ultimo_pago->AdvancedSearch->SearchValue = @$filter["x_fecha_ultimo_pago"];
        $this->fecha_ultimo_pago->AdvancedSearch->SearchOperator = @$filter["z_fecha_ultimo_pago"];
        $this->fecha_ultimo_pago->AdvancedSearch->SearchCondition = @$filter["v_fecha_ultimo_pago"];
        $this->fecha_ultimo_pago->AdvancedSearch->SearchValue2 = @$filter["y_fecha_ultimo_pago"];
        $this->fecha_ultimo_pago->AdvancedSearch->SearchOperator2 = @$filter["w_fecha_ultimo_pago"];
        $this->fecha_ultimo_pago->AdvancedSearch->save();
        ...
        // Field signo_documento
        $this->signo_documento->AdvancedSearch->SearchValue = @$filter["x_signo_documento"];
        $this->signo_documento->AdvancedSearch->SearchOperator = @$filter["z_signo_documento"];
        $this->signo_documento->AdvancedSearch->SearchCondition = @$filter["v_signo_documento"];
        $this->signo_documento->AdvancedSearch->SearchValue2 = @$filter["y_signo_documento"];
        $this->signo_documento->AdvancedSearch->SearchOperator2 = @$filter["w_signo_documento"];
        $this->signo_documento->AdvancedSearch->save();

        // Field monto_documento_moneda
        $this->monto_documento_moneda->AdvancedSearch->SearchValue = @$filter["x_monto_documento_moneda"];
        $this->monto_documento_moneda->AdvancedSearch->SearchOperator = @$filter["z_monto_documento_moneda"];
        $this->monto_documento_moneda->AdvancedSearch->SearchCondition = @$filter["v_monto_documento_moneda"];
        $this->monto_documento_moneda->AdvancedSearch->SearchValue2 = @$filter["y_monto_documento_moneda"];
        $this->monto_documento_moneda->AdvancedSearch->SearchOperator2 = @$filter["w_monto_documento_moneda"];
        $this->monto_documento_moneda->AdvancedSearch->save();

        // Field monto_documento_bs
        $this->monto_documento_bs->AdvancedSearch->SearchValue = @$filter["x_monto_documento_bs"];
        $this->monto_documento_bs->AdvancedSearch->SearchOperator = @$filter["z_monto_documento_bs"];
        $this->monto_documento_bs->AdvancedSearch->SearchCondition = @$filter["v_monto_documento_bs"];
        $this->monto_documento_bs->AdvancedSearch->SearchValue2 = @$filter["y_monto_documento_bs"];
        $this->monto_documento_bs->AdvancedSearch->SearchOperator2 = @$filter["w_monto_documento_bs"];
        $this->monto_documento_bs->AdvancedSearch->save();

        // Field monto_documento_usd
        $this->monto_documento_usd->AdvancedSearch->SearchValue = @$filter["x_monto_documento_usd"];
        $this->monto_documento_usd->AdvancedSearch->SearchOperator = @$filter["z_monto_documento_usd"];
        $this->monto_documento_usd->AdvancedSearch->SearchCondition = @$filter["v_monto_documento_usd"];
        $this->monto_documento_usd->AdvancedSearch->SearchValue2 = @$filter["y_monto_documento_usd"];
        $this->monto_documento_usd->AdvancedSearch->SearchOperator2 = @$filter["w_monto_documento_usd"];
        $this->monto_documento_usd->AdvancedSearch->save();

        // Field monto_aplicado_bs
        $this->monto_aplicado_bs->AdvancedSearch->SearchValue = @$filter["x_monto_aplicado_bs"];
        $this->monto_aplicado_bs->AdvancedSearch->SearchOperator = @$filter["z_monto_aplicado_bs"];
        $this->monto_aplicado_bs->AdvancedSearch->SearchCondition = @$filter["v_monto_aplicado_bs"];
        $this->monto_aplicado_bs->AdvancedSearch->SearchValue2 = @$filter["y_monto_aplicado_bs"];
        $this->monto_aplicado_bs->AdvancedSearch->SearchOperator2 = @$filter["w_monto_aplicado_bs"];
        $this->monto_aplicado_bs->AdvancedSearch->save();

        // Field monto_aplicado_usd
        $this->monto_aplicado_usd->AdvancedSearch->SearchValue = @$filter["x_monto_aplicado_usd"];
        $this->monto_aplicado_usd->AdvancedSearch->SearchOperator = @$filter["z_monto_aplicado_usd"];
        $this->monto_aplicado_usd->AdvancedSearch->SearchCondition = @$filter["v_monto_aplicado_usd"];
        $this->monto_aplicado_usd->AdvancedSearch->SearchValue2 = @$filter["y_monto_aplicado_usd"];
        $this->monto_aplicado_usd->AdvancedSearch->SearchOperator2 = @$filter["w_monto_aplicado_usd"];
        $this->monto_aplicado_usd->AdvancedSearch->save();

        // Field total_pagado_bs
        $this->total_pagado_bs->AdvancedSearch->SearchValue = @$filter["x_total_pagado_bs"];
        $this->total_pagado_bs->AdvancedSearch->SearchOperator = @$filter["z_total_pagado_bs"];
        $this->total_pagado_bs->AdvancedSearch->SearchCondition = @$filter["v_total_pagado_bs"];
        $this->total_pagado_bs->AdvancedSearch->SearchValue2 = @$filter["y_total_pagado_bs"];
        $this->total_pagado_bs->AdvancedSearch->SearchOperator2 = @$filter["w_total_pagado_bs"];
        $this->total_pagado_bs->AdvancedSearch->save();

        // Field total_pagado_usd
        $this->total_pagado_usd->AdvancedSearch->SearchValue = @$filter["x_total_pagado_usd"];
        $this->total_pagado_usd->AdvancedSearch->SearchOperator = @$filter["z_total_pagado_usd"];
        $this->total_pagado_usd->AdvancedSearch->SearchCondition = @$filter["v_total_pagado_usd"];
        $this->total_pagado_usd->AdvancedSearch->SearchValue2 = @$filter["y_total_pagado_usd"];
        $this->total_pagado_usd->AdvancedSearch->SearchOperator2 = @$filter["w_total_pagado_usd"];
        $this->total_pagado_usd->AdvancedSearch->save();

        // Field cantidad_pagos
        $this->cantidad_pagos->AdvancedSearch->SearchValue = @$filter["x_cantidad_pagos"];
        $this->cantidad_pagos->AdvancedSearch->SearchOperator = @$filter["z_cantidad_pagos"];
        $this->cantidad_pagos->AdvancedSearch->SearchCondition = @$filter["v_cantidad_pagos"];
        $this->cantidad_pagos->AdvancedSearch->SearchValue2 = @$filter["y_cantidad_pagos"];
        $this->cantidad_pagos->AdvancedSearch->SearchOperator2 = @$filter["w_cantidad_pagos"];
        $this->cantidad_pagos->AdvancedSearch->save();
        ...
        // Field estado_cuenta
        $this->estado_cuenta->AdvancedSearch->SearchValue = @$filter["x_estado_cuenta"];
        $this->estado_cuenta->AdvancedSearch->SearchOperator = @$filter["z_estado_cuenta"];
        $this->estado_cuenta->AdvancedSearch->SearchCondition = @$filter["v_estado_cuenta"];
        $this->estado_cuenta->AdvancedSearch->SearchValue2 = @$filter["y_estado_cuenta"];
        $this->estado_cuenta->AdvancedSearch->SearchOperator2 = @$filter["w_estado_cuenta"];
        $this->estado_cuenta->AdvancedSearch->save();
        ...
        // Field antiguedad
        $this->antiguedad->AdvancedSearch->SearchValue = @$filter["x_antiguedad"];
        $this->antiguedad->AdvancedSearch->SearchOperator = @$filter["z_antiguedad"];
        $this->antiguedad->AdvancedSearch->SearchCondition = @$filter["v_antiguedad"];
        $this->antiguedad->AdvancedSearch->SearchValue2 = @$filter["y_antiguedad"];
        $this->antiguedad->AdvancedSearch->SearchOperator2 = @$filter["w_antiguedad"];
        $this->antiguedad->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->proveedor_rif;
        $searchFlds[] = &$this->proveedor_nombre;
        ...
        $searchFlds[] = &$this->estado_cuenta;
        $searchFlds[] = &$this->antiguedad;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->fecha_ultimo_pago); // fecha_ultimo_pago
            $this->updateSort($this->monto_documento_bs); // monto_documento_bs
            $this->updateSort($this->total_pagado_bs); // total_pagado_bs
            $this->updateSort($this->saldo_bs); // saldo_bs
            $this->updateSort($this->antiguedad); // antiguedad
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->proveedor_rif->setSort("");
                $this->proveedor_nombre->setSort("");
                $this->tipo_documento->setSort("");
                $this->documento->setSort("");
                $this->nro_control->setSort("");
                $this->fecha->setSort("");
                $this->fecha_ultimo_pago->setSort("");
                ...
                $this->signo_documento->setSort("");
                $this->monto_documento_moneda->setSort("");
                $this->monto_documento_bs->setSort("");
                $this->monto_documento_usd->setSort("");
                $this->monto_aplicado_bs->setSort("");
                $this->monto_aplicado_usd->setSort("");
                $this->total_pagado_bs->setSort("");
                $this->total_pagado_usd->setSort("");
                $this->cantidad_pagos->setSort("");
                $this->saldo_bs->setSort("");
                $this->saldo_usd->setSort("");
                $this->estado_cuenta->setSort("");
                $this->dias_transcurridos->setSort("");
                $this->antiguedad->setSort("");
            }
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fview_cuentas_por_pagarlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fview_cuentas_por_pagarlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "fecha_ultimo_pago");
            $this->createColumnOption($option, "monto_documento_bs");
            $this->createColumnOption($option, "total_pagado_bs");
            $this->createColumnOption($option, "saldo_bs");
            $this->createColumnOption($option, "antiguedad");
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fview_cuentas_por_pagarsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fview_cuentas_por_pagarsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fview_cuentas_por_pagarlist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" form=\"fview_cuentas_por_pagarlist\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToExcel") . "</button>";
            } else {
                return "<a href=\"$exportUrl\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" form=\"fview_cuentas_por_pagarlist\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToWord") . "</button>";
            } else {
                return "<a href=\"$exportUrl\" class=\"btn btn-default ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPdf", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPdf", true)) . "\" form=\"fview_cuentas_por_pagarlist\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToPdf") . "</button>";
            } else {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fview_cuentas_por_pagarlist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fview_cuentas_por_pagarsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    */
    public function exportData($doc)
    {
        ...
        if (Config("EXPORT_MASTER_RECORD") && $this->DbMasterFilter != "" && $this->getCurrentMasterTable() == "view_cuentas_por_pagar_resumen") {
            $view_cuentas_por_pagar_resumen = new ViewCuentasPorPagarResumenList();
            $rsmaster = $view_cuentas_por_pagar_resumen->loadRs($this->DbMasterFilter); // Load master record
            if ($rsmaster) {
                $exportStyle = $doc->Style;
                $doc->setStyle("v"); // Change to vertical
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    $doc->setTable($view_cuentas_por_pagar_resumen);
                    $view_cuentas_por_pagar_resumen->exportDocument($doc, $rsmaster);
                    $doc->exportEmptyRow();
                    $doc->setTable($this);
                }
