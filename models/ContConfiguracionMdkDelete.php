 ...
 * Page class
 */
class ContConfiguracionMdkDelete extends ContConfiguracionMdk
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContConfiguracionMdkDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ContConfiguracionMdkDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ContConfiguracionMdkList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ContConfiguracionMdkList"); // Return to list
                return;
            }
        }
