...
/**
 * Table class for pagos_proveedor_factura
 */
class PagosProveedorFactura extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "pagos_proveedor_factura";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // pagos_proveedor
        $this->pagos_proveedor = new DbField(
            $this, // Table
            'x_pagos_proveedor', // Variable name
            'pagos_proveedor', // Name
            '`pagos_proveedor`', // Expression
            '`pagos_proveedor`', // Basic search expression
            19, // Type
            10, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`pagos_proveedor`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->pagos_proveedor->InputTextType = "text";
        $this->pagos_proveedor->Raw = true;
        $this->pagos_proveedor->IsForeignKey = true; // Foreign key field
        $this->pagos_proveedor->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->pagos_proveedor->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['pagos_proveedor'] = &$this->pagos_proveedor;
        ...
        $this->abono->Raw = true;
        $this->abono->Lookup = new Lookup($this->abono, 'pagos_proveedor_factura', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    public function getMasterFilterFromSession()
    {
        // Master filter
        $masterFilter = "";
        if ($this->getCurrentMasterTable() == "pagos_proveedor") {
            $masterTable = Container("pagos_proveedor");
            if ($this->pagos_proveedor->getSessionValue() != "") {
                $masterFilter .= "" . GetKeyFilter($masterTable->id, $this->pagos_proveedor->getSessionValue(), $masterTable->id->DataType, $masterTable->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "pagos_proveedor") {
            $masterTable = Container("pagos_proveedor");
            if ($this->pagos_proveedor->getSessionValue() != "") {
                $detailFilter .= "" . GetKeyFilter($this->pagos_proveedor, $this->pagos_proveedor->getSessionValue(), $masterTable->id->DataType, $this->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getMasterFilter($masterTable, $keys)
    {
        ...
        switch ($masterTable->TableVar) {
            case "pagos_proveedor":
                ...
                if ($validKeys) {
                    return GetKeyFilter($masterTable->id, $keys["pagos_proveedor"], $this->pagos_proveedor->DataType, $this->Dbid);
                }
                break;
        }
    ...
    public function getDetailFilter($masterTable)
    {
        switch ($masterTable->TableVar) {
            case "pagos_proveedor":
                return GetKeyFilter($this->pagos_proveedor, $masterTable->id->DbValue, $masterTable->id->DataType, $masterTable->Dbid);
        }
        return "";
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "pagos_proveedor_factura";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->pagos_proveedor->DbValue = $row['pagos_proveedor'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PagosProveedorFacturaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "PagosProveedorFacturaView" => $Language->phrase("View"),
            "PagosProveedorFacturaEdit" => $Language->phrase("Edit"),
            "PagosProveedorFacturaAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "PagosProveedorFacturaList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "PagosProveedorFacturaView",
            Config("API_ADD_ACTION") => "PagosProveedorFacturaAdd",
            Config("API_EDIT_ACTION") => "PagosProveedorFacturaEdit",
            Config("API_DELETE_ACTION") => "PagosProveedorFacturaDelete",
            Config("API_LIST_ACTION") => "PagosProveedorFacturaList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PagosProveedorFacturaView", $parm);
        } else {
            $url = $this->keyUrl("PagosProveedorFacturaView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "PagosProveedorFacturaAdd?" . $parm;
        } else {
            $url = "PagosProveedorFacturaAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PagosProveedorFacturaEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PagosProveedorFacturaList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PagosProveedorFacturaAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PagosProveedorFacturaList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("PagosProveedorFacturaDelete", $parm);
        }
    }
    ...
    {
        if ($this->getCurrentMasterTable() == "pagos_proveedor" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->pagos_proveedor->getSessionValue()); // Use Session Value
        }
        return $url;
    }
    ...
    {
        global $Response;
        $listPage = "PagosProveedorFacturaList";
    ...
    public function renderListRow()
    {
        ...
        // pagos_proveedor
        $this->pagos_proveedor->HrefValue = "";
        $this->pagos_proveedor->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // pagos_proveedor
        $this->pagos_proveedor->setupEditAttributes();
        if ($this->pagos_proveedor->getSessionValue() != "") {
            $this->pagos_proveedor->CurrentValue = GetForeignKeyValue($this->pagos_proveedor->getSessionValue());
            $this->pagos_proveedor->ViewValue = $this->pagos_proveedor->CurrentValue;
        } else {
            $this->pagos_proveedor->EditValue = $this->pagos_proveedor->CurrentValue;
            $this->pagos_proveedor->PlaceHolder = RemoveHtml($this->pagos_proveedor->caption());
            if (strval($this->pagos_proveedor->EditValue) != "" && is_numeric($this->pagos_proveedor->EditValue)) {
                $this->pagos_proveedor->EditValue = $this->pagos_proveedor->EditValue;
            }
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->pagos_proveedor);
                    $doc->exportCaption($this->tipo_documento);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->pagos_proveedor);
                        $doc->exportField($this->tipo_documento);
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'pagos_proveedor_factura');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'pagos_proveedor_factura', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'pagos_proveedor_factura', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'pagos_proveedor_factura', $fldname, $key, $oldvalue);
            }
        }
    }
    ...
    public function rowDeleted($rs) {
    	...
    	$sql = "SELECT SUM(monto) AS monto
    			...
    			WHERE pagos_proveedor = " . $rs["pagos_proveedor"]. ";";
    	$monto = floatval(ExecuteScalar($sql));
    	$sql = "UPDATE pagos_proveedor
    			SET
     				monto = $monto 
    			WHERE id = " . $rs["pagos_proveedor"] . ";";
    	Execute($sql);
    }
