 ...
 * Page class
 */
class ProveedorArticuloView extends ProveedorArticulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProveedorArticuloView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProveedorArticuloView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ProveedorArticuloList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProveedorArticuloList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
