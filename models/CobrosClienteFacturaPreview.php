 ...
 * Page class
 */
class CobrosClienteFacturaPreview extends CobrosClienteFactura
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CobrosClienteFacturaPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "CobrosClienteFacturaPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "cobros_cliente") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=cobros_cliente&" . GetForeignKeyUrl("fk_id", $this->cobros_cliente->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "cobros_cliente") {
            $this->cobros_cliente->setQueryStringValue($keys[0] ?? "");
        }
    }
