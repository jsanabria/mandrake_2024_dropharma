 ...
 * Page class
 */
class ContPeriodoContableEdit extends ContPeriodoContable
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContPeriodoContableEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ContPeriodoContableEdit";
    ...
    public function run()
    {
        ...
        $this->setVisibility();
        $this->fecha_inicio->Required = false;
        $this->fecha_fin->Required = false;
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ContPeriodoContableList"); // Return to list page
                        return;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ContPeriodoContableList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "ContPeriodoContableList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ContPeriodoContableList") {
                            ...
                            $returnUrl = "ContPeriodoContableList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ContPeriodoContableList"), "", $this->TableVar, true);
        $pageId = "edit";
