 ...
 * Page class
 */
class PedidioDetalleOnlineGrid extends PedidioDetalleOnline
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PedidioDetalleOnlineGrid";
    ...
    public $FormName = "fpedidio_detalle_onlinegrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "PedidioDetalleOnlineGrid";
    ...
    protected function editRow()
    {
        ...
        // Check referential integrity for master table 'pedido_online'
        $detailKeys = [];
        $keyValue = $rsnew['id_documento'] ?? $rsold['id_documento'];
        $detailKeys['id_documento'] = $keyValue;
        $keyValue = $rsnew['tipo_documento'] ?? $rsold['tipo_documento'];
        $detailKeys['tipo_documento'] = $keyValue;
        ...
        if (!$validMasterRecord) {
            $relatedRecordMsg = str_replace("%t", "pedido_online", $Language->phrase("RelatedRecordRequired"));
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'pedidio_detalle_online'
        $validMasterRecord = true;
        $detailKeys = [];
        $detailKeys["id_documento"] = $this->id_documento->getSessionValue();
        $detailKeys["tipo_documento"] = $this->tipo_documento->getSessionValue();
        $masterTable = Container("pedido_online");
        $masterFilter = $this->getMasterFilter($masterTable, $detailKeys);
        if (!EmptyValue($masterFilter)) {
            $rsmaster = $masterTable->loadRs($masterFilter)->fetch();
