 ...
 * Page class
 */
class ViewOutTdcfcvEdit extends ViewOutTdcfcv
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewOutTdcfcvEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewOutTdcfcvEdit";
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ViewOutTdcfcvList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "ViewOutTdcfcvList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ViewOutTdcfcvList") {
                            ...
                            $returnUrl = "ViewOutTdcfcvList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
