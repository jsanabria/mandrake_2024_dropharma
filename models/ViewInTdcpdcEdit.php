 ...
 * Page class
 */
class ViewInTdcpdcEdit extends ViewInTdcpdc
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewInTdcpdcEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewInTdcpdcEdit";
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ViewInTdcpdcList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "ViewInTdcpdcList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ViewInTdcpdcList") {
                            ...
                            $returnUrl = "ViewInTdcpdcList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function validateForm()
    {
        ...
        if (in_array("view_in", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("ViewInGrid");
            if (in_array("view_in", $detailTblVar) && $detailPage->DetailEdit && $editRow) {
                $Security->loadCurrentUserLevel($this->ProjectID . "view_in"); // Load user level of detail table
