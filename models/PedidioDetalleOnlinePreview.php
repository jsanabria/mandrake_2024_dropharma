 ...
 * Page class
 */
class PedidioDetalleOnlinePreview extends PedidioDetalleOnline
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PedidioDetalleOnlinePreview";
    ...
    // CSS class/style
    public $CurrentPageName = "PedidioDetalleOnlinePreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "pedido_online") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=pedido_online&" . GetForeignKeyUrl("fk_id", $this->id_documento->QueryStringValue) . "&" . GetForeignKeyUrl("fk_tipo_documento", $this->tipo_documento->QueryStringValue) . "";
        }
        return $url;
    }
