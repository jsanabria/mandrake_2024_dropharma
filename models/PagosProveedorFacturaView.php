 ...
 * Page class
 */
class PagosProveedorFacturaView extends PagosProveedorFactura
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PagosProveedorFacturaView";
    ...
    // CSS class/style
    public $CurrentPageName = "PagosProveedorFacturaView";
    ...
    public function setVisibility()
    {
        ...
        $this->pagos_proveedor->setVisibility();
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "PagosProveedorFacturaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("PagosProveedorFacturaList"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "PagosProveedorFacturaList"; // No matching record, return to list
                    } else {
