...
/**
 * Table class for view_tarifa
 */
class ViewTarifa extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->tarifa->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_tarifa";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewTarifaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewTarifaView" => $Language->phrase("View"),
            "ViewTarifaEdit" => $Language->phrase("Edit"),
            "ViewTarifaAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewTarifaView",
            Config("API_ADD_ACTION") => "ViewTarifaAdd",
            Config("API_EDIT_ACTION") => "ViewTarifaEdit",
            Config("API_DELETE_ACTION") => "ViewTarifaDelete",
            Config("API_LIST_ACTION") => "ViewTarifaList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewTarifaView", $parm);
        } else {
            $url = $this->keyUrl("ViewTarifaView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewTarifaEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewTarifaList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewTarifaAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewTarifaList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewTarifaDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->tarifa->Raw) {
            $this->tarifa->CurrentValue = HtmlDecode($this->tarifa->CurrentValue);
        }
