 ...
 * Page class
 */
class AlicuotaDelete extends Alicuota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AlicuotaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "AlicuotaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AlicuotaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("AlicuotaList"); // Return to list
                return;
            }
        }
