 ...
 * Page class
 */
class AsesorClienteAdd extends AsesorCliente
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AsesorClienteAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "AsesorClienteAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("AsesorClienteList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "AsesorClienteList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "AsesorClienteView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "AsesorClienteList") {
                            ...
                            $returnUrl = "AsesorClienteList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("AsesorClienteList"), "", $this->TableVar, true);
