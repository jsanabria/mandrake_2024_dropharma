 ...
 * Page class
 */
class ViewAudittrailSeniatList extends ViewAudittrailSeniat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewAudittrailSeniatList";
    ...
    public $FormName = "fview_audittrail_seniatlist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ViewAudittrailSeniatList";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_audittrail_seniat';
        $this->TableName = 'view_audittrail_seniat';
        ...
        // Table object (view_audittrail_seniat)
        if (!isset($GLOBALS["view_audittrail_seniat"]) || $GLOBALS["view_audittrail_seniat"]::class == PROJECT_NAMESPACE . "view_audittrail_seniat") {
            $GLOBALS["view_audittrail_seniat"] = &$this;
        }
        ...
        // Initialize URLs
        $this->AddUrl = "ViewAudittrailSeniatAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "ViewAudittrailSeniatDelete";
        $this->MultiUpdateUrl = "ViewAudittrailSeniatUpdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'view_audittrail_seniat');
        }
        ...
        if ($url != "") {
            ...
            if ($this->IsModal) { // Show as modal
                ...
                if (!SameString($pageName, GetPageName($this->getListUrl()))) { // Not List page
                    ...
                    $result["view"] = SameString($pageName, "ViewAudittrailSeniatView"); // If View page, no primary button
                } else { // List page
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "fview_audittrail_seniatgrid";
        }
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fview_audittrail_seniatsrch");
        }
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fview_audittrail_seniatsrch", $filters);
    ...
    public function showFilterList()
    {
        ...
        // Field field
        $filter = $this->queryBuilderWhere("field");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->field, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->field->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field keyvalue
        $filter = $this->queryBuilderWhere("keyvalue");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->keyvalue, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->keyvalue->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field oldvalue
        $filter = $this->queryBuilderWhere("oldvalue");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->oldvalue, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->oldvalue->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field newvalue
        $filter = $this->queryBuilderWhere("newvalue");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->newvalue, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->newvalue->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }
        if ($this->BasicSearch->Keyword != "") {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"view_audittrail_seniat\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fview_audittrail_seniatlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fview_audittrail_seniatlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"view_audittrail_seniat\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "oldvalue");
            $this->createColumnOption($option, "newvalue");
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fview_audittrail_seniatsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fview_audittrail_seniatsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fview_audittrail_seniatlist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_view_audittrail_seniat", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_view_audittrail_seniat",
    ...
    protected function loadSearchValues()
    {
        ...
        // field
        if ($this->field->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->field->AdvancedSearch->SearchValue != "" || $this->field->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // keyvalue
        if ($this->keyvalue->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->keyvalue->AdvancedSearch->SearchValue != "" || $this->keyvalue->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // oldvalue
        if ($this->oldvalue->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->oldvalue->AdvancedSearch->SearchValue != "" || $this->oldvalue->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // newvalue
        if ($this->newvalue->AdvancedSearch->get()) {
            $hasValue = true;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->keyvalue->EditValue = HtmlEncode($this->keyvalue->AdvancedSearch->SearchValue);
            $this->keyvalue->PlaceHolder = RemoveHtml($this->keyvalue->caption());

            // oldvalue
            $this->oldvalue->setupEditAttributes();
            $this->oldvalue->EditValue = HtmlEncode($this->oldvalue->AdvancedSearch->SearchValue);
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fview_audittrail_seniatsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
