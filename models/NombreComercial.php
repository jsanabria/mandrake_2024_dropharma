...
/**
 * Table class for nombre_comercial
 */
class NombreComercial extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "nombre_comercial";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "nombre_comercial";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("NombreComercialList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "NombreComercialView" => $Language->phrase("View"),
            "NombreComercialEdit" => $Language->phrase("Edit"),
            "NombreComercialAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "NombreComercialView",
            Config("API_ADD_ACTION") => "NombreComercialAdd",
            Config("API_EDIT_ACTION") => "NombreComercialEdit",
            Config("API_DELETE_ACTION") => "NombreComercialDelete",
            Config("API_LIST_ACTION") => "NombreComercialList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("NombreComercialView", $parm);
        } else {
            $url = $this->keyUrl("NombreComercialView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "NombreComercialAdd?" . $parm;
        } else {
            $url = "NombreComercialAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NombreComercialEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NombreComercialList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NombreComercialAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NombreComercialList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("NombreComercialDelete", $parm);
        }
    }
