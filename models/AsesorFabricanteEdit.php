 ...
 * Page class
 */
class AsesorFabricanteEdit extends AsesorFabricante
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AsesorFabricanteEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "AsesorFabricanteEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("AsesorFabricanteList"); // Return to list page
                        return;
