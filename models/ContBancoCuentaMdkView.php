 ...
 * Page class
 */
class ContBancoCuentaMdkView extends ContBancoCuentaMdk
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContBancoCuentaMdkView";
    ...
    // CSS class/style
    public $CurrentPageName = "ContBancoCuentaMdkView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ContBancoCuentaMdkList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ContBancoCuentaMdkList"; // No matching record, return to list
                    } else {
