 ...
 * Page class
 */
class ContMetodoCuentaMdkEdit extends ContMetodoCuentaMdk
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContMetodoCuentaMdkEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ContMetodoCuentaMdkEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ContMetodoCuentaMdkList"); // Return to list page
                        return;
    ...
    protected function editRow()
    {
        ...
        // Check field with unique index (metodo_pago)
        if ($this->metodo_pago->CurrentValue != "") {
            $filterChk = "(`metodo_pago` = '" . AdjustSql($this->metodo_pago->CurrentValue, $this->Dbid) . "')";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // tipo_destino
        $this->tipo_destino->setDbValueDef($rsnew, $this->tipo_destino->CurrentValue, $this->tipo_destino->ReadOnly);

        // cuenta_id
        $this->cuenta_id->setDbValueDef($rsnew, $this->cuenta_id->CurrentValue, $this->cuenta_id->ReadOnly);

        // forzar_destino
        $this->forzar_destino->setDbValueDef($rsnew, $this->forzar_destino->CurrentValue, $this->forzar_destino->ReadOnly);
