...
/**
 * Table class for ftp_fact_pedi_procesado
 */
class FtpFactPediProcesado extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "ftp_fact_pedi_procesado";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // pedido
        $this->pedido = new DbField(
            $this, // Table
            'x_pedido', // Variable name
            'pedido', // Name
            '`pedido`', // Expression
            '`pedido`', // Basic search expression
            200, // Type
            50, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`pedido`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->pedido->InputTextType = "text";
        $this->pedido->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        $this->fecha_hora = new DbField(
            ...
            CastDateFieldForLike("`fecha_hora`", 0, "DB"), // Basic search expression
            135, // Type
            19, // Size
            0, // Date/Time format
            false, // Is upload field
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "ftp_fact_pedi_procesado";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("FtpFactPediProcesadoList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "FtpFactPediProcesadoView" => $Language->phrase("View"),
            "FtpFactPediProcesadoEdit" => $Language->phrase("Edit"),
            "FtpFactPediProcesadoAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "FtpFactPediProcesadoList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "FtpFactPediProcesadoView",
            Config("API_ADD_ACTION") => "FtpFactPediProcesadoAdd",
            Config("API_EDIT_ACTION") => "FtpFactPediProcesadoEdit",
            Config("API_DELETE_ACTION") => "FtpFactPediProcesadoDelete",
            Config("API_LIST_ACTION") => "FtpFactPediProcesadoList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("FtpFactPediProcesadoView", $parm);
        } else {
            $url = $this->keyUrl("FtpFactPediProcesadoView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "FtpFactPediProcesadoAdd?" . $parm;
        } else {
            $url = "FtpFactPediProcesadoAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FtpFactPediProcesadoEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FtpFactPediProcesadoList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FtpFactPediProcesadoAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FtpFactPediProcesadoList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("FtpFactPediProcesadoDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "FtpFactPediProcesadoList";
