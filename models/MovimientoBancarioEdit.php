 ...
 * Page class
 */
class MovimientoBancarioEdit extends MovimientoBancario
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MovimientoBancarioEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "MovimientoBancarioEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("MovimientoBancarioList"); // Return to list page
                        return;
