...
/**
 * Table class for pedidos_detalles_online_bitacora
 */
class PedidosDetallesOnlineBitacora extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "pedidos_detalles_online_bitacora";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // cantidad_solicitada
        $this->cantidad_solicitada = new DbField(
            $this, // Table
            'x_cantidad_solicitada', // Variable name
            'cantidad_solicitada', // Name
            '`cantidad_solicitada`', // Expression
            '`cantidad_solicitada`', // Basic search expression
            131, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`cantidad_solicitada`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->cantidad_solicitada->InputTextType = "text";
        $this->cantidad_solicitada->Raw = true;
        $this->cantidad_solicitada->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->cantidad_solicitada->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['cantidad_solicitada'] = &$this->cantidad_solicitada;

        // cantidadasignada
        $this->cantidadasignada = new DbField(
            $this, // Table
            'x_cantidadasignada', // Variable name
            'cantidadasignada', // Name
            '`cantidadasignada`', // Expression
            '`cantidadasignada`', // Basic search expression
            131, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`cantidadasignada`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->cantidadasignada->InputTextType = "text";
        $this->cantidadasignada->Raw = true;
        $this->cantidadasignada->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->cantidadasignada->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['cantidadasignada'] = &$this->cantidadasignada;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "pedidos_detalles_online_bitacora";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->cantidad_solicitada->DbValue = $row['cantidad_solicitada'];
        $this->cantidadasignada->DbValue = $row['cantidadasignada'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PedidosDetallesOnlineBitacoraList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "PedidosDetallesOnlineBitacoraView" => $Language->phrase("View"),
            "PedidosDetallesOnlineBitacoraEdit" => $Language->phrase("Edit"),
            "PedidosDetallesOnlineBitacoraAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "PedidosDetallesOnlineBitacoraList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "PedidosDetallesOnlineBitacoraView",
            Config("API_ADD_ACTION") => "PedidosDetallesOnlineBitacoraAdd",
            Config("API_EDIT_ACTION") => "PedidosDetallesOnlineBitacoraEdit",
            Config("API_DELETE_ACTION") => "PedidosDetallesOnlineBitacoraDelete",
            Config("API_LIST_ACTION") => "PedidosDetallesOnlineBitacoraList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PedidosDetallesOnlineBitacoraView", $parm);
        } else {
            $url = $this->keyUrl("PedidosDetallesOnlineBitacoraView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "PedidosDetallesOnlineBitacoraAdd?" . $parm;
        } else {
            $url = "PedidosDetallesOnlineBitacoraAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PedidosDetallesOnlineBitacoraEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PedidosDetallesOnlineBitacoraList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PedidosDetallesOnlineBitacoraAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PedidosDetallesOnlineBitacoraList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("PedidosDetallesOnlineBitacoraDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "PedidosDetallesOnlineBitacoraList";
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->cantidad_solicitada);
                    $doc->exportCaption($this->cantidadasignada);
                } else {
                    $doc->exportCaption($this->id);
                    $doc->exportCaption($this->id_documento);
                    $doc->exportCaption($this->fabricante);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->cantidad_solicitada);
                        $doc->exportField($this->cantidadasignada);
                    } else {
                        $doc->exportField($this->id);
                        $doc->exportField($this->id_documento);
                        $doc->exportField($this->fabricante);
