 ...
 * Page class
 */
class ConceptosBancariosView extends ConceptosBancarios
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConceptosBancariosView";
    ...
    // CSS class/style
    public $CurrentPageName = "ConceptosBancariosView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ConceptosBancariosList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ConceptosBancariosList"; // No matching record, return to list
                    } else {
