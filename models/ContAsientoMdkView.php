 ...
 * Page class
 */
class ContAsientoMdkView extends ContAsientoMdk
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContAsientoMdkView";
    ...
    // CSS class/style
    public $CurrentPageName = "ContAsientoMdkView";
    ...
    public function setVisibility()
    {
        ...
        $this->tercero_id->setVisibility();
        $this->moneda_trx->setVisibility();
        $this->tasa_trx->setVisibility();
        $this->total_moneda_trx->setVisibility();
        $this->total_bs->setVisibility();
        $this->centro_costo_id->setVisibility();
        $this->_username->setVisibility();
        $this->created_at->setVisibility();
        $this->anulado->setVisibility();
        $this->anulado_at->setVisibility();
        $this->anulado_by->setVisibility();
        $this->anulado_motivo->setVisibility();
    }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ContAsientoMdkList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ContAsientoMdkList"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ContAsientoMdkList"; // No matching record, return to list
                    } else {
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $item = &$option->add("detail_cont_asiento_detalle_mdk");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->tablePhrase("cont_asiento_detalle_mdk", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ContAsientoDetalleMdkList?" . Config("TABLE_SHOW_MASTER") . "=cont_asiento_mdk&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'cont_asiento_mdk')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=cont_asiento_detalle_mdk"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
        ...
        if ($item->Visible) {
            ...
            $detailTableLink .= "cont_asiento_detalle_mdk";
        }
    ...
    protected function setupDetailParms()
    {
        ...
        if ($detailTblVar != "") {
            ...
            if (in_array("cont_asiento_detalle_mdk", $detailTblVar)) {
                $detailPageObj = Container("ContAsientoDetalleMdkGrid");
                if ($detailPageObj->DetailView) {
                    ...
                    $detailPageObj->asiento_id->IsDetailKey = true;
                    $detailPageObj->asiento_id->CurrentValue = $this->id->CurrentValue;
                    $detailPageObj->asiento_id->setSessionValue($detailPageObj->asiento_id->CurrentValue);
                }
            }
        }
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ContAsientoMdkList"), "", $this->TableVar, true);
        $pageId = "view";
