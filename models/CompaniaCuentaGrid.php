 ...
 * Page class
 */
class CompaniaCuentaGrid extends CompaniaCuenta
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CompaniaCuentaGrid";
    ...
    public $FormName = "fcompania_cuentagrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "CompaniaCuentaGrid";
    ...
    public function emptyRow()
    {
        ...
        if (
            $CurrentForm->hasValue("x_numero") &&
            $CurrentForm->hasValue("o_numero") &&
            $this->numero->CurrentValue != $this->numero->DefaultValue &&
            !($this->numero->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->numero->CurrentValue == $this->numero->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_mostrar") &&
            $CurrentForm->hasValue("o_mostrar") &&
            $this->mostrar->CurrentValue != $this->mostrar->DefaultValue &&
            !($this->mostrar->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->mostrar->CurrentValue == $this->mostrar->getSessionValue())
        ) {
            return false;
        }
        if (
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_mostrar")) {
            $this->mostrar->setOldValue($CurrentForm->getValue("o_mostrar"));
        }
    ...
    protected function editRow()
    {
        ...
        // Check referential integrity for master table 'compania'
        $detailKeys = [];
        $keyValue = $rsnew['compania'] ?? $rsold['compania'];
        $detailKeys['compania'] = $keyValue;
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['mostrar'])) { // mostrar
            $this->mostrar->CurrentValue = $row['mostrar'];
        }
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "compania") {
            $this->compania->Visible = true; // Need to insert foreign key
            $this->compania->CurrentValue = $this->compania->getSessionValue();
        }
