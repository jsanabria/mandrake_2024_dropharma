 ...
 * Page class
 */
class ArticuloUnidadMedidaEdit extends ArticuloUnidadMedida
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArticuloUnidadMedidaEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ArticuloUnidadMedidaEdit";
    ...
    public function run()
    {
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ArticuloUnidadMedidaList"); // Return to list page
                        return;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ArticuloUnidadMedidaList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "ArticuloUnidadMedidaList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "ArticuloUnidadMedidaList") {
                            ...
                            $returnUrl = "ArticuloUnidadMedidaList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ArticuloUnidadMedidaList"), "", $this->TableVar, true);
        $pageId = "edit";
