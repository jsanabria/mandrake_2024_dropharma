 ...
 * Page class
 */
class PurgaDetalleEdit extends PurgaDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PurgaDetalleEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "PurgaDetalleEdit";
    ...
    public function run()
    {
        ...
        $this->setVisibility();
        $this->fabricante->Required = false;
        $this->articulo->Required = false;
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("PurgaDetalleList"); // Return to list page
                        return;
