...
/**
 * Table class for view_temp_tarifa
 */
class ViewTempTarifa extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "view_temp_tarifa";
        $this->TableName = 'view_temp_tarifa';
        $this->TableType = "VIEW";
        $this->ImportUseTransaction = $this->supportsTransaction() && Config("IMPORT_USE_TRANSACTION");
        $this->UseTransaction = $this->supportsTransaction() && Config("USE_TRANSACTION");

        // Update Table
        $this->UpdateTable = "view_temp_tarifa";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_temp_tarifa";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewTempTarifaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewTempTarifaView" => $Language->phrase("View"),
            "ViewTempTarifaEdit" => $Language->phrase("Edit"),
            "ViewTempTarifaAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewTempTarifaView",
            Config("API_ADD_ACTION") => "ViewTempTarifaAdd",
            Config("API_EDIT_ACTION") => "ViewTempTarifaEdit",
            Config("API_DELETE_ACTION") => "ViewTempTarifaDelete",
            Config("API_LIST_ACTION") => "ViewTempTarifaList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewTempTarifaView", $parm);
        } else {
            $url = $this->keyUrl("ViewTempTarifaView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewTempTarifaAdd?" . $parm;
        } else {
            $url = "ViewTempTarifaAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewTempTarifaEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewTempTarifaList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewTempTarifaAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewTempTarifaList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewTempTarifaDelete", $parm);
        }
    }
