...
class Notificaciones extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // Nnotificaciones
        $this->Nnotificaciones = new DbField(
            $this, // Table
            'x_Nnotificaciones', // Variable name
            'Nnotificaciones', // Name
            '`Nnotificaciones`', // Expression
            '`Nnotificaciones`', // Basic search expression
            19, // Type
            10, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Nnotificaciones`', // Virtual expression
            false, // Is virtual
        ...
        $this->tipo->addMethod("getSelectFilter", fn() => "`codigo` = '015'");
        ...
        $this->tipo->Lookup = new Lookup($this->tipo, 'parametro', false, 'valor1', ["valor2","","",""], '', '', [], [], [], [], [], [], false, '`valor1`', '', "`valor2`");
        $this->tipo->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['tipo'] = &$this->tipo;

        // notificar
        $this->notificar = new DbField(
            $this, // Table
            'x_notificar', // Variable name
            'notificar', // Name
            '`notificar`', // Expression
            '`notificar`', // Basic search expression
            200, // Type
            50, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`notificar`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->notificar->addMethod("getSelectFilter", fn() => "`codigo` = '016'");
        $this->notificar->InputTextType = "text";
        $this->notificar->setSelectMultiple(false); // Select one
        ...
        $this->notificar->Lookup = new Lookup($this->notificar, 'parametro', false, 'valor1', ["valor2","","",""], '', '', [], [], [], [], [], [], false, '`valor1`', '', "`valor2`");
        $this->notificar->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['notificar'] = &$this->notificar;

        // asunto
        $this->asunto = new DbField(
            $this, // Table
            'x_asunto', // Variable name
            'asunto', // Name
            '`asunto`', // Expression
            '`asunto`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`asunto`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->asunto->InputTextType = "text";
        $this->asunto->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['asunto'] = &$this->asunto;

        // notificacion
        $this->notificacion = new DbField(
            $this, // Table
            'x_notificacion', // Variable name
            'notificacion', // Name
            '`notificacion`', // Expression
            '`notificacion`', // Basic search expression
            201, // Type
            2147483647, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`notificacion`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->notificacion->InputTextType = "text";
        $this->notificacion->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['notificacion'] = &$this->notificacion;

        // notificados
        $this->notificados = new DbField(
            $this, // Table
            'x_notificados', // Variable name
            'notificados', // Name
            '`notificados`', // Expression
            '`notificados`', // Basic search expression
            201, // Type
            2147483647, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`notificados`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->notificados->InputTextType = "text";
        $this->notificados->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['notificados'] = &$this->notificados;

        // notificados_efectivos
        $this->notificados_efectivos = new DbField(
            $this, // Table
            'x_notificados_efectivos', // Variable name
            'notificados_efectivos', // Name
            '`notificados_efectivos`', // Expression
            '`notificados_efectivos`', // Basic search expression
            201, // Type
            2147483647, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`notificados_efectivos`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->notificados_efectivos->InputTextType = "text";
        $this->notificados_efectivos->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        // enviado
        $this->enviado = new DbField(
            $this, // Table
            'x_enviado', // Variable name
            'enviado', // Name
            '`enviado`', // Expression
            '`enviado`', // Basic search expression
            129, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`enviado`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->enviado->addMethod("getDefault", fn() => "0");
        $this->enviado->InputTextType = "text";
        $this->enviado->setSelectMultiple(false); // Select one
        ...
        $this->enviado->Lookup = new Lookup($this->enviado, 'notificaciones', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->enviado->OptionCount = 2;
        $this->enviado->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        ...
        $this->adjunto->SearchOperators = ["=", "<>", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['Nnotificaciones']) && !EmptyValue($this->Nnotificaciones->CurrentValue)) {
                $rs['Nnotificaciones'] = $this->Nnotificaciones->CurrentValue;
            }
        }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            ...
            $val = !EmptyValue($this->Nnotificaciones->OldValue) && !$current ? $this->Nnotificaciones->OldValue : $this->Nnotificaciones->CurrentValue;
        }
        if (!is_numeric($val)) {
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "NotificacionesView" => $Language->phrase("View"),
            "NotificacionesEdit" => $Language->phrase("Edit"),
            "NotificacionesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "NotificacionesView",
            Config("API_ADD_ACTION") => "NotificacionesAdd",
            Config("API_EDIT_ACTION") => "NotificacionesEdit",
            Config("API_DELETE_ACTION") => "NotificacionesDelete",
            Config("API_LIST_ACTION") => "NotificacionesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("NotificacionesView", $parm);
        } else {
            $url = $this->keyUrl("NotificacionesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NotificacionesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NotificacionesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NotificacionesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NotificacionesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("NotificacionesDelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"Nnotificaciones\":" . VarToJson($this->Nnotificaciones->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->Nnotificaciones->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->Nnotificaciones->CurrentValue);
        } else {
    ...
    public function renderEditRow()
    {
        ...
        // Nnotificaciones
        $this->Nnotificaciones->setupEditAttributes();
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'notificaciones');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'notificaciones', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'notificaciones', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'notificaciones', $fldname, $key, $oldvalue);
            }
        }
    }
