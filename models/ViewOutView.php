 ...
 * Page class
 */
class ViewOutView extends ViewOut
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewOutView";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewOutView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ViewOutList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ViewOutList"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ViewOutList"; // No matching record, return to list
                    } else {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewOutList"), "", $this->TableVar, true);
        $pageId = "view";
