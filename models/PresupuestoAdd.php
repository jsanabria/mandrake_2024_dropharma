 ...
 * Page class
 */
class PresupuestoAdd extends Presupuesto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PresupuestoAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "PresupuestoAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PresupuestoView") {
    ...
    protected function getAddRow()
    {
        ...
        // cliente_potencial
        $this->cliente_potencial->setDbValueDef($rsnew, $this->cliente_potencial->CurrentValue, false);
        ...
        // proyecto
        $this->proyecto->setDbValueDef($rsnew, $this->proyecto->CurrentValue, false);

        // estatus
        $this->estatus->setDbValueDef($rsnew, $this->estatus->CurrentValue, false);
        return $rsnew;
    }
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['cliente_potencial'])) { // cliente_potencial
            $this->cliente_potencial->setFormValue($row['cliente_potencial']);
        }
        ...
        if (isset($row['proyecto'])) { // proyecto
            $this->proyecto->setFormValue($row['proyecto']);
        }
        if (isset($row['estatus'])) { // estatus
            $this->estatus->setFormValue($row['estatus']);
        }
    }
