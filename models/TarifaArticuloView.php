 ...
 * Page class
 */
class TarifaArticuloView extends TarifaArticulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TarifaArticuloView";
    ...
    // CSS class/style
    public $CurrentPageName = "TarifaArticuloView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "TarifaArticuloList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TarifaArticuloList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
