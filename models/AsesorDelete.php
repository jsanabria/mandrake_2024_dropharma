 ...
 * Page class
 */
class AsesorDelete extends Asesor
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AsesorDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "AsesorDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AsesorList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("AsesorList"); // Return to list
                return;
            }
        }
