...
/**
 * Table class for view_out_tdcasa
 */
class ViewOutTdcasa extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_out_tdcasa";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->estatus->Lookup = new Lookup($this->estatus, 'view_out_tdcasa', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->documento->Lookup = new Lookup($this->documento, 'view_out_tdcasa', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->entregado->Lookup = new Lookup($this->entregado, 'view_out_tdcasa', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->pagado->Lookup = new Lookup($this->pagado, 'view_out_tdcasa', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->consignacion->Lookup = new Lookup($this->consignacion, 'view_out_tdcasa', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->factura->Lookup = new Lookup($this->factura, 'view_out_tdcasa', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->activo->Lookup = new Lookup($this->activo, 'view_out_tdcasa', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->cerrado->Lookup = new Lookup($this->cerrado, 'view_out_tdcasa', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->igtf->Raw = true;
        $this->igtf->Lookup = new Lookup($this->igtf, 'view_out_tdcasa', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->impreso->Lookup = new Lookup($this->impreso, 'view_out_tdcasa', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->genera_ne->Lookup = new Lookup($this->genera_ne, 'view_out_tdcasa', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "view_out") {
            $detailUrl = Container("view_out")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_tipo_documento", $this->tipo_documento->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "ViewOutTdcasaList";
        }
        return $detailUrl;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_out_tdcasa";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewOutTdcasaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewOutTdcasaView" => $Language->phrase("View"),
            "ViewOutTdcasaEdit" => $Language->phrase("Edit"),
            "ViewOutTdcasaAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewOutTdcasaView",
            Config("API_ADD_ACTION") => "ViewOutTdcasaAdd",
            Config("API_EDIT_ACTION") => "ViewOutTdcasaEdit",
            Config("API_DELETE_ACTION") => "ViewOutTdcasaDelete",
            Config("API_LIST_ACTION") => "ViewOutTdcasaList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewOutTdcasaView", $parm);
        } else {
            $url = $this->keyUrl("ViewOutTdcasaView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewOutTdcasaAdd?" . $parm;
        } else {
            $url = "ViewOutTdcasaAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewOutTdcasaEdit", $parm);
        } else {
            $url = $this->keyUrl("ViewOutTdcasaEdit", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewOutTdcasaList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewOutTdcasaAdd", $parm);
        } else {
            $url = $this->keyUrl("ViewOutTdcasaAdd", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewOutTdcasaList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewOutTdcasaDelete", $parm);
        }
    }
    ...
    public function renderListRow()
    {
        ...
        if ($this->fotos->UseColorbox) {
            ...
            $this->fotos->LinkAttrs["data-rel"] = "view_out_tdcasa_x_fotos";
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'view_out_tdcasa');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'view_out_tdcasa', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'view_out_tdcasa', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'view_out_tdcasa', $fldname, $key, $oldvalue);
            }
        }
    }
    ...
    {
        //Log("Row Updated");
        $sql = "SELECT articulo FROM entradas_salidas WHERE id_documento = " . $rsold["id"] . " AND tipo_documento = 'TDCASA';";
