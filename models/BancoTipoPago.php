...
/**
 * Table class for banco_tipo_pago
 */
class BancoTipoPago extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "banco_tipo_pago";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->banco->addMethod("getDefault", fn() => 0);
        ...
        $this->tipo_pago->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "banco_tipo_pago";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("BancoTipoPagoList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "BancoTipoPagoView" => $Language->phrase("View"),
            "BancoTipoPagoEdit" => $Language->phrase("Edit"),
            "BancoTipoPagoAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "BancoTipoPagoView",
            Config("API_ADD_ACTION") => "BancoTipoPagoAdd",
            Config("API_EDIT_ACTION") => "BancoTipoPagoEdit",
            Config("API_DELETE_ACTION") => "BancoTipoPagoDelete",
            Config("API_LIST_ACTION") => "BancoTipoPagoList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BancoTipoPagoView", $parm);
        } else {
            $url = $this->keyUrl("BancoTipoPagoView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "BancoTipoPagoAdd?" . $parm;
        } else {
            $url = "BancoTipoPagoAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BancoTipoPagoEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BancoTipoPagoList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BancoTipoPagoAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BancoTipoPagoList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("BancoTipoPagoDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->tipo_pago->Raw) {
            $this->tipo_pago->CurrentValue = HtmlDecode($this->tipo_pago->CurrentValue);
        }
