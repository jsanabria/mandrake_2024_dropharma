 ...
 * Page class
 */
class PagosProveedorDelete extends PagosProveedor
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PagosProveedorDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PagosProveedorDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PagosProveedorList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("PagosProveedorList"); // Return to list
                return;
            }
        }
