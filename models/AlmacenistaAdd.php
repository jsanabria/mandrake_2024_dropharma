 ...
 * Page class
 */
class AlmacenistaAdd extends Almacenista
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AlmacenistaAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "AlmacenistaAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "AlmacenistaView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->nombre->CurrentValue != "") { // Check field with unique index
            $filter = "(`nombre` = '" . AdjustSql($this->nombre->CurrentValue, $this->Dbid) . "')";
