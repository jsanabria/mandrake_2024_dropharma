 ...
 * Page class
 */
class TarifaArticuloDelete extends TarifaArticulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TarifaArticuloDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TarifaArticuloDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TarifaArticuloList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("TarifaArticuloList"); // Return to list
                return;
            }
        }
