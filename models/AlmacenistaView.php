 ...
 * Page class
 */
class AlmacenistaView extends Almacenista
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AlmacenistaView";
    ...
    // CSS class/style
    public $CurrentPageName = "AlmacenistaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "AlmacenistaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "AlmacenistaList"; // No matching record, return to list
                    } else {
