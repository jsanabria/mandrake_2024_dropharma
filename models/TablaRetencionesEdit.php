 ...
 * Page class
 */
class TablaRetencionesEdit extends TablaRetenciones
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TablaRetencionesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "TablaRetencionesEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("TablaRetencionesList"); // Return to list page
                        return;
    ...
    protected function getEditRow($rsold)
    {
        ...
        // base_imponible
        $this->base_imponible->setDbValueDef($rsnew, $this->base_imponible->CurrentValue, $this->base_imponible->ReadOnly);
        ...
        // pagos_mayores
        $this->pagos_mayores->setDbValueDef($rsnew, $this->pagos_mayores->CurrentValue, $this->pagos_mayores->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['base_imponible'])) { // base_imponible
            $this->base_imponible->CurrentValue = $row['base_imponible'];
        }
        ...
        if (isset($row['pagos_mayores'])) { // pagos_mayores
            $this->pagos_mayores->CurrentValue = $row['pagos_mayores'];
        }
