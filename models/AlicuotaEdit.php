 ...
 * Page class
 */
class AlicuotaEdit extends Alicuota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AlicuotaEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "AlicuotaEdit";
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("AlicuotaList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "AlicuotaList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "AlicuotaList") {
                            ...
                            $returnUrl = "AlicuotaList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
