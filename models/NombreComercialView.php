 ...
 * Page class
 */
class NombreComercialView extends NombreComercial
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NombreComercialView";
    ...
    // CSS class/style
    public $CurrentPageName = "NombreComercialView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codigo") ?? Route("codigo")) !== null) {
            ...
            $returnUrl = "NombreComercialList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "NombreComercialList"; // No matching record, return to list
                    } else {
