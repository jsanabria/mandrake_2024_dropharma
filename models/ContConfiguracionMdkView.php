 ...
 * Page class
 */
class ContConfiguracionMdkView extends ContConfiguracionMdk
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContConfiguracionMdkView";
    ...
    // CSS class/style
    public $CurrentPageName = "ContConfiguracionMdkView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ContConfiguracionMdkList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ContConfiguracionMdkList"; // No matching record, return to list
                    } else {
