 ...
 * Page class
 */
class AbonoDelete extends Abono
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AbonoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AbonoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("AbonoList"); // Return to list
                return;
            }
        }
