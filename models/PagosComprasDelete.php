 ...
 * Page class
 */
class PagosComprasDelete extends PagosCompras
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PagosComprasDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PagosComprasDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PagosComprasList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("PagosComprasList"); // Return to list
                return;
            }
        }
