 ...
 * Page class
 */
class ClienteAddopt extends Cliente
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ClienteAddopt";
    ...
    // CSS class/style
    public $CurrentPageName = "ClienteAddopt";
    ...
    public function restoreFormValues()
    {
        ...
        $this->sucursal->CurrentValue = ConvertToUtf8($this->sucursal->FormValue);
        $this->contacto->CurrentValue = ConvertToUtf8($this->contacto->FormValue);
        $this->ciudad->CurrentValue = ConvertToUtf8($this->ciudad->FormValue);
        $this->zona->CurrentValue = ConvertToUtf8($this->zona->FormValue);
        ...
        $this->tipo_cliente->CurrentValue = ConvertToUtf8($this->tipo_cliente->FormValue);
