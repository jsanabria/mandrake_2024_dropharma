 ...
 * Page class
 */
class ViewInTdcaenView extends ViewInTdcaen
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewInTdcaenView";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewInTdcaenView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ViewInTdcaenList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ViewInTdcaenList"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ViewInTdcaenList"; // No matching record, return to list
                    } else {
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ViewInList?" . Config("TABLE_SHOW_MASTER") . "=view_in_tdcaen&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "&" . GetForeignKeyUrl("fk_tipo_documento", $this->tipo_documento->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewInTdcaenList"), "", $this->TableVar, true);
        $pageId = "view";
    ...
    public function pageDataRendering(&$header)
    {
        ...
        if($this->estatus->CurrentValue == "NUEVO") {
            $header = "../TdcaenAdd?tipo_documento=TDCAEN&codpro=0C&pedido=" . $this->id->CurrentValue;
            $header = '<a class="btn btn-outline-primary" id="btnNuevo" href="' . $header . '"><span class="fas fa-edit"></span> Editar Documento</a>';
            $header .= ' ';
        }
        $url = "../reportes/ajuste_de_entrada.php?id=" . $this->id->CurrentValue . "&tipo=TDCAEN";
