 ...
 * Page class
 */
class PresupustoDetalleView extends PresupustoDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PresupustoDetalleView";
    ...
    // CSS class/style
    public $CurrentPageName = "PresupustoDetalleView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "PresupustoDetalleList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "PresupustoDetalleList"; // No matching record, return to list
                    } else {
