 ...
 * Page class
 */
class PagosProveedorEdit extends PagosProveedor
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PagosProveedorEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "PagosProveedorEdit";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("pagos_proveedor_factura", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("PagosProveedorFacturaGrid");
            if (in_array("pagos_proveedor_factura", $detailTblVar) && $detailPage->DetailEdit && $editRow) {
    ...
    protected function getEditRow($rsold)
    {
        ...
        // monto_dado
        $this->monto_dado->setDbValueDef($rsnew, $this->monto_dado->CurrentValue, $this->monto_dado->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['monto_dado'])) { // monto_dado
            $this->monto_dado->CurrentValue = $row['monto_dado'];
        }
