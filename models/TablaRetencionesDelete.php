 ...
 * Page class
 */
class TablaRetencionesDelete extends TablaRetenciones
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TablaRetencionesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TablaRetencionesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TablaRetencionesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("TablaRetencionesList"); // Return to list
                return;
            }
        }
