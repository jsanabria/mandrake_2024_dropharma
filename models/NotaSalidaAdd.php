 ...
 * Page class
 */
class NotaSalidaAdd extends NotaSalida
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NotaSalidaAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "NotaSalidaAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "NotaSalidaView") {
    ...
    protected function getAddRow()
    {
        ...
        // salida
        $this->salida->setDbValueDef($rsnew, $this->salida->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        if (isset($row['salida'])) { // salida
            $this->salida->setFormValue($row['salida']);
        }
