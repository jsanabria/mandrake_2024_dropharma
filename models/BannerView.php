 ...
 * Page class
 */
class BannerView extends Banner
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "BannerView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "BannerList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "BannerList"; // No matching record, return to list
                    } else {
