 ...
 * Page class
 */
class PagosComprasAdd extends PagosCompras
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PagosComprasAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "PagosComprasAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PagosComprasView") {
    ...
    protected function getAddRow()
    {
        ...
        // anexos
        $this->anexos->setDbValueDef($rsnew, $this->anexos->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['anexos'])) { // anexos
            $this->anexos->setFormValue($row['anexos']);
        }
