...
/**
 * Table class for view_out_tdcfcv
 */
class ViewOutTdcfcv extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_out_tdcfcv";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->documento->Lookup = new Lookup($this->documento, 'view_out_tdcfcv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->estatus->Lookup = new Lookup($this->estatus, 'view_out_tdcfcv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->entregado->Lookup = new Lookup($this->entregado, 'view_out_tdcfcv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->pagado->Lookup = new Lookup($this->pagado, 'view_out_tdcfcv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->impreso->Lookup = new Lookup($this->impreso, 'view_out_tdcfcv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->consignacion->Lookup = new Lookup($this->consignacion, 'view_out_tdcfcv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->factura->Lookup = new Lookup($this->factura, 'view_out_tdcfcv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->activo->Lookup = new Lookup($this->activo, 'view_out_tdcfcv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->cerrado->Lookup = new Lookup($this->cerrado, 'view_out_tdcfcv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_out_tdcfcv";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewOutTdcfcvList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewOutTdcfcvView" => $Language->phrase("View"),
            "ViewOutTdcfcvEdit" => $Language->phrase("Edit"),
            "ViewOutTdcfcvAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewOutTdcfcvView",
            Config("API_ADD_ACTION") => "ViewOutTdcfcvAdd",
            Config("API_EDIT_ACTION") => "ViewOutTdcfcvEdit",
            Config("API_DELETE_ACTION") => "ViewOutTdcfcvDelete",
            Config("API_LIST_ACTION") => "ViewOutTdcfcvList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewOutTdcfcvView", $parm);
        } else {
            $url = $this->keyUrl("ViewOutTdcfcvView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewOutTdcfcvAdd?" . $parm;
        } else {
            $url = "ViewOutTdcfcvAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewOutTdcfcvEdit", $parm);
        } else {
            $url = $this->keyUrl("ViewOutTdcfcvEdit", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewOutTdcfcvList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewOutTdcfcvAdd", $parm);
        } else {
            $url = $this->keyUrl("ViewOutTdcfcvAdd", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewOutTdcfcvList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewOutTdcfcvDelete", $parm);
        }
    }
    ...
    public function renderListRow()
    {
        ...
        if ($this->fotos->UseColorbox) {
            ...
            $this->fotos->LinkAttrs["data-rel"] = "view_out_tdcfcv_x_fotos";
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'view_out_tdcfcv');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'view_out_tdcfcv', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'view_out_tdcfcv', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'view_out_tdcfcv', $fldname, $key, $oldvalue);
            }
        }
    }
    ...
    public function rowUpdating($rsold, &$rsnew)
    {
        ...
        if (array_key_exists("fecha", $rsnew)) {
            unset($rsnew["fecha"]);
        }
        return true;
    }
    ...
    public function rowRendered()
    {
        ...
        if ($this->impreso->CurrentValue == "S") $color = "background-color: #77dd77; color: #ffffff;";
        else $color = "background-color: #fff8cc; color: #7a6a00;";
        $this->impreso->CellAttrs["style"] = $color;
    }
