...
/**
 * Table class for view_in_tdcaen
 */
class ViewInTdcaen extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_in_tdcaen";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->estatus->Lookup = new Lookup($this->estatus, 'view_in_tdcaen', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->consignacion->Lookup = new Lookup($this->consignacion, 'view_in_tdcaen', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->consignacion_reportada->Lookup = new Lookup($this->consignacion_reportada, 'view_in_tdcaen', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->aplica_retencion->Lookup = new Lookup($this->aplica_retencion, 'view_in_tdcaen', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->documento->Lookup = new Lookup($this->documento, 'view_in_tdcaen', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->cerrado->Lookup = new Lookup($this->cerrado, 'view_in_tdcaen', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_in_tdcaen";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewInTdcaenList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewInTdcaenView" => $Language->phrase("View"),
            "ViewInTdcaenEdit" => $Language->phrase("Edit"),
            "ViewInTdcaenAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewInTdcaenView",
            Config("API_ADD_ACTION") => "ViewInTdcaenAdd",
            Config("API_EDIT_ACTION") => "ViewInTdcaenEdit",
            Config("API_DELETE_ACTION") => "ViewInTdcaenDelete",
            Config("API_LIST_ACTION") => "ViewInTdcaenList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewInTdcaenView", $parm);
        } else {
            $url = $this->keyUrl("ViewInTdcaenView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewInTdcaenEdit", $parm);
        } else {
            $url = $this->keyUrl("ViewInTdcaenEdit", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewInTdcaenList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewInTdcaenAdd", $parm);
        } else {
            $url = $this->keyUrl("ViewInTdcaenAdd", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewInTdcaenList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewInTdcaenDelete", $parm);
        }
    }
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'view_in_tdcaen');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'view_in_tdcaen', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'view_in_tdcaen', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'view_in_tdcaen', $fldname, $key, $oldvalue);
            }
        }
    }
    ...
    public function rowUpdated($rsold, $rsnew)
    {
                ...
                if($num == 5) {
                    for($columna = 0; $columna < $num; $columna++) {
                        ...
                        case 3:	
                            ...
                            break;
                        case 4:	
                            if (($timestamp = strtotime($datos[$columna])) === false) 
                                $fecha_vencimiento = strtotime("1990-01-01");
                            else 
                    ...
                    $insart->insertar_articulo("TDCAEN", $rsold["id"], 1, $cod_articulo, $cantidad, $lote, $fecha_vencimiento);
                }
                $codigo = "";
                $nombre = "";
                $lote = "";
        ...
        //// **** **** **** **** **** **** **** **** **** **** **** **** ////
        $sql = "SELECT articulo FROM entradas_salidas WHERE id_documento = " . $rsold["id"] . " AND tipo_documento = 'TDCAEN';";
