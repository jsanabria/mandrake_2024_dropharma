...
/**
 * Table class for cont_plancta
 */
class ContPlancta extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // clase
        $this->clase = new DbField(
            $this, // Table
            'x_clase', // Variable name
            'clase', // Name
            '`clase`', // Expression
            '`clase`', // Basic search expression
            200, // Type
            6, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`clase`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->clase->InputTextType = "text";
        $this->clase->Required = true; // Required field
        $this->clase->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        $this->grupo->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        $this->cuenta->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['cuenta'] = &$this->cuenta;

        // subcuenta
        $this->subcuenta = new DbField(
            $this, // Table
            'x_subcuenta', // Variable name
            'subcuenta', // Name
            '`subcuenta`', // Expression
            '`subcuenta`', // Basic search expression
            200, // Type
            6, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`subcuenta`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->subcuenta->InputTextType = "text";
        $this->subcuenta->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['subcuenta'] = &$this->subcuenta;
        ...
        $this->clasificacion->Lookup = new Lookup($this->clasificacion, 'cont_plancta', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->clasificacion->OptionCount = 7;
        ...
        $this->naturaleza->Lookup = new Lookup($this->naturaleza, 'cont_plancta', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->naturaleza->OptionCount = 2;
        $this->naturaleza->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        ...
        $this->tipo->Lookup = new Lookup($this->tipo, 'cont_plancta', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->moneda->Lookup = new Lookup($this->moneda, 'parametro', false, 'valor1', ["valor1","","",""], '', '', [], [], [], [], [], [], false, '`valor2` ASC', '', "`valor1`");
        $this->moneda->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['moneda'] = &$this->moneda;

        // activa
        $this->activa = new DbField(
            $this, // Table
            'x_activa', // Variable name
            'activa', // Name
            '`activa`', // Expression
            '`activa`', // Basic search expression
            200, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`activa`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->activa->InputTextType = "text";
        $this->activa->Raw = true;
        $this->activa->Required = true; // Required field
        $this->activa->Lookup = new Lookup($this->activa, 'cont_plancta', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->activa->OptionCount = 2;
        $this->activa->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "cont_plancta";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->subcuenta->DbValue = $row['subcuenta'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ContPlanctaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ContPlanctaView" => $Language->phrase("View"),
            "ContPlanctaEdit" => $Language->phrase("Edit"),
            "ContPlanctaAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ContPlanctaView",
            Config("API_ADD_ACTION") => "ContPlanctaAdd",
            Config("API_EDIT_ACTION") => "ContPlanctaEdit",
            Config("API_DELETE_ACTION") => "ContPlanctaDelete",
            Config("API_LIST_ACTION") => "ContPlanctaList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ContPlanctaView", $parm);
        } else {
            $url = $this->keyUrl("ContPlanctaView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContPlanctaEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContPlanctaList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContPlanctaAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContPlanctaList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ContPlanctaDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->subcuenta->EditValue = $this->subcuenta->CurrentValue;
        ...
        if (strval($this->clasificacion->CurrentValue) != "") {
            $this->clasificacion->EditValue = $this->clasificacion->optionCaption($this->clasificacion->CurrentValue);
        } else {
            $this->clasificacion->EditValue = null;
        }

        // naturaleza
        $this->naturaleza->setupEditAttributes();
        if (strval($this->naturaleza->CurrentValue) != "") {
            $this->naturaleza->EditValue = $this->naturaleza->optionCaption($this->naturaleza->CurrentValue);
        } else {
            $this->naturaleza->EditValue = null;
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->clase);
                    $doc->exportCaption($this->grupo);
                    $doc->exportCaption($this->cuenta);
                    $doc->exportCaption($this->subcuenta);
        ...
        while (($row = $result->fetch()) && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->clase);
                        $doc->exportField($this->grupo);
                        $doc->exportField($this->cuenta);
                        $doc->exportField($this->subcuenta);
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'cont_plancta');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'cont_plancta', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'cont_plancta', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'cont_plancta', $fldname, $key, $oldvalue);
            }
        }
    }
    ...
    public function rowInserting($rsold, &$rsnew) {
    	...
    	$clase = trim($rsnew["clase"]);
    	$grupo = trim($rsnew["grupo"]);
    	$cuenta = trim($rsnew["cuenta"]);
    	$subcuenta = trim($rsnew["subcuenta"]);
    	$where = "";
    	if($grupo != "") $where .= "AND LTRIM(RTRIM(grupo)) = '$grupo' ";
    	if($cuenta != "") $where .= "AND LTRIM(RTRIM(cuenta)) = '$cuenta' ";
    	if($subcuenta != "") $where .= "AND LTRIM(RTRIM(subcuenta)) = '$subcuenta' ";
    	$sql = "SELECT 
    				COUNT(descripcion) AS cantidad 
    			FROM 
    				cont_plancta 
    			WHERE 
    				LTRIM(RTRIM(clase)) = '$clase' 
    				$where;";
    	$cantidad = intval(ExecuteScalar($sql));
    	if($cantidad >= 1) {
    		$this->CancelMessage = "La cuenta ya existe; !Verifique!";
    		return FALSE;
    	}
    	switch($clase) {
    	case '1':
    		$rsnew["clasificacion"] = "ACTIVO";
    		$rsnew["naturaleza"] = "DEBE";
    		$rsnew["tipo"] = "BALANCE";
    		break;
    	case '2':
    		$rsnew["clasificacion"] = "PASIVO";
    		$rsnew["naturaleza"] = "HABER";
    		$rsnew["tipo"] = "BALANCE";
    		break;
    	case '3':
    		$rsnew["clasificacion"] = "CAPITAL";
    		$rsnew["naturaleza"] = "HABER";
    		$rsnew["tipo"] = "BALANCE";
    		break;
    	case '4':
    		$rsnew["clasificacion"] = "VENTAS";
    		$rsnew["naturaleza"] = "DEBE";
    		$rsnew["tipo"] = "RESULTADO";
    		break;
    	case '5':
    		$rsnew["clasificacion"] = "COSTOS";
    		$rsnew["naturaleza"] = "HABER";
    		$rsnew["tipo"] = "RESULTADO";
    		break;
    	case '6':
    		$rsnew["clasificacion"] = "GASTOS";
    		$rsnew["naturaleza"] = "HABER";
    		$rsnew["tipo"] = "RESULTADO";
    		break;
    	}
    ...
    public function rowDeleting(&$rs) {
    	// Enter your code here
    	// To cancel, set return value to False
    	$sql = "SELECT regla FROM cont_reglas WHERE cuenta = " . $rs["id"] . ";";
    	if($row = ExecuteRow($sql)) {
    		$this->CancelMessage = "La cuenta no se puede eliminar porque existe en reglas contables; !Verifique!";
    		return FALSE;
    	}
    	$sql = "SELECT id FROM cont_asiento WHERE cuenta = " . $rs["id"] . ";";
    	if($row = ExecuteRow($sql)) {
    		$this->CancelMessage = "La cuenta no se puede eliminar porque tiene movimientos contables; !Verifique!";
    		return FALSE;
    	}
    	return TRUE;
    }
