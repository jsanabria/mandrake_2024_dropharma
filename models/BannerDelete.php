 ...
 * Page class
 */
class BannerDelete extends Banner
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BannerDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "BannerDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("BannerList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("BannerList"); // Return to list
                return;
            }
        }
