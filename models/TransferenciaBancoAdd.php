 ...
 * Page class
 */
class TransferenciaBancoAdd extends TransferenciaBanco
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TransferenciaBancoAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "TransferenciaBancoAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "TransferenciaBancoView") {
    ...
    protected function getAddRow()
    {
        ...
        // banco_origen
        $this->banco_origen->setDbValueDef($rsnew, $this->banco_origen->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        if (isset($row['banco_origen'])) { // banco_origen
            $this->banco_origen->setFormValue($row['banco_origen']);
        }
