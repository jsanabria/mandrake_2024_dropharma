 ...
 * Page class
 */
class NombreComercialAdd extends NombreComercial
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NombreComercialAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "NombreComercialAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "NombreComercialView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($insertRow && $this->ValidateKey && strval($rsnew['codigo']) == "") {
