 ...
 * Page class
 */
class AsesorClienteEdit extends AsesorCliente
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AsesorClienteEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "AsesorClienteEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("AsesorClienteList"); // Return to list page
                        return;
