 ...
 * Page class
 */
class PagosComprasDetalleView extends PagosComprasDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PagosComprasDetalleView";
    ...
    // CSS class/style
    public $CurrentPageName = "PagosComprasDetalleView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "PagosComprasDetalleList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "PagosComprasDetalleList"; // No matching record, return to list
                    } else {
