...
class TipoDocumento extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->tipo->Lookup = new Lookup($this->tipo, 'tipo_documento', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->M01->Lookup = new Lookup($this->M01, 'tipo_documento', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->M02->Lookup = new Lookup($this->M02, 'tipo_documento', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->M03->Lookup = new Lookup($this->M03, 'tipo_documento', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->M04->Lookup = new Lookup($this->M04, 'tipo_documento', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->M05->Lookup = new Lookup($this->M05, 'tipo_documento', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->M06->Lookup = new Lookup($this->M06, 'tipo_documento', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->M07->Lookup = new Lookup($this->M07, 'tipo_documento', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->M08->Lookup = new Lookup($this->M08, 'tipo_documento', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->M09->Lookup = new Lookup($this->M09, 'tipo_documento', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->M10->Lookup = new Lookup($this->M10, 'tipo_documento', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->M11->Lookup = new Lookup($this->M11, 'tipo_documento', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->M12->Lookup = new Lookup($this->M12, 'tipo_documento', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "TipoDocumentoView" => $Language->phrase("View"),
            "TipoDocumentoEdit" => $Language->phrase("Edit"),
            "TipoDocumentoAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "TipoDocumentoView",
            Config("API_ADD_ACTION") => "TipoDocumentoAdd",
            Config("API_EDIT_ACTION") => "TipoDocumentoEdit",
            Config("API_DELETE_ACTION") => "TipoDocumentoDelete",
            Config("API_LIST_ACTION") => "TipoDocumentoList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TipoDocumentoView", $parm);
        } else {
            $url = $this->keyUrl("TipoDocumentoView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TipoDocumentoEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TipoDocumentoList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TipoDocumentoAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TipoDocumentoList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TipoDocumentoDelete", $parm);
        }
    }
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'tipo_documento');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'tipo_documento', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'tipo_documento', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'tipo_documento', $fldname, $key, $oldvalue);
            }
        }
    }
