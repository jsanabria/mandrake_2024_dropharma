...
/**
 * Table class for view_banco
 */
class ViewBanco extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->cuenta->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_banco";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewBancoList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewBancoView" => $Language->phrase("View"),
            "ViewBancoEdit" => $Language->phrase("Edit"),
            "ViewBancoAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewBancoView",
            Config("API_ADD_ACTION") => "ViewBancoAdd",
            Config("API_EDIT_ACTION") => "ViewBancoEdit",
            Config("API_DELETE_ACTION") => "ViewBancoDelete",
            Config("API_LIST_ACTION") => "ViewBancoList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewBancoView", $parm);
        } else {
            $url = $this->keyUrl("ViewBancoView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewBancoEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewBancoList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewBancoAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewBancoList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewBancoDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        if (strval($this->cuenta->EditValue) != "" && is_numeric($this->cuenta->EditValue)) {
            $this->cuenta->EditValue = $this->cuenta->EditValue;
        }
