...
/**
 * Table class for cont_configuracion_mdk
 */
class ContConfiguracionMdk extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "cont_configuracion_mdk";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // clave
        $this->clave = new DbField(
            $this, // Table
            'x_clave', // Variable name
            'clave', // Name
            '`clave`', // Expression
            '`clave`', // Basic search expression
            200, // Type
            60, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`clave`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->clave->InputTextType = "text";
        $this->clave->Nullable = false; // NOT NULL field
        $this->clave->Required = true; // Required field
        $this->clave->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->cuenta_id->Lookup = new Lookup($this->cuenta_id, 'cont_plan_cuentas_mdk', false, 'id', ["codigo","nombre","",""], '', '', [], [], [], [], [], [], false, '', '', "CONCAT(COALESCE(`codigo`, ''),'" . ValueSeparator(1, $this->cuenta_id) . "',COALESCE(`nombre`,''))");
        ...
        // valor_texto
        $this->valor_texto = new DbField(
            $this, // Table
            'x_valor_texto', // Variable name
            'valor_texto', // Name
            '`valor_texto`', // Expression
            '`valor_texto`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`valor_texto`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->valor_texto->InputTextType = "text";
        $this->valor_texto->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['valor_texto'] = &$this->valor_texto;

        // valor_numero
        $this->valor_numero = new DbField(
            $this, // Table
            'x_valor_numero', // Variable name
            'valor_numero', // Name
            '`valor_numero`', // Expression
            '`valor_numero`', // Basic search expression
            131, // Type
            22, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`valor_numero`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->valor_numero->InputTextType = "text";
        $this->valor_numero->Raw = true;
        $this->valor_numero->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->valor_numero->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['valor_numero'] = &$this->valor_numero;
        ...
        $this->estado->Lookup = new Lookup($this->estado, 'cont_configuracion_mdk', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "cont_configuracion_mdk";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->valor_texto->DbValue = $row['valor_texto'];
        $this->valor_numero->DbValue = $row['valor_numero'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ContConfiguracionMdkList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ContConfiguracionMdkView" => $Language->phrase("View"),
            "ContConfiguracionMdkEdit" => $Language->phrase("Edit"),
            "ContConfiguracionMdkAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "ContConfiguracionMdkList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ContConfiguracionMdkView",
            Config("API_ADD_ACTION") => "ContConfiguracionMdkAdd",
            Config("API_EDIT_ACTION") => "ContConfiguracionMdkEdit",
            Config("API_DELETE_ACTION") => "ContConfiguracionMdkDelete",
            Config("API_LIST_ACTION") => "ContConfiguracionMdkList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ContConfiguracionMdkView", $parm);
        } else {
            $url = $this->keyUrl("ContConfiguracionMdkView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ContConfiguracionMdkAdd?" . $parm;
        } else {
            $url = "ContConfiguracionMdkAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContConfiguracionMdkEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContConfiguracionMdkList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContConfiguracionMdkAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContConfiguracionMdkList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ContConfiguracionMdkDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ContConfiguracionMdkList";
    ...
    public function renderListRow()
    {
        ...
        $this->valor_numero->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        $this->valor_texto->EditValue = $this->valor_texto->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->valor_texto);
                    $doc->exportCaption($this->valor_numero);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->valor_texto);
                        $doc->exportField($this->valor_numero);
