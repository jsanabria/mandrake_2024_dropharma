 ...
 * Page class
 */
class TasaUsdEdit extends TasaUsd
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TasaUsdEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "TasaUsdEdit";
    ...
    public function run()
    {
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("TasaUsdList"); // Return to list page
                        return;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("TasaUsdList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "TasaUsdList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "TasaUsdList") {
                            ...
                            $returnUrl = "TasaUsdList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->hora->IsDetailKey) {
            ...
            $this->hora->CurrentValue = UnFormatDateTime($this->hora->CurrentValue, $this->hora->formatPattern());
        }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->hora->Visible && $this->hora->Required) {
                if (!$this->hora->IsDetailKey && EmptyValue($this->hora->FormValue)) {
                    $this->hora->addErrorMessage(str_replace("%s", $this->hora->caption(), $this->hora->RequiredErrorMessage));
                }
            }
    ...
    protected function getEditRow($rsold)
    {
        ...
        // fecha
        $this->fecha->CurrentValue = $this->fecha->getAutoUpdateValue(); // PHP
        $this->fecha->setDbValueDef($rsnew, UnFormatDateTime($this->fecha->CurrentValue, $this->fecha->formatPattern()), $this->fecha->ReadOnly);

        // hora
        $this->hora->CurrentValue = $this->hora->getAutoUpdateValue(); // PHP
        $this->hora->setDbValueDef($rsnew, UnFormatDateTime($this->hora->CurrentValue, $this->hora->formatPattern()), $this->hora->ReadOnly);
        return $rsnew;
    }
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['hora'])) { // hora
            $this->hora->CurrentValue = $row['hora'];
        }
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("TasaUsdList"), "", $this->TableVar, true);
        $pageId = "edit";
