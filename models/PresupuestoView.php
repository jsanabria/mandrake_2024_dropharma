 ...
 * Page class
 */
class PresupuestoView extends Presupuesto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PresupuestoView";
    ...
    // CSS class/style
    public $CurrentPageName = "PresupuestoView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "PresupuestoList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "PresupuestoList"; // No matching record, return to list
                    } else {
