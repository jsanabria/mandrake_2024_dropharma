 ...
 * Page class
 */
class CobrosClienteFacturaView extends CobrosClienteFactura
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CobrosClienteFacturaView";
    ...
    // CSS class/style
    public $CurrentPageName = "CobrosClienteFacturaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "CobrosClienteFacturaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "CobrosClienteFacturaList"; // No matching record, return to list
                    } else {
