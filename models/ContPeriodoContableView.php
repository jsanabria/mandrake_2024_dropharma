 ...
 * Page class
 */
class ContPeriodoContableView extends ContPeriodoContable
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContPeriodoContableView";
    ...
    // CSS class/style
    public $CurrentPageName = "ContPeriodoContableView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ContPeriodoContableList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ContPeriodoContableList"; // No matching record, return to list
                    } else {
