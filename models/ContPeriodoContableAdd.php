 ...
 * Page class
 */
class ContPeriodoContableAdd extends ContPeriodoContable
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContPeriodoContableAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ContPeriodoContableAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ContPeriodoContableView") {
