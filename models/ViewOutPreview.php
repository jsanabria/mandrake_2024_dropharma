 ...
 * Page class
 */
class ViewOutPreview extends ViewOut
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewOutPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewOutPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_out_tdcpdv") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_out_tdcpdv&" . GetForeignKeyUrl("fk_id", $this->id_documento->QueryStringValue) . "&" . GetForeignKeyUrl("fk_tipo_documento", $this->tipo_documento->QueryStringValue) . "";
        }
