 ...
 * Page class
 */
class ViewCuentasPorCobrarPreview extends ViewCuentasPorCobrar
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewCuentasPorCobrarPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewCuentasPorCobrarPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_cuentas_por_cobrar_resumen") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_cuentas_por_cobrar_resumen&" . GetForeignKeyUrl("fk_cliente", $this->cliente->QueryStringValue) . "";
        }
        return $url;
    }
