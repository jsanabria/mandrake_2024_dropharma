 ...
 * Page class
 */
class FabricanteAdd extends Fabricante
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FabricanteAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "FabricanteAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("FabricanteList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "FabricanteList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "FabricanteView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "FabricanteList") {
                            ...
                            $returnUrl = "FabricanteList"; // Return list page content
                        }
                    }
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if ($this->tipo->ViewValue !== null) { // Load from cache
                ...
                if ($curVal == "") {
                    ...
                    $filterWrk = SearchFilter($this->tipo->Lookup->getTable()->Fields["campo_codigo"]->searchExpression(), "=", $this->tipo->CurrentValue, $this->tipo->Lookup->getTable()->Fields["campo_codigo"]->searchDataType(), "");
                }
                $lookupFilter = $this->tipo->getSelectFilter($this); // PHP
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("FabricanteList"), "", $this->TableVar, true);
