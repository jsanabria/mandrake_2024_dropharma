 ...
 * Page class
 */
class PresupustoDetalleDelete extends PresupustoDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PresupustoDetalleDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PresupustoDetalleDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PresupustoDetalleList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("PresupustoDetalleList"); // Return to list
                return;
            }
        }
