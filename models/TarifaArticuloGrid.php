 ...
 * Page class
 */
class TarifaArticuloGrid extends TarifaArticulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TarifaArticuloGrid";
    ...
    public $FormName = "ftarifa_articulogrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "TarifaArticuloGrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "tarifa") {
            $this->tarifa->Visible = true; // Need to insert foreign key
            $this->tarifa->CurrentValue = $this->tarifa->getSessionValue();
        }
