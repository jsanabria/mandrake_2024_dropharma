 ...
 * Page class
 */
class ViewInTdcaenEdit extends ViewInTdcaen
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewInTdcaenEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewInTdcaenEdit";
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ViewInTdcaenList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "ViewInTdcaenList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ViewInTdcaenList") {
                            ...
                            $returnUrl = "ViewInTdcaenList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
