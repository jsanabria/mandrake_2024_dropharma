 ...
 * Page class
 */
class ContPlanctaView extends ContPlancta
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContPlanctaView";
    ...
    // CSS class/style
    public $CurrentPageName = "ContPlanctaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ContPlanctaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ContPlanctaList"; // No matching record, return to list
                    } else {
