...
/**
 * Table class for pedidos_detalles_online
 */
class PedidosDetallesOnline extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "pedidos_detalles_online";
        $this->TableName = 'pedidos_detalles_online';
        $this->TableType = "TABLE";
        $this->ImportUseTransaction = $this->supportsTransaction() && Config("IMPORT_USE_TRANSACTION");
        $this->UseTransaction = $this->supportsTransaction() && Config("USE_TRANSACTION");

        // Update Table
        $this->UpdateTable = "pedidos_detalles_online";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "pedidos_detalles_online";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PedidosDetallesOnlineList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "PedidosDetallesOnlineView" => $Language->phrase("View"),
            "PedidosDetallesOnlineEdit" => $Language->phrase("Edit"),
            "PedidosDetallesOnlineAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "PedidosDetallesOnlineList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "PedidosDetallesOnlineView",
            Config("API_ADD_ACTION") => "PedidosDetallesOnlineAdd",
            Config("API_EDIT_ACTION") => "PedidosDetallesOnlineEdit",
            Config("API_DELETE_ACTION") => "PedidosDetallesOnlineDelete",
            Config("API_LIST_ACTION") => "PedidosDetallesOnlineList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PedidosDetallesOnlineView", $parm);
        } else {
            $url = $this->keyUrl("PedidosDetallesOnlineView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "PedidosDetallesOnlineAdd?" . $parm;
        } else {
            $url = "PedidosDetallesOnlineAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PedidosDetallesOnlineEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PedidosDetallesOnlineList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PedidosDetallesOnlineAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PedidosDetallesOnlineList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("PedidosDetallesOnlineDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "PedidosDetallesOnlineList";
