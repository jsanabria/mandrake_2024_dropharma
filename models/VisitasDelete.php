 ...
 * Page class
 */
class VisitasDelete extends Visitas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VisitasDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "VisitasDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("VisitasList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("VisitasList"); // Return to list
                return;
            }
        }
