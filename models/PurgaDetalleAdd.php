 ...
 * Page class
 */
class PurgaDetalleAdd extends PurgaDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PurgaDetalleAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "PurgaDetalleAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("PurgaDetalleList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "PurgaDetalleList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "PurgaDetalleView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "PurgaDetalleList") {
                            ...
                            $returnUrl = "PurgaDetalleList"; // Return list page content
                        }
                    }
    ...
    public function renderRow()
    {
        ...
        // id_entradas_salidas
        $this->id_entradas_salidas->RowCssClass = "row";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("PurgaDetalleList"), "", $this->TableVar, true);
