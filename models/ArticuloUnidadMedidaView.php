 ...
 * Page class
 */
class ArticuloUnidadMedidaView extends ArticuloUnidadMedida
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArticuloUnidadMedidaView";
    ...
    // CSS class/style
    public $CurrentPageName = "ArticuloUnidadMedidaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ArticuloUnidadMedidaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ArticuloUnidadMedidaList"; // No matching record, return to list
                    } else {
