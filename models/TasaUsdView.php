 ...
 * Page class
 */
class TasaUsdView extends TasaUsd
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TasaUsdView";
    ...
    // CSS class/style
    public $CurrentPageName = "TasaUsdView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "TasaUsdList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "TasaUsdList"; // No matching record, return to list
                    } else {
