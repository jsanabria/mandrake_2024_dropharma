 ...
 * Page class
 */
class ContLotesPagosDetallePreview extends ContLotesPagosDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContLotesPagosDetallePreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ContLotesPagosDetallePreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "cont_lotes_pagos") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=cont_lotes_pagos&" . GetForeignKeyUrl("fk_id", $this->cont_lotes_pago->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "cont_lotes_pagos") {
            $this->cont_lotes_pago->setQueryStringValue($keys[0] ?? "");
        }
    }
