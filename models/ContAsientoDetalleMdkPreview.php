 ...
 * Page class
 */
class ContAsientoDetalleMdkPreview extends ContAsientoDetalleMdk
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContAsientoDetalleMdkPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ContAsientoDetalleMdkPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "cont_asiento_mdk") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=cont_asiento_mdk&" . GetForeignKeyUrl("fk_id", $this->asiento_id->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "cont_asiento_mdk") {
            $this->asiento_id->setQueryStringValue($keys[0] ?? "");
        }
    }
