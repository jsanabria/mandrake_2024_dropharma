 ...
 * Page class
 */
class EntradasView extends Entradas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EntradasView";
    ...
    // CSS class/style
    public $CurrentPageName = "EntradasView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "EntradasList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("EntradasList"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "EntradasList"; // No matching record, return to list
                    } else {
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("EntradasSalidasList?" . Config("TABLE_SHOW_MASTER") . "=entradas&" . GetForeignKeyUrl("fk_tipo_documento", $this->tipo_documento->CurrentValue) . "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
    ...
    public function pageRender() {
    	...
    	case "TDCNRP":
    		...
    		$this->descuento->Visible = TRUE;
    		$this->monto_pagar->Visible = TRUE;
    		break;
    	case "TDCFCC":
    		$this->nro_documento->Visible = TRUE;
    		$this->id_documento_padre->Visible = FALSE;
    		$this->ret_iva->Visible = TRUE;
    		$this->ref_iva->Visible = TRUE;
    		$this->ret_islr->Visible = TRUE;
    		$this->ref_islr->Visible = TRUE;
    		$this->ret_municipal->Visible = TRUE;
    ...
    public function pageDataRendering(&$header) {
    	// Example:
    	if($this->tipo_documento->CurrentValue == "TDCFCC") {
