 ...
 * Page class
 */
class AdjuntoSalidaEdit extends AdjuntoSalida
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AdjuntoSalidaEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "AdjuntoSalidaEdit";
    ...
    public function run()
    {
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("AdjuntoSalidaList"); // Return to list page
                        return;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("AdjuntoSalidaList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "AdjuntoSalidaList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "AdjuntoSalidaList") {
                            ...
                            $returnUrl = "AdjuntoSalidaList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function getEditRow($rsold)
    {
        ...
        // foto
        $this->foto->setDbValueDef($rsnew, $this->foto->CurrentValue, $this->foto->ReadOnly);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("AdjuntoSalidaList"), "", $this->TableVar, true);
        $pageId = "edit";
