 ...
 * Page class
 */
class ProveedorArticuloGrid extends ProveedorArticulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProveedorArticuloGrid";
    ...
    public $FormName = "fproveedor_articulogrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ProveedorArticuloGrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "proveedor") {
