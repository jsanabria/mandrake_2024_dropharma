 ...
 * Page class
 */
class ViewOutTdcnetView extends ViewOutTdcnet
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewOutTdcnetView";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewOutTdcnetView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ViewOutTdcnetList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ViewOutTdcnetList"; // No matching record, return to list
                    } else {
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ViewOutList?" . Config("TABLE_SHOW_MASTER") . "=view_out_tdcnet&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "&" . GetForeignKeyUrl("fk_tipo_documento", $this->tipo_documento->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
    ...
    public function pageDataRendering(&$header)
    {
        ...
        if($this->estatus->CurrentValue == "NUEVO") {
            $header = "../AjusteSalida?id=" . $this->id->CurrentValue . "&tipo_documento=TDCNET";
            $header = '<a class="btn btn-outline-primary" id="btnNuevo" href="' . $header . '"><span class="fas fa-edit"></span> Editar Documento</a>';
            $header .= ' ';
            $url = "../include/DescargarNotaDeEntregaXLS.php?id_pedido=" . $this->id->CurrentValue;
