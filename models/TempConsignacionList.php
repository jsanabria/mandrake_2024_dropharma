 ...
 * Page class
 */
class TempConsignacionList extends TempConsignacion
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TempConsignacionList";
    ...
    public $FormName = "ftemp_consignacionlist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "TempConsignacionList";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "TempConsignacionAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "TempConsignacionDelete";
        $this->MultiUpdateUrl = "TempConsignacionUpdate";
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "ftemp_consignaciongrid";
        }
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("ftemp_consignacionsrch");
        }
        ...
        $filterList = Concat($filterList, $this->cantidad_entre_fechas->AdvancedSearch->toJson(), ","); // Field cantidad_entre_fechas
        $filterList = Concat($filterList, $this->cantidad_acumulada->AdvancedSearch->toJson(), ","); // Field cantidad_acumulada
        $filterList = Concat($filterList, $this->cantidad_ajuste->AdvancedSearch->toJson(), ","); // Field cantidad_ajuste
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("ftemp_consignacionsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field cantidad_entre_fechas
        $this->cantidad_entre_fechas->AdvancedSearch->SearchValue = @$filter["x_cantidad_entre_fechas"];
        $this->cantidad_entre_fechas->AdvancedSearch->SearchOperator = @$filter["z_cantidad_entre_fechas"];
        $this->cantidad_entre_fechas->AdvancedSearch->SearchCondition = @$filter["v_cantidad_entre_fechas"];
        $this->cantidad_entre_fechas->AdvancedSearch->SearchValue2 = @$filter["y_cantidad_entre_fechas"];
        $this->cantidad_entre_fechas->AdvancedSearch->SearchOperator2 = @$filter["w_cantidad_entre_fechas"];
        $this->cantidad_entre_fechas->AdvancedSearch->save();

        // Field cantidad_acumulada
        $this->cantidad_acumulada->AdvancedSearch->SearchValue = @$filter["x_cantidad_acumulada"];
        $this->cantidad_acumulada->AdvancedSearch->SearchOperator = @$filter["z_cantidad_acumulada"];
        $this->cantidad_acumulada->AdvancedSearch->SearchCondition = @$filter["v_cantidad_acumulada"];
        $this->cantidad_acumulada->AdvancedSearch->SearchValue2 = @$filter["y_cantidad_acumulada"];
        $this->cantidad_acumulada->AdvancedSearch->SearchOperator2 = @$filter["w_cantidad_acumulada"];
        $this->cantidad_acumulada->AdvancedSearch->save();

        // Field cantidad_ajuste
        $this->cantidad_ajuste->AdvancedSearch->SearchValue = @$filter["x_cantidad_ajuste"];
        $this->cantidad_ajuste->AdvancedSearch->SearchOperator = @$filter["z_cantidad_ajuste"];
        $this->cantidad_ajuste->AdvancedSearch->SearchCondition = @$filter["v_cantidad_ajuste"];
        $this->cantidad_ajuste->AdvancedSearch->SearchValue2 = @$filter["y_cantidad_ajuste"];
        $this->cantidad_ajuste->AdvancedSearch->SearchOperator2 = @$filter["w_cantidad_ajuste"];
        $this->cantidad_ajuste->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->cantidad_entre_fechas); // cantidad_entre_fechas
            $this->updateSort($this->cantidad_acumulada); // cantidad_acumulada
            $this->updateSort($this->cantidad_ajuste); // cantidad_ajuste
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->cantidad_entre_fechas->setSort("");
                $this->cantidad_acumulada->setSort("");
                $this->cantidad_ajuste->setSort("");
            }
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"temp_consignacion\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"temp_consignacion\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"temp_consignacion\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"ftemp_consignacionlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"ftemp_consignacionlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"temp_consignacion\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "cantidad_entre_fechas");
            $this->createColumnOption($option, "cantidad_acumulada");
            $this->createColumnOption($option, "cantidad_ajuste");
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"ftemp_consignacionsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"ftemp_consignacionsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="ftemp_consignacionlist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_temp_consignacion", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_temp_consignacion",
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="ftemp_consignacionlist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"ftemp_consignacionsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
