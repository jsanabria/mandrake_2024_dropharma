 ...
 * Page class
 */
class PedidioDetalleOnlineView extends PedidioDetalleOnline
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PedidioDetalleOnlineView";
    ...
    // CSS class/style
    public $CurrentPageName = "PedidioDetalleOnlineView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "PedidioDetalleOnlineList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("PedidioDetalleOnlineList"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "PedidioDetalleOnlineList"; // No matching record, return to list
                    } else {
