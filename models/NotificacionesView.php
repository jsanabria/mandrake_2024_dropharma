 ...
 * Page class
 */
class NotificacionesView extends Notificaciones
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NotificacionesView";
    ...
    // CSS class/style
    public $CurrentPageName = "NotificacionesView";
    ...
    {
        $this->Nnotificaciones->setVisibility();
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Nnotificaciones") ?? Route("Nnotificaciones")) !== null) {
            $this->RecKey["Nnotificaciones"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nnotificaciones") ?? Route("Nnotificaciones")) !== null) {
            ...
            $this->RecKey["Nnotificaciones"] = $this->Nnotificaciones->QueryStringValue;
        } elseif (Post("Nnotificaciones") !== null) {
            $this->Nnotificaciones->setFormValue(Post("Nnotificaciones"));
            $this->RecKey["Nnotificaciones"] = $this->Nnotificaciones->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nnotificaciones->setQueryStringValue($keyValue);
            $this->RecKey["Nnotificaciones"] = $this->Nnotificaciones->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "NotificacionesList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "NotificacionesList"; // No matching record, return to list
                    } else {
    ...
    public function pageLoad() {
    	//echo "Page Load";
    	header("Location: dashboard/emails_masivos/resume_email.php?id=".$_GET["Nnotificaciones"]."&username=".CurrentUserName());
    }
