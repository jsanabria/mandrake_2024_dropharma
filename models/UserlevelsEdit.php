...
class UserlevelsEdit extends Userlevels
{
    ...
    protected function validateForm()
    {
        ...
        if (in_array("grupo_funciones", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("GrupoFuncionesGrid");
            if (in_array("grupo_funciones", $detailTblVar) && $detailPage->DetailEdit && $editRow) {
    ...
    protected function getEditRow($rsold)
    {
        ...
        // tipo_acceso
        $this->tipo_acceso->setDbValueDef($rsnew, $this->tipo_acceso->CurrentValue, $this->tipo_acceso->ReadOnly);
        return $rsnew;
    }
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['tipo_acceso'])) { // tipo_acceso
            $this->tipo_acceso->CurrentValue = $row['tipo_acceso'];
        }
    }
