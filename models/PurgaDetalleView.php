 ...
 * Page class
 */
class PurgaDetalleView extends PurgaDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PurgaDetalleView";
    ...
    // CSS class/style
    public $CurrentPageName = "PurgaDetalleView";
    ...
    public function setVisibility()
    {
        ...
        $this->purga->setVisibility();
        $this->fabricante->setVisibility();
        $this->articulo->setVisibility();
        $this->id_entradas_salidas->setVisibility();
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "PurgaDetalleList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "PurgaDetalleList"; // No matching record, return to list
                    } else {
