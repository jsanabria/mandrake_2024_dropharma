 ...
 * Page class
 */
class MovimientoBancarioAdd extends MovimientoBancario
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MovimientoBancarioAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "MovimientoBancarioAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("MovimientoBancarioList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "MovimientoBancarioList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "MovimientoBancarioView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "MovimientoBancarioList") {
                            ...
                            $returnUrl = "MovimientoBancarioList"; // Return list page content
                        }
                    }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->concepto->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->concepto->setFormValue($val, true, $validate);
            }
        }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if (!CheckInteger($this->concepto->FormValue)) {
                $this->concepto->addErrorMessage($this->concepto->getErrorMessage(false));
            }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("MovimientoBancarioList"), "", $this->TableVar, true);
