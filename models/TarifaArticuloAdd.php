 ...
 * Page class
 */
class TarifaArticuloAdd extends TarifaArticulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TarifaArticuloAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "TarifaArticuloAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("TarifaArticuloList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "TarifaArticuloList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "TarifaArticuloView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "TarifaArticuloList") {
                            ...
                            $returnUrl = "TarifaArticuloList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("TarifaArticuloList"), "", $this->TableVar, true);
