 ...
 * Page class
 */
class FuncionesView extends Funciones
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FuncionesView";
    ...
    // CSS class/style
    public $CurrentPageName = "FuncionesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "FuncionesList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("FuncionesList"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "FuncionesList"; // No matching record, return to list
                    } else {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("FuncionesList"), "", $this->TableVar, true);
        $pageId = "view";
