...
/**
 * Table class for tarifa_articulo_temp
 */
class TarifaArticuloTemp extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "tarifa_articulo_temp";
        $this->TableName = 'tarifa_articulo_temp';
        $this->TableType = "TABLE";
        $this->ImportUseTransaction = $this->supportsTransaction() && Config("IMPORT_USE_TRANSACTION");
        $this->UseTransaction = $this->supportsTransaction() && Config("USE_TRANSACTION");

        // Update Table
        $this->UpdateTable = "tarifa_articulo_temp";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "tarifa_articulo_temp";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TarifaArticuloTempList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "TarifaArticuloTempView" => $Language->phrase("View"),
            "TarifaArticuloTempEdit" => $Language->phrase("Edit"),
            "TarifaArticuloTempAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "TarifaArticuloTempView",
            Config("API_ADD_ACTION") => "TarifaArticuloTempAdd",
            Config("API_EDIT_ACTION") => "TarifaArticuloTempEdit",
            Config("API_DELETE_ACTION") => "TarifaArticuloTempDelete",
            Config("API_LIST_ACTION") => "TarifaArticuloTempList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TarifaArticuloTempView", $parm);
        } else {
            $url = $this->keyUrl("TarifaArticuloTempView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "TarifaArticuloTempAdd?" . $parm;
        } else {
            $url = "TarifaArticuloTempAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifaArticuloTempEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifaArticuloTempList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifaArticuloTempAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifaArticuloTempList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TarifaArticuloTempDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "TarifaArticuloTempList";
    ...
    public function renderEditRow()
    {
        ...
        if (strval($this->tarifa->EditValue) != "" && is_numeric($this->tarifa->EditValue)) {
            $this->tarifa->EditValue = $this->tarifa->EditValue;
        }
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'tarifa_articulo_temp');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'tarifa_articulo_temp', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'tarifa_articulo_temp', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'tarifa_articulo_temp', $fldname, $key, $oldvalue);
            }
        }
    }
