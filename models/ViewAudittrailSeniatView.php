 ...
 * Page class
 */
class ViewAudittrailSeniatView extends ViewAudittrailSeniat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewAudittrailSeniatView";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewAudittrailSeniatView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ViewAudittrailSeniatList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ViewAudittrailSeniatList"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ViewAudittrailSeniatList"; // No matching record, return to list
                    } else {
