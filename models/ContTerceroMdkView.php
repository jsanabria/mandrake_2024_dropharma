 ...
 * Page class
 */
class ContTerceroMdkView extends ContTerceroMdk
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContTerceroMdkView";
    ...
    // CSS class/style
    public $CurrentPageName = "ContTerceroMdkView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ContTerceroMdkList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ContTerceroMdkList"; // No matching record, return to list
                    } else {
