 ...
 * Page class
 */
class ContLotesPagosDetalleView extends ContLotesPagosDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContLotesPagosDetalleView";
    ...
    // CSS class/style
    public $CurrentPageName = "ContLotesPagosDetalleView";
    ...
    public function setVisibility()
    {
        ...
        $this->cont_lotes_pago->setVisibility();
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Id") ?? Route("Id")) !== null) {
            ...
            $returnUrl = "ContLotesPagosDetalleList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ContLotesPagosDetalleList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ContLotesPagosDetalleList"), "", $this->TableVar, true);
        $pageId = "view";
