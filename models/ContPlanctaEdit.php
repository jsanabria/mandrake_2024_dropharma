 ...
 * Page class
 */
class ContPlanctaEdit extends ContPlancta
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContPlanctaEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ContPlanctaEdit";
    ...
    public function run()
    {
        ...
        $this->setVisibility();
        $this->clase->Required = false;
        $this->clasificacion->Required = false;
        $this->naturaleza->Required = false;
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ContPlanctaList"); // Return to list page
                        return;
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ContPlanctaList") {
                            ...
                            $returnUrl = "ContPlanctaList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    public function renderRow()
    {
        ...
        // subcuenta
        $this->subcuenta->RowCssClass = "row";

        // descripcion
        $this->descripcion->RowCssClass = "row";

        // clasificacion
        $this->clasificacion->RowCssClass = "row";
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            if ($this->clase->Visible && $this->clase->Required) {
            ...
            if ($this->subcuenta->Visible && $this->subcuenta->Required) {
            ...
            if ($this->clasificacion->Visible && $this->clasificacion->Required) {
                if (!$this->clasificacion->IsDetailKey && EmptyValue($this->clasificacion->FormValue)) {
                    $this->clasificacion->addErrorMessage(str_replace("%s", $this->clasificacion->caption(), $this->clasificacion->RequiredErrorMessage));
                }
            }
            if ($this->naturaleza->Visible && $this->naturaleza->Required) {
                if ($this->naturaleza->FormValue == "") {
            ...
            if ($this->activa->Visible && $this->activa->Required) {
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['activa'])) { // activa
            $this->activa->CurrentValue = $row['activa'];
        }
    }
