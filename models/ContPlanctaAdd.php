...
class ContPlanctaAdd extends ContPlancta
{
    ...
    // CSS class/style
    public $CurrentPageName = "ContPlanctaAdd";
    ...
    protected function getAddRow()
    {
        ...
        // clase
        $this->clase->setDbValueDef($rsnew, $this->clase->CurrentValue, false);
        ...
        // subcuenta
        $this->subcuenta->setDbValueDef($rsnew, $this->subcuenta->CurrentValue, false);
        ...
        // activa
        $this->activa->setDbValueDef($rsnew, $this->activa->CurrentValue, false);
        return $rsnew;
    }
    ...
    {
        if (isset($row['clase'])) { // clase
            $this->clase->setFormValue($row['clase']);
        }
        ...
        if (isset($row['subcuenta'])) { // subcuenta
            $this->subcuenta->setFormValue($row['subcuenta']);
        }
        ...
        if (isset($row['activa'])) { // activa
            $this->activa->setFormValue($row['activa']);
        }
    }
