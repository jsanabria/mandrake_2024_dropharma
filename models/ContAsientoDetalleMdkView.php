 ...
 * Page class
 */
class ContAsientoDetalleMdkView extends ContAsientoDetalleMdk
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContAsientoDetalleMdkView";
    ...
    // CSS class/style
    public $CurrentPageName = "ContAsientoDetalleMdkView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ContAsientoDetalleMdkList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ContAsientoDetalleMdkList"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ContAsientoDetalleMdkList"; // No matching record, return to list
                    } else {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ContAsientoDetalleMdkList"), "", $this->TableVar, true);
        $pageId = "view";
