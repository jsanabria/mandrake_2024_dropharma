 ...
 * Page class
 */
class ConteoDetalleView extends ConteoDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConteoDetalleView";
    ...
    // CSS class/style
    public $CurrentPageName = "ConteoDetalleView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ConteoDetalleList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ConteoDetalleList"; // No matching record, return to list
                    } else {
