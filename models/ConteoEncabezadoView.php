 ...
 * Page class
 */
class ConteoEncabezadoView extends ConteoEncabezado
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConteoEncabezadoView";
    ...
    // CSS class/style
    public $CurrentPageName = "ConteoEncabezadoView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ConteoEncabezadoList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ConteoEncabezadoList"; // No matching record, return to list
                    } else {
