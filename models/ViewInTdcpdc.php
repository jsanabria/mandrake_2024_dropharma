...
/**
 * Table class for view_in_tdcpdc
 */
class ViewInTdcpdc extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_in_tdcpdc";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->consignacion->Lookup = new Lookup($this->consignacion, 'view_in_tdcpdc', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->estatus->Lookup = new Lookup($this->estatus, 'view_in_tdcpdc', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->consignacion_reportada->Lookup = new Lookup($this->consignacion_reportada, 'view_in_tdcpdc', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->aplica_retencion->Lookup = new Lookup($this->aplica_retencion, 'view_in_tdcpdc', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->cerrado->Lookup = new Lookup($this->cerrado, 'view_in_tdcpdc', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_in_tdcpdc";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewInTdcpdcList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewInTdcpdcView" => $Language->phrase("View"),
            "ViewInTdcpdcEdit" => $Language->phrase("Edit"),
            "ViewInTdcpdcAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewInTdcpdcView",
            Config("API_ADD_ACTION") => "ViewInTdcpdcAdd",
            Config("API_EDIT_ACTION") => "ViewInTdcpdcEdit",
            Config("API_DELETE_ACTION") => "ViewInTdcpdcDelete",
            Config("API_LIST_ACTION") => "ViewInTdcpdcList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewInTdcpdcView", $parm);
        } else {
            $url = $this->keyUrl("ViewInTdcpdcView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewInTdcpdcEdit", $parm);
        } else {
            $url = $this->keyUrl("ViewInTdcpdcEdit", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewInTdcpdcList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewInTdcpdcAdd", $parm);
        } else {
            $url = $this->keyUrl("ViewInTdcpdcAdd", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewInTdcpdcList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewInTdcpdcDelete", $parm);
        }
    }
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'view_in_tdcpdc');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'view_in_tdcpdc', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'view_in_tdcpdc', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'view_in_tdcpdc', $fldname, $key, $oldvalue);
            }
        }
    }
        ...
        if(trim($rsnew["archivo_pedido"]) != "") {
            ...
            while (($datos = fgetcsv($archivo, 0, ";")) == true) {
                ...
                if($num == 3) {
                    ...
                    $insart->insertar_articulo("TDCPDC", $rsold["id"], 1, $cod_articulo, $cantidad, '', date("Y-m-d", strtotime("1990-01-01")));
                }
                $codigo = "";
                $nombre = "";
                $precio = 0.00;
