 ...
 * Page class
 */
class FabricanteEdit extends Fabricante
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FabricanteEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "FabricanteEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("FabricanteList"); // Return to list page
                        return;
