...
class TablaRetenciones extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->tipo->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        // pagos_mayores
        $this->pagos_mayores = new DbField(
            $this, // Table
            'x_pagos_mayores', // Variable name
            'pagos_mayores', // Name
            '`pagos_mayores`', // Expression
            '`pagos_mayores`', // Basic search expression
            4, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`pagos_mayores`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->pagos_mayores->InputTextType = "text";
        $this->pagos_mayores->Raw = true;
        $this->pagos_mayores->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->pagos_mayores->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->activo->Lookup = new Lookup($this->activo, 'tabla_retenciones', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "TablaRetencionesView" => $Language->phrase("View"),
            "TablaRetencionesEdit" => $Language->phrase("Edit"),
            "TablaRetencionesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "TablaRetencionesView",
            Config("API_ADD_ACTION") => "TablaRetencionesAdd",
            Config("API_EDIT_ACTION") => "TablaRetencionesEdit",
            Config("API_DELETE_ACTION") => "TablaRetencionesDelete",
            Config("API_LIST_ACTION") => "TablaRetencionesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TablaRetencionesView", $parm);
        } else {
            $url = $this->keyUrl("TablaRetencionesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TablaRetencionesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TablaRetencionesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TablaRetencionesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TablaRetencionesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("TablaRetencionesDelete", $parm);
        }
    }
