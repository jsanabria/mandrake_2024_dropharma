 ...
 * Page class
 */
class ViewOutTdcpdvEdit extends ViewOutTdcpdv
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewOutTdcpdvEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewOutTdcpdvEdit";
    ...
    public function run()
    {
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ViewOutTdcpdvList"); // Return to list page
                        return;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ViewOutTdcpdvList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "ViewOutTdcpdvList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ViewOutTdcpdvList") {
                            ...
                            $returnUrl = "ViewOutTdcpdvList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewOutTdcpdvList"), "", $this->TableVar, true);
        $pageId = "edit";
