 ...
 * Page class
 */
class AsesorClienteGrid extends AsesorCliente
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AsesorClienteGrid";
    ...
    public $FormName = "fasesor_clientegrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "AsesorClienteGrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'asesor_cliente'
