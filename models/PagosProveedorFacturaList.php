 ...
 * Page class
 */
class PagosProveedorFacturaList extends PagosProveedorFactura
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PagosProveedorFacturaList";
    ...
    public $FormName = "fpagos_proveedor_facturalist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "PagosProveedorFacturaList";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'pagos_proveedor_factura';
        $this->TableName = 'pagos_proveedor_factura';
        ...
        if (!isset($GLOBALS["pagos_proveedor_factura"]) || $GLOBALS["pagos_proveedor_factura"]::class == PROJECT_NAMESPACE . "pagos_proveedor_factura") {
        ...
        // Initialize URLs
        $this->AddUrl = "PagosProveedorFacturaAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "PagosProveedorFacturaDelete";
        $this->MultiUpdateUrl = "PagosProveedorFacturaUpdate";
        ...
        if ($url != "") {
            ...
            if ($this->IsModal) { // Show as modal
                ...
                if (!SameString($pageName, GetPageName($this->getListUrl()))) { // Not List page
                    ...
                    $result["view"] = SameString($pageName, "PagosProveedorFacturaView"); // If View page, no primary button
                } else { // List page
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "fpagos_proveedor_facturagrid";
        }
        ...
        // Load master record
        if ($this->CurrentMode != "add" && $this->DbMasterFilter != "" && $this->getCurrentMasterTable() == "pagos_proveedor") {
            $masterTbl = Container("pagos_proveedor");
            $rsmaster = $masterTbl->loadRs($this->DbMasterFilter)->fetchAssociative();
            $this->MasterRecordExists = $rsmaster !== false;
            if (!$this->MasterRecordExists) {
                $this->setFailureMessage($Language->phrase("NoRecord")); // Set no record found
                $this->terminate("PagosProveedorList"); // Return to master page
                return;
            } else {
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fpagos_proveedor_facturasrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field pagos_proveedor
        $this->pagos_proveedor->AdvancedSearch->SearchValue = @$filter["x_pagos_proveedor"];
        $this->pagos_proveedor->AdvancedSearch->SearchOperator = @$filter["z_pagos_proveedor"];
        $this->pagos_proveedor->AdvancedSearch->SearchCondition = @$filter["v_pagos_proveedor"];
        $this->pagos_proveedor->AdvancedSearch->SearchValue2 = @$filter["y_pagos_proveedor"];
        $this->pagos_proveedor->AdvancedSearch->SearchOperator2 = @$filter["w_pagos_proveedor"];
        $this->pagos_proveedor->AdvancedSearch->save();
    ...
    public function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->pagos_proveedor, $default, false); // pagos_proveedor
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->pagos_proveedor->AdvancedSearch->save(); // pagos_proveedor
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->pagos_proveedor->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    protected function resetAdvancedSearchParms()
    {
        ...
        $this->pagos_proveedor->AdvancedSearch->unsetSession();
    ...
    protected function restoreSearchParms()
    {
        ...
        $this->pagos_proveedor->AdvancedSearch->load();
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetall") {
                ...
                $this->DbMasterFilter = "";
                $this->DbDetailFilter = "";
                        $this->pagos_proveedor->setSessionValue("");
            }
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"pagos_proveedor_factura\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fpagos_proveedor_facturalist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fpagos_proveedor_facturalist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpagos_proveedor_facturasrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpagos_proveedor_facturasrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fpagos_proveedor_facturalist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_pagos_proveedor_factura", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_pagos_proveedor_factura",
    ...
    protected function loadSearchValues()
    {
        ...
        // pagos_proveedor
        if ($this->pagos_proveedor->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->pagos_proveedor->AdvancedSearch->SearchValue != "" || $this->pagos_proveedor->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    public function loadRowValues($row = null)
    {
        ...
        $this->pagos_proveedor->setDbValue($row['pagos_proveedor']);
    ...
    protected function newRow()
    {
        ...
        $row['pagos_proveedor'] = $this->pagos_proveedor->DefaultValue;
    ...
    public function renderRow()
    {
        ...
        // id_documento
        $this->id_documento->CellCssStyle = "white-space: nowrap;";
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            // pagos_proveedor
            $this->pagos_proveedor->ViewValue = $this->pagos_proveedor->CurrentValue;
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" form=\"fpagos_proveedor_facturalist\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToExcel") . "</button>";
            } else {
                return "<a href=\"$exportUrl\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" form=\"fpagos_proveedor_facturalist\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToWord") . "</button>";
            } else {
                return "<a href=\"$exportUrl\" class=\"btn btn-default ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPdf", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPdf", true)) . "\" form=\"fpagos_proveedor_facturalist\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToPdf") . "</button>";
            } else {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fpagos_proveedor_facturalist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fpagos_proveedor_facturasrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    */
    public function exportData($doc)
    {
        ...
        if (Config("EXPORT_MASTER_RECORD") && $this->DbMasterFilter != "" && $this->getCurrentMasterTable() == "pagos_proveedor") {
            $pagos_proveedor = new PagosProveedorList();
            $rsmaster = $pagos_proveedor->loadRs($this->DbMasterFilter); // Load master record
            if ($rsmaster) {
                $exportStyle = $doc->Style;
                $doc->setStyle("v"); // Change to vertical
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    $doc->setTable($pagos_proveedor);
                    $pagos_proveedor->exportDocument($doc, $rsmaster);
                    $doc->exportEmptyRow();
                    $doc->setTable($this);
                }
    ...
    protected function setupMasterParms()
    {
        ...
        if (($master = Get(Config("TABLE_SHOW_MASTER"), Get(Config("TABLE_MASTER")))) !== null) {
            ...
            if ($masterTblVar == "pagos_proveedor") {
                $validMaster = true;
                $masterTbl = Container("pagos_proveedor");
                if (($parm = Get("fk_id", Get("pagos_proveedor"))) !== null) {
                    $masterTbl->id->setQueryStringValue($parm);
                    $this->pagos_proveedor->QueryStringValue = $masterTbl->id->QueryStringValue; // DO NOT change, master/detail key data type can be different
                    $this->pagos_proveedor->setSessionValue($this->pagos_proveedor->QueryStringValue);
                    $foreignKeys["pagos_proveedor"] = $this->pagos_proveedor->QueryStringValue;
            ...
            if ($masterTblVar == "pagos_proveedor") {
                $validMaster = true;
                $masterTbl = Container("pagos_proveedor");
                if (($parm = Post("fk_id", Post("pagos_proveedor"))) !== null) {
                    $masterTbl->id->setFormValue($parm);
                    $this->pagos_proveedor->FormValue = $masterTbl->id->FormValue;
                    $this->pagos_proveedor->setSessionValue($this->pagos_proveedor->FormValue);
                    $foreignKeys["pagos_proveedor"] = $this->pagos_proveedor->FormValue;
        ...
        if ($validMaster) {
            ...
            if ($masterTblVar != "pagos_proveedor") {
                if (!array_key_exists("pagos_proveedor", $foreignKeys)) { // Not current foreign key
                    $this->pagos_proveedor->setSessionValue("");
                }
            }
        }
