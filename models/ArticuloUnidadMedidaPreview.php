 ...
 * Page class
 */
class ArticuloUnidadMedidaPreview extends ArticuloUnidadMedida
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArticuloUnidadMedidaPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ArticuloUnidadMedidaPreview";
