 ...
 * Page class
 */
class CierreDeCajaView extends CierreDeCaja
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CierreDeCajaView";
    ...
    // CSS class/style
    public $CurrentPageName = "CierreDeCajaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "CierreDeCajaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "CierreDeCajaList"; // No matching record, return to list
                    } else {
