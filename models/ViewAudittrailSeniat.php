...
/**
 * Table class for view_audittrail_seniat
 */
class ViewAudittrailSeniat extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_audittrail_seniat";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_audittrail_seniat";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewAudittrailSeniatList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewAudittrailSeniatView" => $Language->phrase("View"),
            "ViewAudittrailSeniatEdit" => $Language->phrase("Edit"),
            "ViewAudittrailSeniatAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "ViewAudittrailSeniatList";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewAudittrailSeniatView",
            Config("API_ADD_ACTION") => "ViewAudittrailSeniatAdd",
            Config("API_EDIT_ACTION") => "ViewAudittrailSeniatEdit",
            Config("API_DELETE_ACTION") => "ViewAudittrailSeniatDelete",
            Config("API_LIST_ACTION") => "ViewAudittrailSeniatList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewAudittrailSeniatView", $parm);
        } else {
            $url = $this->keyUrl("ViewAudittrailSeniatView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewAudittrailSeniatAdd?" . $parm;
        } else {
            $url = "ViewAudittrailSeniatAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewAudittrailSeniatEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewAudittrailSeniatList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewAudittrailSeniatAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewAudittrailSeniatList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewAudittrailSeniatDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ViewAudittrailSeniatList";
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'view_audittrail_seniat');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'view_audittrail_seniat', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'view_audittrail_seniat', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'view_audittrail_seniat', $fldname, $key, $oldvalue);
            }
        }
    }
