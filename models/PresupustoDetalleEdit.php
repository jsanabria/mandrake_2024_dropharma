 ...
 * Page class
 */
class PresupustoDetalleEdit extends PresupustoDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PresupustoDetalleEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "PresupustoDetalleEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("PresupustoDetalleList"); // Return to list page
                        return;
    ...
    protected function getEditRow($rsold)
    {
        ...
        // presupuesto
        $this->presupuesto->setDbValueDef($rsnew, $this->presupuesto->CurrentValue, $this->presupuesto->ReadOnly);

        // grupo1
        $this->grupo1->setDbValueDef($rsnew, $this->grupo1->CurrentValue, $this->grupo1->ReadOnly);

        // grupo2
        $this->grupo2->setDbValueDef($rsnew, $this->grupo2->CurrentValue, $this->grupo2->ReadOnly);
        ...
        // linea
        $this->linea->setDbValueDef($rsnew, $this->linea->CurrentValue, $this->linea->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['presupuesto'])) { // presupuesto
            $this->presupuesto->CurrentValue = $row['presupuesto'];
        }
        if (isset($row['grupo1'])) { // grupo1
            $this->grupo1->CurrentValue = $row['grupo1'];
        }
        if (isset($row['grupo2'])) { // grupo2
            $this->grupo2->CurrentValue = $row['grupo2'];
        }
        ...
        if (isset($row['linea'])) { // linea
            $this->linea->CurrentValue = $row['linea'];
        }
