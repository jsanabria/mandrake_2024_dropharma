 ...
 * Page class
 */
class PagosProveedorFacturaGrid extends PagosProveedorFactura
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PagosProveedorFacturaGrid";
    ...
    public $FormName = "fpagos_proveedor_facturagrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "PagosProveedorFacturaGrid";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // abono
        $this->abono->setDbValueDef($rsnew, $this->abono->CurrentValue, $this->abono->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['abono'])) { // abono
            $this->abono->CurrentValue = $row['abono'];
        }
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "pagos_proveedor") {
            $this->pagos_proveedor->Visible = true; // Need to insert foreign key
            $this->pagos_proveedor->CurrentValue = $this->pagos_proveedor->getSessionValue();
        }
    ...
    protected function getAddRow()
    {
        ...
        if ($this->pagos_proveedor->getSessionValue() != "") {
            $rsnew['pagos_proveedor'] = $this->pagos_proveedor->getSessionValue();
        }
        return $rsnew;
    }
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['pagos_proveedor'])) { // pagos_proveedor
            $this->pagos_proveedor->setFormValue($row['pagos_proveedor']);
        }
    }
