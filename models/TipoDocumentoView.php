 ...
 * Page class
 */
class TipoDocumentoView extends TipoDocumento
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TipoDocumentoView";
    ...
    // CSS class/style
    public $CurrentPageName = "TipoDocumentoView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "TipoDocumentoList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "TipoDocumentoList"; // No matching record, return to list
                    } else {
