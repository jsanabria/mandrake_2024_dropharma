 ...
 * Page class
 */
class ViewInView extends ViewIn
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "ViewInView";
    ...
    public function setVisibility()
    {
        ...
        $this->articulo_codigo->setVisibility();
        $this->articulo_descripcion->setVisibility();
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ViewInList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ViewInList"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ViewInList"; // No matching record, return to list
                    } else {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewInList"), "", $this->TableVar, true);
        $pageId = "view";
