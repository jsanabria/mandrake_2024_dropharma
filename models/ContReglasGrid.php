 ...
 * Page class
 */
class ContReglasGrid extends ContReglas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContReglasGrid";
    ...
    public $FormName = "fcont_reglasgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ContReglasGrid";
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_codigo")) {
        ...
        if ($CurrentForm->hasValue("o_cargo")) {
            $this->cargo->setOldValue($CurrentForm->getValue("o_cargo"));
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            // cargo
            $this->cargo->EditValue = $this->cargo->options(false);
    ...
    protected function editRow()
    {
        ...
        // Check referential integrity for master table 'cont_reglas_hr'
        $detailKeys = [];
        $keyValue = $rsnew['regla'] ?? $rsold['regla'];
        $detailKeys['regla'] = $keyValue;
        $masterTable = Container("cont_reglas_hr");
        ...
        if (!$validMasterRecord) {
            $relatedRecordMsg = str_replace("%t", "cont_reglas_hr", $Language->phrase("RelatedRecordRequired"));
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "cont_reglas_hr") {
            $this->regla->Visible = true; // Need to insert foreign key
            $this->regla->CurrentValue = $this->regla->getSessionValue();
        }
        ...
        // Check referential integrity for master table 'cont_reglas'
        $validMasterRecord = true;
        $detailKeys = [];
        $detailKeys["regla"] = $this->regla->getSessionValue();
        $masterTable = Container("cont_reglas_hr");
        $masterFilter = $this->getMasterFilter($masterTable, $detailKeys);
        if (!EmptyValue($masterFilter)) {
            $rsmaster = $masterTable->loadRs($masterFilter)->fetch();
    ...
    protected function getAddRow()
    {
        ...
        // regla
        if ($this->regla->getSessionValue() != "") {
            $rsnew['regla'] = $this->regla->getSessionValue();
        }
        return $rsnew;
    }
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['regla'])) { // regla
            $this->regla->setFormValue($row['regla']);
        }
    }
