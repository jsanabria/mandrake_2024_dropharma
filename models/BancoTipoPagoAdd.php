 ...
 * Page class
 */
class BancoTipoPagoAdd extends BancoTipoPago
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BancoTipoPagoAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "BancoTipoPagoAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("BancoTipoPagoList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "BancoTipoPagoList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "BancoTipoPagoView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "BancoTipoPagoList") {
                            ...
                            $returnUrl = "BancoTipoPagoList"; // Return list page content
                        }
                    }
    ...
    {
        $this->banco->DefaultValue = $this->banco->getDefault(); // PHP
        $this->banco->OldValue = $this->banco->DefaultValue;
    }
    ...
    protected function getAddRow()
    {
        ...
        // banco
        $this->banco->setDbValueDef($rsnew, $this->banco->CurrentValue, strval($this->banco->CurrentValue) == "");
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("BancoTipoPagoList"), "", $this->TableVar, true);
