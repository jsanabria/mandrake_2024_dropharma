...
/**
 * Table class for cont_mes_contable
 */
class ContMesContable extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "cont_mes_contable";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // tipo_comprobante
        $this->tipo_comprobante = new DbField(
            $this, // Table
            'x_tipo_comprobante', // Variable name
            'tipo_comprobante', // Name
            '`tipo_comprobante`', // Expression
            '`tipo_comprobante`', // Basic search expression
            129, // Type
            6, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`tipo_comprobante`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->tipo_comprobante->InputTextType = "text";
        $this->tipo_comprobante->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        // M01
        $this->M01 = new DbField(
            $this, // Table
            'x_M01', // Variable name
            'M01', // Name
            '`M01`', // Expression
            '`M01`', // Basic search expression
            200, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`M01`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->M01->InputTextType = "text";
        $this->M01->Raw = true;
        $this->M01->Lookup = new Lookup($this->M01, 'cont_mes_contable', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->M01->OptionCount = 2;
        $this->M01->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['M01'] = &$this->M01;

        // M02
        $this->M02 = new DbField(
            $this, // Table
            'x_M02', // Variable name
            'M02', // Name
            '`M02`', // Expression
            '`M02`', // Basic search expression
            200, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`M02`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->M02->InputTextType = "text";
        $this->M02->Raw = true;
        $this->M02->Lookup = new Lookup($this->M02, 'cont_mes_contable', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->M02->OptionCount = 2;
        $this->M02->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['M02'] = &$this->M02;

        // M03
        $this->M03 = new DbField(
            $this, // Table
            'x_M03', // Variable name
            'M03', // Name
            '`M03`', // Expression
            '`M03`', // Basic search expression
            200, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`M03`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->M03->InputTextType = "text";
        $this->M03->Raw = true;
        $this->M03->Lookup = new Lookup($this->M03, 'cont_mes_contable', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->M03->OptionCount = 2;
        $this->M03->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['M03'] = &$this->M03;

        // M04
        $this->M04 = new DbField(
            $this, // Table
            'x_M04', // Variable name
            'M04', // Name
            '`M04`', // Expression
            '`M04`', // Basic search expression
            200, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`M04`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->M04->InputTextType = "text";
        $this->M04->Raw = true;
        $this->M04->Lookup = new Lookup($this->M04, 'cont_mes_contable', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->M04->OptionCount = 2;
        $this->M04->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['M04'] = &$this->M04;

        // M05
        $this->M05 = new DbField(
            $this, // Table
            'x_M05', // Variable name
            'M05', // Name
            '`M05`', // Expression
            '`M05`', // Basic search expression
            200, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`M05`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->M05->InputTextType = "text";
        $this->M05->Raw = true;
        $this->M05->Lookup = new Lookup($this->M05, 'cont_mes_contable', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->M05->OptionCount = 2;
        $this->M05->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['M05'] = &$this->M05;

        // M06
        $this->M06 = new DbField(
            $this, // Table
            'x_M06', // Variable name
            'M06', // Name
            '`M06`', // Expression
            '`M06`', // Basic search expression
            200, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`M06`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->M06->InputTextType = "text";
        $this->M06->Raw = true;
        $this->M06->Lookup = new Lookup($this->M06, 'cont_mes_contable', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->M06->OptionCount = 2;
        $this->M06->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['M06'] = &$this->M06;

        // M07
        $this->M07 = new DbField(
            $this, // Table
            'x_M07', // Variable name
            'M07', // Name
            '`M07`', // Expression
            '`M07`', // Basic search expression
            200, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`M07`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->M07->InputTextType = "text";
        $this->M07->Raw = true;
        $this->M07->Lookup = new Lookup($this->M07, 'cont_mes_contable', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->M07->OptionCount = 2;
        $this->M07->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['M07'] = &$this->M07;

        // M08
        $this->M08 = new DbField(
            $this, // Table
            'x_M08', // Variable name
            'M08', // Name
            '`M08`', // Expression
            '`M08`', // Basic search expression
            200, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`M08`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->M08->InputTextType = "text";
        $this->M08->Raw = true;
        $this->M08->Lookup = new Lookup($this->M08, 'cont_mes_contable', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->M08->OptionCount = 2;
        $this->M08->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['M08'] = &$this->M08;

        // M09
        $this->M09 = new DbField(
            $this, // Table
            'x_M09', // Variable name
            'M09', // Name
            '`M09`', // Expression
            '`M09`', // Basic search expression
            200, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`M09`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->M09->InputTextType = "text";
        $this->M09->Raw = true;
        $this->M09->Lookup = new Lookup($this->M09, 'cont_mes_contable', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->M09->OptionCount = 2;
        $this->M09->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['M09'] = &$this->M09;

        // M10
        $this->M10 = new DbField(
            $this, // Table
            'x_M10', // Variable name
            'M10', // Name
            '`M10`', // Expression
            '`M10`', // Basic search expression
            200, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`M10`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->M10->InputTextType = "text";
        $this->M10->Raw = true;
        $this->M10->Lookup = new Lookup($this->M10, 'cont_mes_contable', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->M10->OptionCount = 2;
        $this->M10->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['M10'] = &$this->M10;

        // M11
        $this->M11 = new DbField(
            $this, // Table
            'x_M11', // Variable name
            'M11', // Name
            '`M11`', // Expression
            '`M11`', // Basic search expression
            200, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`M11`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->M11->InputTextType = "text";
        $this->M11->Raw = true;
        $this->M11->Lookup = new Lookup($this->M11, 'cont_mes_contable', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->M11->OptionCount = 2;
        $this->M11->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['M11'] = &$this->M11;

        // M12
        $this->M12 = new DbField(
            $this, // Table
            'x_M12', // Variable name
            'M12', // Name
            '`M12`', // Expression
            '`M12`', // Basic search expression
            200, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`M12`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->M12->InputTextType = "text";
        $this->M12->Raw = true;
        $this->M12->Lookup = new Lookup($this->M12, 'cont_mes_contable', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->M12->OptionCount = 2;
        $this->M12->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        ...
        $this->activo->Lookup = new Lookup($this->activo, 'cont_mes_contable', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "cont_mes_contable";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->tipo_comprobante->DbValue = $row['tipo_comprobante'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ContMesContableList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ContMesContableView" => $Language->phrase("View"),
            "ContMesContableEdit" => $Language->phrase("Edit"),
            "ContMesContableAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ContMesContableView",
            Config("API_ADD_ACTION") => "ContMesContableAdd",
            Config("API_EDIT_ACTION") => "ContMesContableEdit",
            Config("API_DELETE_ACTION") => "ContMesContableDelete",
            Config("API_LIST_ACTION") => "ContMesContableList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ContMesContableView", $parm);
        } else {
            $url = $this->keyUrl("ContMesContableView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ContMesContableAdd?" . $parm;
        } else {
            $url = "ContMesContableAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContMesContableEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContMesContableList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContMesContableAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContMesContableList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ContMesContableDelete", $parm);
        }
    }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->tipo_comprobante);
                    $doc->exportCaption($this->descripcion);
                    $doc->exportCaption($this->M01);
                    $doc->exportCaption($this->M02);
                    $doc->exportCaption($this->M03);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->tipo_comprobante);
                        $doc->exportField($this->descripcion);
                        $doc->exportField($this->M01);
                        $doc->exportField($this->M02);
                        $doc->exportField($this->M03);
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'cont_mes_contable');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'cont_mes_contable', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'cont_mes_contable', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'cont_mes_contable', $fldname, $key, $oldvalue);
            }
        }
    }
