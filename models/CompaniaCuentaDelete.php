 ...
 * Page class
 */
class CompaniaCuentaDelete extends CompaniaCuenta
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CompaniaCuentaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "CompaniaCuentaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CompaniaCuentaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("CompaniaCuentaList"); // Return to list
                return;
            }
        }
