 ...
 * Page class
 */
class ContPeriodoContableDelete extends ContPeriodoContable
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContPeriodoContableDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ContPeriodoContableDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ContPeriodoContableList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ContPeriodoContableList"); // Return to list
                return;
            }
        }
