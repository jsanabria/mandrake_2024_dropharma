 ...
 * Page class
 */
class PedidosDetallesOnlineBitacoraDelete extends PedidosDetallesOnlineBitacora
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PedidosDetallesOnlineBitacoraDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PedidosDetallesOnlineBitacoraDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PedidosDetallesOnlineBitacoraList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("PedidosDetallesOnlineBitacoraList"); // Return to list
                return;
            }
        }
