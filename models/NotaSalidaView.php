 ...
 * Page class
 */
class NotaSalidaView extends NotaSalida
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NotaSalidaView";
    ...
    // CSS class/style
    public $CurrentPageName = "NotaSalidaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "NotaSalidaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "NotaSalidaList"; // No matching record, return to list
                    } else {
