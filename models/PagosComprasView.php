 ...
 * Page class
 */
class PagosComprasView extends PagosCompras
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PagosComprasView";
    ...
    // CSS class/style
    public $CurrentPageName = "PagosComprasView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "PagosComprasList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "PagosComprasList"; // No matching record, return to list
                    } else {
    ...
    public function pageDataRendering(&$header)
    {
        // Example:
        //$header = "your header";
       	$url = "../SalidasView/" . $this->id_documento->CurrentValue . "?showdetail=entradas_salidas";
       	$header .= '<a href="' . $url . '" class="btn btn-primary" id="btnCierreDeCaja">Ir al Documento</a>';
    }
