...
/**
 * Table class for view_bultos
 */
class ViewBultos extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->fecha_despacho = new DbField(
            ...
            CastDateFieldForLike("`fecha_despacho`", 11, "DB"), // Basic search expression
            135, // Type
            76, // Size
            11, // Date/Time format
            false, // Is upload field
        ...
        $this->fecha_despacho->DefaultErrorMessage = str_replace("%s", DateFormat(11), $Language->phrase("IncorrectDate"));
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_bultos";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewBultosList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewBultosView" => $Language->phrase("View"),
            "ViewBultosEdit" => $Language->phrase("Edit"),
            "ViewBultosAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewBultosView",
            Config("API_ADD_ACTION") => "ViewBultosAdd",
            Config("API_EDIT_ACTION") => "ViewBultosEdit",
            Config("API_DELETE_ACTION") => "ViewBultosDelete",
            Config("API_LIST_ACTION") => "ViewBultosList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewBultosView", $parm);
        } else {
            $url = $this->keyUrl("ViewBultosView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewBultosEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewBultosList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewBultosAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewBultosList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewBultosDelete", $parm);
        }
    }
