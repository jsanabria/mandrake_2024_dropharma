 ...
 * Page class
 */
class ContLotesPagosDelete extends ContLotesPagos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContLotesPagosDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ContLotesPagosDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ContLotesPagosList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ContLotesPagosList"); // Return to list
                return;
            }
        }
