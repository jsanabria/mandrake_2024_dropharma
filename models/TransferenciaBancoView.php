 ...
 * Page class
 */
class TransferenciaBancoView extends TransferenciaBanco
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TransferenciaBancoView";
    ...
    // CSS class/style
    public $CurrentPageName = "TransferenciaBancoView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "TransferenciaBancoList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "TransferenciaBancoList"; // No matching record, return to list
                    } else {
