 ...
 * Page class
 */
class ContMesContableView extends ContMesContable
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContMesContableView";
    ...
    // CSS class/style
    public $CurrentPageName = "ContMesContableView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ContMesContableList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ContMesContableList"; // No matching record, return to list
                    } else {
