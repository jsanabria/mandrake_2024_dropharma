 ...
 * Page class
 */
class ContAsientoEdit extends ContAsiento
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContAsientoEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ContAsientoEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ContAsientoList"); // Return to list page
                        return;
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "ContAsientoList") {
                            ...
                            $returnUrl = "ContAsientoList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    public function renderRow()
    {
        ...
        // debe
        $this->debe->RowCssClass = "row";

        // haber
        $this->haber->RowCssClass = "row";

        // id_referencia
        $this->id_referencia->RowCssClass = "row";
