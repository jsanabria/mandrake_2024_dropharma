 ...
 * Page class
 */
class TipoDocumentoEdit extends TipoDocumento
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TipoDocumentoEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "TipoDocumentoEdit";
    ...
    public function run()
    {
        ...
        $this->setVisibility();
        $this->descripcion->Required = false;
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("TipoDocumentoList"); // Return to list page
                        return;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("TipoDocumentoList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "TipoDocumentoList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "TipoDocumentoList") {
                            ...
                            $returnUrl = "TipoDocumentoList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("TipoDocumentoList"), "", $this->TableVar, true);
        $pageId = "edit";
