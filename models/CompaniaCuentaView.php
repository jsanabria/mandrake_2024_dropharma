 ...
 * Page class
 */
class CompaniaCuentaView extends CompaniaCuenta
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CompaniaCuentaView";
    ...
    // CSS class/style
    public $CurrentPageName = "CompaniaCuentaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "CompaniaCuentaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "CompaniaCuentaList"; // No matching record, return to list
                    } else {
