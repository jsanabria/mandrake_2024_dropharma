 ...
 * Page class
 */
class ViewCuentasPorPagarPreview extends ViewCuentasPorPagar
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewCuentasPorPagarPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewCuentasPorPagarPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_cuentas_por_pagar_resumen") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_cuentas_por_pagar_resumen&" . GetForeignKeyUrl("fk_proveedor", $this->proveedor->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "view_cuentas_por_pagar_resumen") {
            $this->proveedor->setQueryStringValue($keys[0] ?? "");
        }
    }
