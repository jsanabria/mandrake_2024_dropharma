 ...
 * Page class
 */
class ContTerceroMdkAdd extends ContTerceroMdk
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContTerceroMdkAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ContTerceroMdkAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ContTerceroMdkView") {
    ...
    protected function getAddRow()
    {
        ...
        // origen_tabla
        $this->origen_tabla->setDbValueDef($rsnew, $this->origen_tabla->CurrentValue, false);

        // origen_id
        $this->origen_id->setDbValueDef($rsnew, $this->origen_id->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['origen_tabla'])) { // origen_tabla
            $this->origen_tabla->setFormValue($row['origen_tabla']);
        }
        if (isset($row['origen_id'])) { // origen_id
            $this->origen_id->setFormValue($row['origen_id']);
        }
