...
class PagosEdit extends Pagos
{
    ...
    public function run()
    {
        ...
        $this->comprobante_pago->Visible = false;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->monto->ViewValue = FormatNumber($this->monto->ViewValue, 2, -1, -1, -1);
            ...
            if (strval($this->monto->EditValue) != "" && is_numeric($this->monto->EditValue)) {
                $this->monto->EditValue = FormatNumber($this->monto->EditValue, -2, -1, -2, -1);
            }
