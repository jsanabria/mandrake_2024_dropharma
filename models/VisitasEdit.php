 ...
 * Page class
 */
class VisitasEdit extends Visitas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VisitasEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "VisitasEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("VisitasList"); // Return to list page
                        return;
    ...
    protected function getEditRow($rsold)
    {
        ...
        // comentario
        $this->comentario->setDbValueDef($rsnew, $this->comentario->CurrentValue, $this->comentario->ReadOnly);

        // seguimiento
        $this->seguimiento->setDbValueDef($rsnew, $this->seguimiento->CurrentValue, $this->seguimiento->ReadOnly);

        // fecha
        $this->fecha->setDbValueDef($rsnew, $this->fecha->CurrentValue, $this->fecha->ReadOnly);
