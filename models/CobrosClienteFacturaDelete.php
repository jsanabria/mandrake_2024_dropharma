 ...
 * Page class
 */
class CobrosClienteFacturaDelete extends CobrosClienteFactura
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CobrosClienteFacturaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "CobrosClienteFacturaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CobrosClienteFacturaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("CobrosClienteFacturaList"); // Return to list
                return;
            }
        }
