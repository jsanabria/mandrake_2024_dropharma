 ...
 * Page class
 */
class ViewOutTdcpdvView extends ViewOutTdcpdv
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewOutTdcpdvView";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewOutTdcpdvView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ViewOutTdcpdvList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ViewOutTdcpdvList"; // No matching record, return to list
                    } else {
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ViewOutList?" . Config("TABLE_SHOW_MASTER") . "=view_out_tdcpdv&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "&" . GetForeignKeyUrl("fk_tipo_documento", $this->tipo_documento->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
    ...
    {
        // Example:
        // $url = "ViewOutList?showmaster=view_out_tdcpdv&fk_id=" . $this->id->CurrentValue . "&fk_tipo_documento=" . $this->tipo_documento->CurrentValue . "";
    }
