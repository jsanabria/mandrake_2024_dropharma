 ...
 * Page class
 */
class HistoriaArticuloEdit extends HistoriaArticulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HistoriaArticuloEdit";
        ...
        if (IsApi()) {
            ...
            if ($this->isShow()) {
                ...
                if ($this->TotalRecords <= 0) { // No record found
                    ...
                    $this->terminate("HistoriaArticuloList"); // Return to list page
                    return;
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // proveedor
            $this->proveedor->setDbValueDef($rsnew, $this->proveedor->CurrentValue, null, $this->proveedor->ReadOnly);

            // almacen
            $this->almacen->setDbValueDef($rsnew, $this->almacen->CurrentValue, null, $this->almacen->ReadOnly);
            ...
            // fecha_vencimiento
            $this->fecha_vencimiento->setDbValueDef($rsnew, UnFormatDateTime($this->fecha_vencimiento->CurrentValue, 0), null, $this->fecha_vencimiento->ReadOnly);

            // usuario
            $this->usuario->setDbValueDef($rsnew, $this->usuario->CurrentValue, null, $this->usuario->ReadOnly);

            // entradas
            $this->entradas->setDbValueDef($rsnew, $this->entradas->CurrentValue, null, $this->entradas->ReadOnly);

            // salidas
            $this->salidas->setDbValueDef($rsnew, $this->salidas->CurrentValue, null, $this->salidas->ReadOnly);
