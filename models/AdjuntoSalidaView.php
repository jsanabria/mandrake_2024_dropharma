 ...
 * Page class
 */
class AdjuntoSalidaView extends AdjuntoSalida
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AdjuntoSalidaView";
    ...
    // CSS class/style
    public $CurrentPageName = "AdjuntoSalidaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "AdjuntoSalidaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "AdjuntoSalidaList"; // No matching record, return to list
                    } else {
