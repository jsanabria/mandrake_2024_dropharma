...
/**
 * Table class for view_out_tdcpdv
 */
class ViewOutTdcpdv extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_out_tdcpdv";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->descuento->InputTextType = "number";
        ...
        $this->descuento2->InputTextType = "number";
        ...
        $this->estatus->Lookup = new Lookup($this->estatus, 'view_out_tdcpdv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->documento->Lookup = new Lookup($this->documento, 'view_out_tdcpdv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->entregado->Lookup = new Lookup($this->entregado, 'view_out_tdcpdv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->pagado->Lookup = new Lookup($this->pagado, 'view_out_tdcpdv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->consignacion->Lookup = new Lookup($this->consignacion, 'view_out_tdcpdv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->factura->Lookup = new Lookup($this->factura, 'view_out_tdcpdv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->activo->Lookup = new Lookup($this->activo, 'view_out_tdcpdv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->cerrado->Lookup = new Lookup($this->cerrado, 'view_out_tdcpdv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->genera_ne->Lookup = new Lookup($this->genera_ne, 'view_out_tdcpdv', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_out_tdcpdv";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewOutTdcpdvList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewOutTdcpdvView" => $Language->phrase("View"),
            "ViewOutTdcpdvEdit" => $Language->phrase("Edit"),
            "ViewOutTdcpdvAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewOutTdcpdvView",
            Config("API_ADD_ACTION") => "ViewOutTdcpdvAdd",
            Config("API_EDIT_ACTION") => "ViewOutTdcpdvEdit",
            Config("API_DELETE_ACTION") => "ViewOutTdcpdvDelete",
            Config("API_LIST_ACTION") => "ViewOutTdcpdvList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewOutTdcpdvView", $parm);
        } else {
            $url = $this->keyUrl("ViewOutTdcpdvView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewOutTdcpdvAdd?" . $parm;
        } else {
            $url = "ViewOutTdcpdvAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewOutTdcpdvEdit", $parm);
        } else {
            $url = $this->keyUrl("ViewOutTdcpdvEdit", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewOutTdcpdvList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewOutTdcpdvAdd", $parm);
        } else {
            $url = $this->keyUrl("ViewOutTdcpdvAdd", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewOutTdcpdvList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewOutTdcpdvDelete", $parm);
        }
    }
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'view_out_tdcpdv');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'view_out_tdcpdv', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'view_out_tdcpdv', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'view_out_tdcpdv', $fldname, $key, $oldvalue);
            }
        }
    }
    ...
    {
        //Log("Row Updated");
        $sql = "SELECT articulo FROM entradas_salidas WHERE id_documento = " . $rsold["id"] . " AND tipo_documento = 'TDCPDV';";
    ...
    {
        /*
        $sql = "SELECT articulo FROM entradas_salidas WHERE id_documento = " . $rs["id"] . " AND tipo_documento = 'TDCPDV';";
        $rows = ExecuteRows($sql);
        foreach ($rows as $key => $value) {
            $articulo = $value["articulo"];
            Execute("CALL sp_onhand_item($articulo);");
