 ...
 * Page class
 */
class TransferenciaBancoDelete extends TransferenciaBanco
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TransferenciaBancoDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TransferenciaBancoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TransferenciaBancoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("TransferenciaBancoList"); // Return to list
                return;
            }
        }
