 ...
 * Page class
 */
class ViewInTdcfccEdit extends ViewInTdcfcc
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewInTdcfccEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewInTdcfccEdit";
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ViewInTdcfccList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "ViewInTdcfccList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ViewInTdcfccList") {
                            ...
                            $returnUrl = "ViewInTdcfccList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
