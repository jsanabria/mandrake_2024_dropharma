 ...
 * Page class
 */
class AsesorFabricanteAdd extends AsesorFabricante
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AsesorFabricanteAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "AsesorFabricanteAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("AsesorFabricanteList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "AsesorFabricanteList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "AsesorFabricanteView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "AsesorFabricanteList") {
                            ...
                            $returnUrl = "AsesorFabricanteList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("AsesorFabricanteList"), "", $this->TableVar, true);
