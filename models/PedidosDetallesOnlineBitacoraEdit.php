 ...
 * Page class
 */
class PedidosDetallesOnlineBitacoraEdit extends PedidosDetallesOnlineBitacora
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PedidosDetallesOnlineBitacoraEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "PedidosDetallesOnlineBitacoraEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("PedidosDetallesOnlineBitacoraList"); // Return to list page
                        return;
    ...
    protected function getEditRow($rsold)
    {
        ...
        // cantidad_solicitada
        $this->cantidad_solicitada->setDbValueDef($rsnew, $this->cantidad_solicitada->CurrentValue, $this->cantidad_solicitada->ReadOnly);

        // cantidadasignada
        $this->cantidadasignada->setDbValueDef($rsnew, $this->cantidadasignada->CurrentValue, $this->cantidadasignada->ReadOnly);
        return $rsnew;
    }
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['cantidad_solicitada'])) { // cantidad_solicitada
            $this->cantidad_solicitada->CurrentValue = $row['cantidad_solicitada'];
        }
        if (isset($row['cantidadasignada'])) { // cantidadasignada
            $this->cantidadasignada->CurrentValue = $row['cantidadasignada'];
        }
    }
