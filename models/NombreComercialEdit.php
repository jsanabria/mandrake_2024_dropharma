 ...
 * Page class
 */
class NombreComercialEdit extends NombreComercial
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NombreComercialEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "NombreComercialEdit";
    ...
    public function run()
    {
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("NombreComercialList"); // Return to list page
                        return;
                        ...
                        if ($this->codigo->CurrentValue != null) {
                            while ($this->fetch()) {
                                if (SameString($this->codigo->CurrentValue, $this->CurrentRow['codigo'])) {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("NombreComercialList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "NombreComercialList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "NombreComercialList") {
                            ...
                            $returnUrl = "NombreComercialList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("NombreComercialList"), "", $this->TableVar, true);
        $pageId = "edit";
