 ...
 * Page class
 */
class ContConfiguracionMdkEdit extends ContConfiguracionMdk
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContConfiguracionMdkEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ContConfiguracionMdkEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ContConfiguracionMdkList"); // Return to list page
                        return;
    ...
    protected function editRow()
    {
        ...
        // Check field with unique index (clave)
        if ($this->clave->CurrentValue != "") {
            $filterChk = "(`clave` = '" . AdjustSql($this->clave->CurrentValue, $this->Dbid) . "')";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // valor_texto
        $this->valor_texto->setDbValueDef($rsnew, $this->valor_texto->CurrentValue, $this->valor_texto->ReadOnly);

        // valor_numero
        $this->valor_numero->setDbValueDef($rsnew, $this->valor_numero->CurrentValue, $this->valor_numero->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['valor_texto'])) { // valor_texto
            $this->valor_texto->CurrentValue = $row['valor_texto'];
        }
        if (isset($row['valor_numero'])) { // valor_numero
            $this->valor_numero->CurrentValue = $row['valor_numero'];
        }
