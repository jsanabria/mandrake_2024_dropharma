...
class EntradasEdit extends Entradas
{
    ...
    // CSS class/style
    public $CurrentPageName = "EntradasEdit";
    ...
    public function setVisibility()
    {
        ...
        $this->consignacion_reportada->setVisibility();
        ...
        $this->fecha_libro_compra->setVisibility();
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'consignacion_reportada' first before field var 'x_consignacion_reportada'
        $val = $CurrentForm->hasValue("consignacion_reportada") ? $CurrentForm->getValue("consignacion_reportada") : $CurrentForm->getValue("x_consignacion_reportada");
        if (!$this->consignacion_reportada->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->consignacion_reportada->Visible = false; // Disable update for API request
            } else {
                $this->consignacion_reportada->setFormValue($val);
            }
        }
        ...
        // Check field name 'fecha_libro_compra' first before field var 'x_fecha_libro_compra'
        $val = $CurrentForm->hasValue("fecha_libro_compra") ? $CurrentForm->getValue("fecha_libro_compra") : $CurrentForm->getValue("x_fecha_libro_compra");
        if (!$this->fecha_libro_compra->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->fecha_libro_compra->Visible = false; // Disable update for API request
            } else {
                $this->fecha_libro_compra->setFormValue($val, true, $validate);
            }
    ...
    public function restoreFormValues()
    {
        ...
        $this->consignacion_reportada->CurrentValue = $this->consignacion_reportada->FormValue;
        ...
        $this->fecha_libro_compra->CurrentValue = $this->fecha_libro_compra->FormValue;
        $this->fecha_libro_compra->CurrentValue = UnFormatDateTime($this->fecha_libro_compra->CurrentValue, $this->fecha_libro_compra->formatPattern());
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->fecha_libro_compra->EditValue = HtmlEncode(FormatDateTime($this->fecha_libro_compra->CurrentValue, $this->fecha_libro_compra->formatPattern()));
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->consignacion_reportada->Visible && $this->consignacion_reportada->Required) {
                if (!$this->consignacion_reportada->IsDetailKey && EmptyValue($this->consignacion_reportada->FormValue)) {
                    $this->consignacion_reportada->addErrorMessage(str_replace("%s", $this->consignacion_reportada->caption(), $this->consignacion_reportada->RequiredErrorMessage));
                }
            }
            ...
            if ($this->fecha_libro_compra->Visible && $this->fecha_libro_compra->Required) {
                if (!$this->fecha_libro_compra->IsDetailKey && EmptyValue($this->fecha_libro_compra->FormValue)) {
                    $this->fecha_libro_compra->addErrorMessage(str_replace("%s", $this->fecha_libro_compra->caption(), $this->fecha_libro_compra->RequiredErrorMessage));
                }
            }
            if (!CheckDate($this->fecha_libro_compra->FormValue, $this->fecha_libro_compra->formatPattern())) {
                $this->fecha_libro_compra->addErrorMessage($this->fecha_libro_compra->getErrorMessage(false));
            }
    ...
    protected function getEditRow($rsold)
    {
        ...
        // consignacion_reportada
        $this->consignacion_reportada->setDbValueDef($rsnew, $this->consignacion_reportada->CurrentValue, $this->consignacion_reportada->ReadOnly);
        ...
        // fecha_registro_retenciones
        $this->fecha_registro_retenciones->setDbValueDef($rsnew, UnFormatDateTime($this->fecha_registro_retenciones->CurrentValue, $this->fecha_registro_retenciones->formatPattern()), $this->fecha_registro_retenciones->ReadOnly);
        ...
        // fecha_libro_compra
        $this->fecha_libro_compra->setDbValueDef($rsnew, UnFormatDateTime($this->fecha_libro_compra->CurrentValue, $this->fecha_libro_compra->formatPattern()), $this->fecha_libro_compra->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['consignacion_reportada'])) { // consignacion_reportada
            $this->consignacion_reportada->CurrentValue = $row['consignacion_reportada'];
        }
        ...
        if (isset($row['fecha_registro_retenciones'])) { // fecha_registro_retenciones
            $this->fecha_registro_retenciones->CurrentValue = $row['fecha_registro_retenciones'];
        }
        ...
        if (isset($row['fecha_libro_compra'])) { // fecha_libro_compra
            $this->fecha_libro_compra->CurrentValue = $row['fecha_libro_compra'];
        }
