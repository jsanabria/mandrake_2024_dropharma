 ...
 * Page class
 */
class PagosComprasDetalleDelete extends PagosComprasDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PagosComprasDetalleDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PagosComprasDetalleDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PagosComprasDetalleList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("PagosComprasDetalleList"); // Return to list
                return;
            }
        }
