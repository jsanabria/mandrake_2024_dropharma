...
/**
 * Table class for movimiento_bancario
 */
class MovimientoBancario extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "movimiento_bancario";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->concepto->Raw = true;
        $this->concepto->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->concepto->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "movimiento_bancario";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MovimientoBancarioList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "MovimientoBancarioView" => $Language->phrase("View"),
            "MovimientoBancarioEdit" => $Language->phrase("Edit"),
            "MovimientoBancarioAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "MovimientoBancarioView",
            Config("API_ADD_ACTION") => "MovimientoBancarioAdd",
            Config("API_EDIT_ACTION") => "MovimientoBancarioEdit",
            Config("API_DELETE_ACTION") => "MovimientoBancarioDelete",
            Config("API_LIST_ACTION") => "MovimientoBancarioList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MovimientoBancarioView", $parm);
        } else {
            $url = $this->keyUrl("MovimientoBancarioView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "MovimientoBancarioAdd?" . $parm;
        } else {
            $url = "MovimientoBancarioAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MovimientoBancarioEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MovimientoBancarioList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MovimientoBancarioAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MovimientoBancarioList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("MovimientoBancarioDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "MovimientoBancarioList";
    ...
    public function renderEditRow()
    {
        ...
        if (strval($this->concepto->EditValue) != "" && is_numeric($this->concepto->EditValue)) {
            $this->concepto->EditValue = FormatNumber($this->concepto->EditValue, null);
        }
