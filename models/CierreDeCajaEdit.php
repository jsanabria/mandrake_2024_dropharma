 ...
 * Page class
 */
class CierreDeCajaEdit extends CierreDeCaja
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CierreDeCajaEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "CierreDeCajaEdit";
    ...
    public function run()
    {
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("CierreDeCajaList"); // Return to list page
                        return;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("CierreDeCajaList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "CierreDeCajaList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "CierreDeCajaList") {
                            ...
                            $returnUrl = "CierreDeCajaList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("CierreDeCajaList"), "", $this->TableVar, true);
        $pageId = "edit";
