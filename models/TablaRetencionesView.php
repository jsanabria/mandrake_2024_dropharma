 ...
 * Page class
 */
class TablaRetencionesView extends TablaRetenciones
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TablaRetencionesView";
    ...
    // CSS class/style
    public $CurrentPageName = "TablaRetencionesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "TablaRetencionesList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "TablaRetencionesList"; // No matching record, return to list
                    } else {
