 ...
 * Page class
 */
class ViewInTdcnrpEdit extends ViewInTdcnrp
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewInTdcnrpEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewInTdcnrpEdit";
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ViewInTdcnrpList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "ViewInTdcnrpList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ViewInTdcnrpList") {
                            ...
                            $returnUrl = "ViewInTdcnrpList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
