 ...
 * Page class
 */
class PagoDestinoReglaEdit extends PagoDestinoRegla
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PagoDestinoReglaEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "PagoDestinoReglaEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // compania
        $this->compania->setDbValueDef($rsnew, $this->compania->CurrentValue, $this->compania->ReadOnly);
        ...
        // cuenta_destino_id
        $this->cuenta_destino_id->setDbValueDef($rsnew, $this->cuenta_destino_id->CurrentValue, $this->cuenta_destino_id->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['compania'])) { // compania
            $this->compania->CurrentValue = $row['compania'];
        }
        ...
        if (isset($row['cuenta_destino_id'])) { // cuenta_destino_id
            $this->cuenta_destino_id->CurrentValue = $row['cuenta_destino_id'];
        }
        if (isset($row['prioridad'])) { // prioridad
            $this->prioridad->CurrentValue = $row['prioridad'];
        }
