 ...
 * Page class
 */
class PedidosDetallesOnlineBitacoraView extends PedidosDetallesOnlineBitacora
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PedidosDetallesOnlineBitacoraView";
    ...
    // CSS class/style
    public $CurrentPageName = "PedidosDetallesOnlineBitacoraView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "PedidosDetallesOnlineBitacoraList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "PedidosDetallesOnlineBitacoraList"; // No matching record, return to list
                    } else {
