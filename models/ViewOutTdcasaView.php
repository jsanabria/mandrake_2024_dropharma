 ...
 * Page class
 */
class ViewOutTdcasaView extends ViewOutTdcasa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewOutTdcasaView";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewOutTdcasaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ViewOutTdcasaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ViewOutTdcasaList"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ViewOutTdcasaList"; // No matching record, return to list
                    } else {
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ViewOutList?" . Config("TABLE_SHOW_MASTER") . "=view_out_tdcasa&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "&" . GetForeignKeyUrl("fk_tipo_documento", $this->tipo_documento->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewOutTdcasaList"), "", $this->TableVar, true);
        $pageId = "view";
    ...
    public function pageDataRendering(&$header)
    {
        ...
        if($this->estatus->CurrentValue == "NUEVO") {
            $header = "../AjusteSalida?id=" . $this->id->CurrentValue . "&tipo_documento=TDCASA";
            $header = '<a class="btn btn-outline-primary" id="btnNuevo" href="' . $header . '"><span class="fas fa-edit"></span> Editar Documento</a>';
            $header .= ' ';
        }
        $url = "../reportes/ajuste_de_salida.php?id=" . $this->id->CurrentValue . "&tipo=TDCASA";
        ...
        if($this->factura->CurrentValue == "S") {
            $header .= ' ';
            $url = "../reportes/documento_ajuste_de_salida.php?id=" . $this->id->CurrentValue . "&tipo=TDCASA";
            $header .= '<a class="btn btn-outline-primary" target="_blank" href="' . $url . '"><span class="fas fa-print"></span> Imprimir Documento Entrega</a>';
        }
        $header .= '<br><br>';
    }
