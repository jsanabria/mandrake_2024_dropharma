 ...
 * Page class
 */
class ContReglasView extends ContReglas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContReglasView";
    ...
    // CSS class/style
    public $CurrentPageName = "ContReglasView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ContReglasList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ContReglasList"; // No matching record, return to list
                    } else {
