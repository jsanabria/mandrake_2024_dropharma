 ...
 * Page class
 */
class PagosComprasDetallePreview extends PagosComprasDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PagosComprasDetallePreview";
    ...
    // CSS class/style
    public $CurrentPageName = "PagosComprasDetallePreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "pagos_compras") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=pagos_compras&" . GetForeignKeyUrl("fk_id", $this->pagos_compras->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "pagos_compras") {
            $this->pagos_compras->setQueryStringValue($keys[0] ?? "");
        }
    }
