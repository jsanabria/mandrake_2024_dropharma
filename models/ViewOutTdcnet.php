...
/**
 * Table class for view_out_tdcnet
 */
class ViewOutTdcnet extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_out_tdcnet";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->estatus->Lookup = new Lookup($this->estatus, 'view_out_tdcnet', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->documento->Lookup = new Lookup($this->documento, 'view_out_tdcnet', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->entregado->Lookup = new Lookup($this->entregado, 'view_out_tdcnet', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->pagado->Lookup = new Lookup($this->pagado, 'view_out_tdcnet', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->consignacion->Lookup = new Lookup($this->consignacion, 'view_out_tdcnet', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->factura->Lookup = new Lookup($this->factura, 'view_out_tdcnet', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->activo->Lookup = new Lookup($this->activo, 'view_out_tdcnet', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->cerrado->Lookup = new Lookup($this->cerrado, 'view_out_tdcnet', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->igtf->Raw = true;
        $this->igtf->Lookup = new Lookup($this->igtf, 'view_out_tdcnet', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->impreso->Lookup = new Lookup($this->impreso, 'view_out_tdcnet', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->genera_ne->Lookup = new Lookup($this->genera_ne, 'view_out_tdcnet', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_out_tdcnet";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewOutTdcnetList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewOutTdcnetView" => $Language->phrase("View"),
            "ViewOutTdcnetEdit" => $Language->phrase("Edit"),
            "ViewOutTdcnetAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewOutTdcnetView",
            Config("API_ADD_ACTION") => "ViewOutTdcnetAdd",
            Config("API_EDIT_ACTION") => "ViewOutTdcnetEdit",
            Config("API_DELETE_ACTION") => "ViewOutTdcnetDelete",
            Config("API_LIST_ACTION") => "ViewOutTdcnetList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewOutTdcnetView", $parm);
        } else {
            $url = $this->keyUrl("ViewOutTdcnetView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewOutTdcnetAdd?" . $parm;
        } else {
            $url = "ViewOutTdcnetAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewOutTdcnetEdit", $parm);
        } else {
            $url = $this->keyUrl("ViewOutTdcnetEdit", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewOutTdcnetList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewOutTdcnetAdd", $parm);
        } else {
            $url = $this->keyUrl("ViewOutTdcnetAdd", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewOutTdcnetList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewOutTdcnetDelete", $parm);
        }
    }
    ...
    public function renderListRow()
    {
        ...
        if ($this->fotos->UseColorbox) {
            ...
            $this->fotos->LinkAttrs["data-rel"] = "view_out_tdcnet_x_fotos";
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'view_out_tdcnet');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'view_out_tdcnet', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'view_out_tdcnet', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'view_out_tdcnet', $fldname, $key, $oldvalue);
            }
        }
    }
    ...
    {
        //Log("Row Updated");
        $sql = "SELECT articulo FROM entradas_salidas WHERE id_documento = " . $rsold["id"] . " AND tipo_documento = 'TDCNET';";
