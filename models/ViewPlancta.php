...
/**
 * Table class for view_plancta
 */
class ViewPlancta extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->activa->Lookup = new Lookup($this->activa, 'view_plancta', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_plancta";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPlanctaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewPlanctaView" => $Language->phrase("View"),
            "ViewPlanctaEdit" => $Language->phrase("Edit"),
            "ViewPlanctaAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewPlanctaView",
            Config("API_ADD_ACTION") => "ViewPlanctaAdd",
            Config("API_EDIT_ACTION") => "ViewPlanctaEdit",
            Config("API_DELETE_ACTION") => "ViewPlanctaDelete",
            Config("API_LIST_ACTION") => "ViewPlanctaList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPlanctaView", $parm);
        } else {
            $url = $this->keyUrl("ViewPlanctaView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPlanctaEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPlanctaList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPlanctaAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPlanctaList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewPlanctaDelete", $parm);
        }
    }
