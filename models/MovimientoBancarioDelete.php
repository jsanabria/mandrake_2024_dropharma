 ...
 * Page class
 */
class MovimientoBancarioDelete extends MovimientoBancario
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MovimientoBancarioDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "MovimientoBancarioDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MovimientoBancarioList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("MovimientoBancarioList"); // Return to list
                return;
            }
        }
