 ...
 * Page class
 */
class TarifaDescuentoUtilidadPreview extends TarifaDescuentoUtilidad
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TarifaDescuentoUtilidadPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "TarifaDescuentoUtilidadPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "tarifa") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=tarifa&" . GetForeignKeyUrl("fk_id", $this->tarifa->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "tarifa") {
            $this->tarifa->setQueryStringValue($keys[0] ?? "");
        }
    }
