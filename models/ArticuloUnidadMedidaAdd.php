 ...
 * Page class
 */
class ArticuloUnidadMedidaAdd extends ArticuloUnidadMedida
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArticuloUnidadMedidaAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ArticuloUnidadMedidaAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ArticuloUnidadMedidaView") {
