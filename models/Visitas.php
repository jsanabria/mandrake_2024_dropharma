...
/**
 * Table class for visitas
 */
class Visitas extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // producto
        $this->producto = new DbField(
            $this, // Table
            'x_producto', // Variable name
            'producto', // Name
            '`producto`', // Expression
            '`producto`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`producto`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->producto->InputTextType = "text";
        $this->producto->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['producto'] = &$this->producto;
        ...
        // seguimiento
        $this->seguimiento = new DbField(
            $this, // Table
            'x_seguimiento', // Variable name
            'seguimiento', // Name
        ...
        $this->Fields['seguimiento'] = &$this->seguimiento;
        ...
        $this->fecha_registro->Nullable = false; // NOT NULL field
        ...
        $this->fecha_registro->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "visitas";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VisitasList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "VisitasView" => $Language->phrase("View"),
            "VisitasEdit" => $Language->phrase("Edit"),
            "VisitasAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "VisitasView",
            Config("API_ADD_ACTION") => "VisitasAdd",
            Config("API_EDIT_ACTION") => "VisitasEdit",
            Config("API_DELETE_ACTION") => "VisitasDelete",
            Config("API_LIST_ACTION") => "VisitasList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VisitasView", $parm);
        } else {
            $url = $this->keyUrl("VisitasView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VisitasEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VisitasList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VisitasAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VisitasList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("VisitasDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->producto->EditValue = $this->producto->CurrentValue;
