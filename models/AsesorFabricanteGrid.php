 ...
 * Page class
 */
class AsesorFabricanteGrid extends AsesorFabricante
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AsesorFabricanteGrid";
    ...
    public $FormName = "fasesor_fabricantegrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "AsesorFabricanteGrid";
    ...
    protected function editRow()
    {
        ...
        // Check referential integrity for master table 'asesor'
        $detailKeys = [];
        $keyValue = $rsnew['asesor'] ?? $rsold['asesor'];
        $detailKeys['asesor'] = $keyValue;
        ...
        if (!$validMasterRecord) {
            $relatedRecordMsg = str_replace("%t", "asesor", $Language->phrase("RelatedRecordRequired"));
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "asesor") {
            $this->asesor->Visible = true; // Need to insert foreign key
            $this->asesor->CurrentValue = $this->asesor->getSessionValue();
        }
        ...
        // Check referential integrity for master table 'asesor_fabricante'
        $validMasterRecord = true;
        $detailKeys = [];
        $detailKeys["asesor"] = $this->asesor->getSessionValue();
        $masterTable = Container("asesor");
        $masterFilter = $this->getMasterFilter($masterTable, $detailKeys);
        if (!EmptyValue($masterFilter)) {
            $rsmaster = $masterTable->loadRs($masterFilter)->fetch();
    ...
    protected function getAddRow()
    {
        ...
        if ($this->asesor->getSessionValue() != "") {
            $rsnew['asesor'] = $this->asesor->getSessionValue();
        }
        return $rsnew;
    }
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['asesor'])) { // asesor
            $this->asesor->setFormValue($row['asesor']);
        }
    }
