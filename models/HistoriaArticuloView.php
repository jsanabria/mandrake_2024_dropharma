 ...
 * Page class
 */
class HistoriaArticuloView extends HistoriaArticulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HistoriaArticuloView";
    ...
    // CSS class/style
    public $CurrentPageName = "HistoriaArticuloView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idx") ?? Route("idx")) !== null) {
            ...
            $returnUrl = "HistoriaArticuloList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->idx->CurrentValue, $this->CurrentRow['idx'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "HistoriaArticuloList"; // No matching record, return to list
                    } else {
