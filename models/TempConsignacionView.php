 ...
 * Page class
 */
class TempConsignacionView extends TempConsignacion
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TempConsignacionView";
    ...
    // CSS class/style
    public $CurrentPageName = "TempConsignacionView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "TempConsignacionList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "TempConsignacionList"; // No matching record, return to list
                    } else {
