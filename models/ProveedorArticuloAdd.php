 ...
 * Page class
 */
class ProveedorArticuloAdd extends ProveedorArticulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProveedorArticuloAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ProveedorArticuloAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("ProveedorArticuloList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "ProveedorArticuloList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "ProveedorArticuloView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "ProveedorArticuloList") {
                            ...
                            $returnUrl = "ProveedorArticuloList"; // Return list page content
                        }
                    }
    ...
    public function renderRow()
    {
        ...
        // codigo_proveedor
        $this->codigo_proveedor->RowCssClass = "row";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ProveedorArticuloList"), "", $this->TableVar, true);
