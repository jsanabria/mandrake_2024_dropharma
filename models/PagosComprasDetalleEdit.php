 ...
 * Page class
 */
class PagosComprasDetalleEdit extends PagosComprasDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PagosComprasDetalleEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "PagosComprasDetalleEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("PagosComprasDetalleList"); // Return to list page
                        return;
    ...
    protected function getEditRow($rsold)
    {
        ...
        // pagos_compras
        $this->pagos_compras->setDbValueDef($rsnew, $this->pagos_compras->CurrentValue, $this->pagos_compras->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['pagos_compras'])) { // pagos_compras
            $this->pagos_compras->CurrentValue = $row['pagos_compras'];
        }
