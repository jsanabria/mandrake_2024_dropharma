 ...
 * Page class
 */
class ContLotesPagosDetalleDelete extends ContLotesPagosDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContLotesPagosDetalleDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ContLotesPagosDetalleDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ContLotesPagosDetalleList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ContLotesPagosDetalleList"); // Return to list
                return;
            }
        }
