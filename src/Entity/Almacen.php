...
/**
 * Entity class for "almacen" table
 */
#[Entity]
#[Table(name: "almacen")]
class Almacen extends AbstractEntity
{
    #[Id]
    ...
    public function setMovimiento(?string $value): static
    {
        if (!in_array($value, ["S", "N"])) {
            throw new \InvalidArgumentException("Invalid 'movimiento' value");
        }
