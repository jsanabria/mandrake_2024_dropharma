...
/**
 * Entity class for "pagos_compras" table
 */
#[Entity]
#[Table(name: "pagos_compras")]
class PagosCompra extends AbstractEntity
{
    #[Id]
    ...
    {
        return HtmlDecode($this->anexos);
    }

    public function setAnexos(?string $value): static
    {
        $this->anexos = RemoveXss($value);
        return $this;
    }
