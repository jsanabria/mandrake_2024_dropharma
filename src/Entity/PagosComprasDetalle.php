...
/**
 * Entity class for "pagos_compras_detalle" table
 */
#[Entity]
#[Table(name: "pagos_compras_detalle")]
class PagosComprasDetalle extends AbstractEntity
{
    #[Id]
    ...
    #[Column(name: "pagos_compras", type: "integer")]
    private int $pagosCompras;
    ...
    public function getPagosCompras(): int
    {
        return $this->pagosCompras;
    }

    public function setPagosCompras(int $value): static
    {
        $this->pagosCompras = $value;
        return $this;
    }
