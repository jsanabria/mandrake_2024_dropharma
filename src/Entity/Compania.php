...
/**
 * Entity class for "compania" table
 */
#[Entity]
#[Table(name: "compania")]
class Compania extends AbstractEntity
{
    #[Id]
    ...
    #[Column(name: "agente_retencion", type: "string", nullable: true)]
    ...
    public function setAgenteRetencion(?string $value): static
    {
        if (!in_array($value, ["S", "N"])) {
            throw new \InvalidArgumentException("Invalid 'agente_retencion' value");
        }
