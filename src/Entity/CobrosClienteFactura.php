...
/**
 * Entity class for "cobros_cliente_factura" table
 */
#[Entity]
#[Table(name: "cobros_cliente_factura")]
class CobrosClienteFactura extends AbstractEntity
{
    #[Id]
    ...
    #[Column(name: "cobros_cliente", type: "integer", nullable: true)]
