...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/mandrake.css", // Project stylesheet file name
    ...
    "SIDEBAR_CLASS" => "main-sidebar sidebar-dark-primary", // CSS class(es) for sidebar
    "NAVBAR_CLASS" => "main-header navbar navbar-expand navbar-light border-bottom-0", // CSS class(es) for navbar
    ...
    "AES_ENCRYPTION_KEY" => "a1px1k2TTZd8aJDip0OoiHLcvOUdxOl+jNcnKY8zzVk=", // AES encryption key (base64 encoded)
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\mandrake\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\mandrake\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-3e26d9a5-1a72-49c3-8e7a-1ddf1ccb6455", // Export folder
    ...
    "ADMIN_PASSWORD" => "dongato", // Administrator password
    ...
    "UPLOAD_DEST_PATH" => "carpetacarga/", // Upload destination path (relative to app root)
    ...
    "MAX_FILE_SIZE" => 1000000, // Max file size
    ...
    "EXPORT_ALL_TIME_LIMIT" => 240, // Export all records time limit
