<?php 
    ...
    // 2. Encabezado de la página, botón de acción y tabla responsiva (Estilo clientes_ims.php)
    $out .= <<<HTML
    ...
    <div class="table-responsive">
        <table class="table table-hover table-striped align-middle" style="font-size: 0.875rem; border: 1px solid #dee2e6;">
            <thead class="table-light text-uppercase text-nowrap" style="font-size: 0.75rem; letter-spacing: 0.5px;">
                <tr>
                    <th scope="col" style="width: 15%;">Laboratorio</th>
                    <th scope="col" style="width: 25%;">Artículo</th>
                    <th scope="col" style="width: 10%;">Código</th>
                    <th scope="col" style="width: 12%;">Código Barra</th>
                    <th scope="col" style="width: 10%;">Unidad Medida</th>
                    <th scope="col" style="width: 8%;" class="text-end">Entradas</th>
                    <th scope="col" style="width: 8%;" class="text-end">Salida</th>
                    <th scope="col" style="width: 8%;" class="text-end">Existencia</th>
                    <th scope="col" style="width: 8%;" class="text-end">Costo C/U</th>
                    <th scope="col" style="width: 8%;" class="text-end">Precio C/U</th>
                </tr>
            </thead>
            <tbody>
HTML;
...
HTML;
    ...
    $out .= <<<HTML
            <tr>
                <th colspan="10" class="text-end table-light py-3 pe-4 text-secondary">
