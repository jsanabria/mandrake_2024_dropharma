...
$tasa_usd = $_REQUEST["tasa_usd"];
$moneda = "Bs."; // trim($_REQUEST["moneda"]) == "" ? "USD" : $_REQUEST["moneda"];
			  		...
			  		if(trim($value) != "") {
			  			...
			  			if(count($arr2) > 2) {
					    	...
					    	*/
					    	...
					    	if($arr2[5] == "USD") $monto_usd = $monto_moneda * $tasa_usd; // $monto_bs / $tasa_usd;
					    	else $monto_usd = $monto_moneda;
					  		/////////////////
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if(parseFloat($("#x_pago").val()) == 0.00 || parseFloat($("#monto").val()) == 0.00 || parseFloat($("#x_pago").val()) < parseFloat($("#monto").val())) { 
			...
			$("#x_saldo_0").val(parseFloat($("#monto").val()) - parseFloat($("#x_pago").val()));
		}
		else {
