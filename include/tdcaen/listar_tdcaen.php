...
/*
$html = $sql;
die(json_encode($html, JSON_UNESCAPED_UNICODE));
*/
...
$sql = "SELECT 
          ...
          z.descuento, z.costo_unidad AS costo, z.costo as total, z.lote, z.fecha_vencimiento  
        FROM 
          entradas_salidas AS z 
          INNER JOIN articulo AS a ON a.id = z.articulo 
          LEFT OUTER JOIN fabricante AS b ON b.Id = a.fabricante 
...
// die(json_encode($sql3, JSON_UNESCAPED_UNICODE)); 
    ...
    $i++;
      ...
      $html .= '<tr><td colspan="6"> <center><b>Registros ' . $i-1 . ' de ' . $cantidad . '</b></center> </td></tr>';
