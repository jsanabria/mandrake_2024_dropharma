<?php 
	...
	$out .= '<table class="table table-hover table-bordered">';
	  $out .= '<thead>';
		$out .= '<tr>';
		  ...
		  $out .= '<th scope="col">COSTO UNIDAD</th>';
	...
	$out .= '<tr>
				<th colspan="13" class="text-right">Art&iacute;culos: ' . number_format($contar, 0, "", ".") . '</th>
			</tr>';
  	  $out .= '</tbody>';
	$out .= '</table>';
?>