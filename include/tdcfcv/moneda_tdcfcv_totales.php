...
if($row = mysqli_fetch_array($rs)) {
	...
	*/
	...
	$sql = "SELECT nro_documento FROM salidas WHERE id = $pedido;";
	$rs = mysqli_query($link, $sql);
	$row = mysqli_fetch_array($rs);
	...
	$sql = "INSERT INTO audittrail
		...
		VALUES (NULL, '" . date("Y-m-d H:i:s") . "', 'Actualiza moneda y/o tasa del dia en Factura de Compra NRO $nro_documento', '$username', 'U', 'view_out_tdcfcc', 'id', '$pedido', '$moneda', '$tasa_usd');";
	mysqli_query($link, $sql);
