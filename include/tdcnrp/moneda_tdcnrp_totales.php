...
if($row = mysqli_fetch_array($rs)) {
	...
	$sql = "INSERT INTO audittrail
		...
		VALUES (NULL, '" . date("Y-m-d H:i:s") . "', 'Actualiza moneda y/o tasa del dia en Nota de Recepcion NRO $nro_documento', '$username', 'U', 'view_in_tdcnrp', 'id', '$pedido', '$moneda', '$tasa_usd');";
	mysqli_query($link, $sql);
