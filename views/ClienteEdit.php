...
<?= $Page->Pager->render() ?>
<?php } ?>
<form name="fclienteedit" id="fclienteedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
<script>
...
<span id="el_cliente_ciudad">
    <select
        ...
        data-select2-id="fclienteedit_x_ciudad"
        data-table="cliente"
        data-field="x_ciudad"
...
loadjs.ready("fclienteedit", function() {
    var options = { name: "x_ciudad", selectId: "fclienteedit_x_ciudad" };
    if (fclienteedit.lists.ciudad?.lookupOptions.length) {
        options.data = { id: "x_ciudad", form: "fclienteedit" };
    } else {
        options.ajax = { id: "x_ciudad", form: "fclienteedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_cliente_tipo_cliente">
    <select
        ...
        data-select2-id="fclienteedit_x_tipo_cliente"
        <?php } ?>
        data-table="cliente"
...
<script>
loadjs.ready("fclienteedit", function() {
    var options = { name: "x_tipo_cliente", selectId: "fclienteedit_x_tipo_cliente" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fclienteedit.lists.tipo_cliente?.lookupOptions.length) {
        options.data = { id: "x_tipo_cliente", form: "fclienteedit" };
    } else {
        options.ajax = { id: "x_tipo_cliente", form: "fclienteedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_cliente_tarifa">
    <select
        ...
        data-select2-id="fclienteedit_x_tarifa"
        <?php } ?>
        data-table="cliente"
        data-field="x_tarifa"
...
<script>
loadjs.ready("fclienteedit", function() {
    var options = { name: "x_tarifa", selectId: "fclienteedit_x_tarifa" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fclienteedit.lists.tarifa?.lookupOptions.length) {
        options.data = { id: "x_tarifa", form: "fclienteedit" };
    } else {
        options.ajax = { id: "x_tarifa", form: "fclienteedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_cliente_consignacion">
    <select
        ...
        data-select2-id="fclienteedit_x_consignacion"
        <?php } ?>
        data-table="cliente"
...
<script>
loadjs.ready("fclienteedit", function() {
    var options = { name: "x_consignacion", selectId: "fclienteedit_x_consignacion" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fclienteedit.lists.consignacion?.lookupOptions.length) {
        options.data = { id: "x_consignacion", form: "fclienteedit" };
    } else {
        options.ajax = { id: "x_consignacion", form: "fclienteedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_cliente_cuenta">
    <select
        ...
        data-select2-id="fclienteedit_x_cuenta"
        data-table="cliente"
        data-field="x_cuenta"
...
<script>
loadjs.ready("fclienteedit", function() {
    var options = { name: "x_cuenta", selectId: "fclienteedit_x_cuenta" };
    if (fclienteedit.lists.cuenta?.lookupOptions.length) {
        options.data = { id: "x_cuenta", form: "fclienteedit" };
    } else {
        options.ajax = { id: "x_cuenta", form: "fclienteedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options = Object.assign({}, ew.modalLookupOptions, options, ew.vars.tables.cliente.fields.cuenta.modalLookupOptions);
    ew.createModalLookup(options);
});
</script>
</span>
...
<span id="el_cliente_activo">
    <select
        ...
        data-select2-id="fclienteedit_x_activo"
        <?php } ?>
        data-table="cliente"
        data-field="x_activo"
...
<script>
loadjs.ready("fclienteedit", function() {
    var options = { name: "x_activo", selectId: "fclienteedit_x_activo" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fclienteedit.lists.activo?.lookupOptions.length) {
        options.data = { id: "x_activo", form: "fclienteedit" };
    } else {
        options.ajax = { id: "x_activo", form: "fclienteedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<input type="hidden" name="fa_x_foto1" id= "fa_x_foto1" value="<?= (Post("fa_x_foto1") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_foto2" id= "fa_x_foto2" value="<?= (Post("fa_x_foto2") == "0") ? "0" : "1" ?>">
...
<span id="el_cliente_dias_credito">
    <select
        ...
        data-select2-id="fclienteedit_x_dias_credito"
        <?php } ?>
        data-table="cliente"
...
<script>
loadjs.ready("fclienteedit", function() {
    var options = { name: "x_dias_credito", selectId: "fclienteedit_x_dias_credito" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fclienteedit.lists.dias_credito?.lookupOptions.length) {
        options.data = { id: "x_dias_credito", form: "fclienteedit" };
    } else {
        options.ajax = { id: "x_dias_credito", form: "fclienteedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fclienteedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fclienteedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
...
loadjs.ready("load", function () {
    ...
    // Función de formateo (igual a la anterior)
