...
<form name="flogin" id="flogin" class="ew-form ew-login-form" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
...
loadjs.ready("load", function () {
    ...
    $("#cia").change(function() {
    	window.location.replace("db_change.php?db=" + $("#cia").val());
    });
});
</script>
