...
<?php } ?>
<div id="gmp_grupo_funciones" class="card-body ew-grid-middle-panel <?= $Page->TableContainerClass ?>" style="<?= $Page->TableContainerStyle ?>">
<?php if ($Page->TotalRecords > 0 || $Page->isGridEdit() || $Page->isMultiEdit()) { ?>
<table id="tbl_grupo_funcioneslist" class="<?= $Page->TableClass ?>"><!-- .ew-table -->
<thead>
...
<?php if ($Page->funcion->Visible) { // funcion ?>
        <th data-name="funcion" class="<?= $Page->funcion->headerCellClass() ?>"><div id="elh_grupo_funciones_funcion" class="grupo_funciones_funcion"><?= $Page->renderFieldHeader($Page->funcion) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_grupo_funciones_funcion" class="el_grupo_funciones_funcion">
