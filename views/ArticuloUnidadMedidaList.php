...
<?php } ?>
<?php if (!$Page->IsModal) { ?>
<form name="farticulo_unidad_medidasrch" id="farticulo_unidad_medidasrch" class="ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>" autocomplete="off">
<div id="farticulo_unidad_medidasrch_search_panel" class="mb-2 mb-sm-0 <?= $Page->SearchPanelClass ?>"><!-- .ew-search-panel -->
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { articulo_unidad_medida: currentTable } });
var currentForm;
var farticulo_unidad_medidasrch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready(["wrapper", "head"], function () {
    let $ = jQuery,
    ...
    let form = new ew.FormBuilder()
        .setId("farticulo_unidad_medidasrch")
        .setPageId("list")
    ...
    <div class="col-sm-auto px-0 pe-sm-2">
        <div class="ew-basic-search input-group">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <button type="button" class="dropdown-item<?= $Page->BasicSearch->getType() == "" ? " active" : "" ?>" form="farticulo_unidad_medidasrch" data-ew-action="search-type"><?= $Language->phrase("QuickSearchAuto") ?></button>
                <button type="button" class="dropdown-item<?= $Page->BasicSearch->getType() == "=" ? " active" : "" ?>" form="farticulo_unidad_medidasrch" data-ew-action="search-type" data-search-type="="><?= $Language->phrase("QuickSearchExact") ?></button>
                <button type="button" class="dropdown-item<?= $Page->BasicSearch->getType() == "AND" ? " active" : "" ?>" form="farticulo_unidad_medidasrch" data-ew-action="search-type" data-search-type="AND"><?= $Language->phrase("QuickSearchAll") ?></button>
                <button type="button" class="dropdown-item<?= $Page->BasicSearch->getType() == "OR" ? " active" : "" ?>" form="farticulo_unidad_medidasrch" data-ew-action="search-type" data-search-type="OR"><?= $Language->phrase("QuickSearchAny") ?></button>
            </div>
        </div>
    </div>
...
<?php } ?>
<div id="gmp_articulo_unidad_medida" class="card-body ew-grid-middle-panel <?= $Page->TableContainerClass ?>" style="<?= $Page->TableContainerStyle ?>">
<?php if ($Page->TotalRecords > 0 || $Page->isGridEdit() || $Page->isMultiEdit()) { ?>
<table id="tbl_articulo_unidad_medidalist" class="<?= $Page->TableClass ?>"><!-- .ew-table -->
<thead>
...
<?php if ($Page->unidad_medida->Visible) { // unidad_medida ?>
        <th data-name="unidad_medida" class="<?= $Page->unidad_medida->headerCellClass() ?>"><div id="elh_articulo_unidad_medida_unidad_medida" class="articulo_unidad_medida_unidad_medida"><?= $Page->renderFieldHeader($Page->unidad_medida) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_articulo_unidad_medida_unidad_medida" class="el_articulo_unidad_medida_unidad_medida">
    <select
...
<input type="hidden" data-table="articulo_unidad_medida" data-field="x_unidad_medida" data-hidden="1" data-old name="o<?= $Page->RowIndex ?>_unidad_medida" id="o<?= $Page->RowIndex ?>_unidad_medida" value="<?= HtmlEncode($Page->unidad_medida->OldValue) ?>">
<?php } ?>
