...
if(isset($_REQUEST["pedido"])) { 
    ...
    $sql = "SELECT cliente, tipo_documento, nota, tasa_dia, moneda, dias_credito, lista_pedido, documento, nro_documento FROM salidas WHERE id = $pedido;";
...
<div class="row">
  ...
  <div class="col-sm-2">
      <?php
      echo '<strong>D&iacute;as de Cr&eacute;dito</strong>';
      ?>
  </div>
