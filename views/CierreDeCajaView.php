...
<?php } ?>
<?php } ?>
<form name="fcierre_de_cajaview" id="fcierre_de_cajaview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
