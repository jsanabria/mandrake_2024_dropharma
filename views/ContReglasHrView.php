...
<?php } ?>
<?php } ?>
<form name="fcont_reglas_hrview" id="fcont_reglas_hrview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
