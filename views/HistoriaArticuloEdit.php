...
// Page object
$HistoriaArticuloEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fhistoria_articuloedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fhistoria_articuloedit = currentForm = new ew.Form("fhistoria_articuloedit", "edit");
    ...
    fhistoria_articuloedit.addFields([
    ...
    // Validate form
    fhistoria_articuloedit.validate = function () {
    ...
    // Form_CustomValidate
    fhistoria_articuloedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fhistoria_articuloedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fhistoria_articuloedit.lists.fabricante = <?= $Page->fabricante->toClientList($Page) ?>;
    fhistoria_articuloedit.lists.articulo = <?= $Page->articulo->toClientList($Page) ?>;
    fhistoria_articuloedit.lists.proveedor = <?= $Page->proveedor->toClientList($Page) ?>;
    fhistoria_articuloedit.lists.almacen = <?= $Page->almacen->toClientList($Page) ?>;
    fhistoria_articuloedit.lists.tipo_documento = <?= $Page->tipo_documento->toClientList($Page) ?>;
    fhistoria_articuloedit.lists.usuario = <?= $Page->usuario->toClientList($Page) ?>;
    loadjs.done("fhistoria_articuloedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="fhistoria_articuloedit" id="fhistoria_articuloedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="historia_articulo" data-field="x_id" data-hidden="1" name="o_id" id="o_id" value="<?= HtmlEncode($Page->id->OldValue ?? $Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fhistoria_articuloedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fhistoria_articuloedit", "x_fecha", {"ignoreReadonly":true,"useCurrent":false,"format":7});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fhistoria_articuloedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fhistoria_articuloedit", "x_fecha_vencimiento", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
