...
$Page->showMessage();
?>
<form name="fcobros_clientedelete" id="fcobros_clientedelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
