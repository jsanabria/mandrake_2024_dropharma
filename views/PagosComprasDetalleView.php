...
<?php } ?>
<?php } ?>
<form name="fpagos_compras_detalleview" id="fpagos_compras_detalleview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
var currentForm;
var fpagos_compras_detalleview;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fpagos_compras_detalleview")
        .setPageId("view")
        .build();
    window[form.id] = form;
    currentForm = form;
...
<?php if ($Page->referencia->Visible) { // referencia ?>
    <tr id="r_referencia"<?= $Page->referencia->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pagos_compras_detalle_referencia"><?= $Page->referencia->caption() ?></span></td>
...
<?php if ($Page->monto_moneda->Visible) { // monto_moneda ?>
    <tr id="r_monto_moneda"<?= $Page->monto_moneda->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pagos_compras_detalle_monto_moneda"><?= $Page->monto_moneda->caption() ?></span></td>
...
<?php if ($Page->moneda->Visible) { // moneda ?>
    <tr id="r_moneda"<?= $Page->moneda->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pagos_compras_detalle_moneda"><?= $Page->moneda->caption() ?></span></td>
...
<?php if ($Page->tasa_moneda->Visible) { // tasa_moneda ?>
    <tr id="r_tasa_moneda"<?= $Page->tasa_moneda->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pagos_compras_detalle_tasa_moneda"><?= $Page->tasa_moneda->caption() ?></span></td>
...
<?php if ($Page->monto_bs->Visible) { // monto_bs ?>
    <tr id="r_monto_bs"<?= $Page->monto_bs->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pagos_compras_detalle_monto_bs"><?= $Page->monto_bs->caption() ?></span></td>
...
<?php if ($Page->tasa_usd->Visible) { // tasa_usd ?>
    <tr id="r_tasa_usd"<?= $Page->tasa_usd->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pagos_compras_detalle_tasa_usd"><?= $Page->tasa_usd->caption() ?></span></td>
...
<?php if ($Page->monto_usd->Visible) { // monto_usd ?>
    <tr id="r_monto_usd"<?= $Page->monto_usd->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pagos_compras_detalle_monto_usd"><?= $Page->monto_usd->caption() ?></span></td>
...
<?php if ($Page->banco->Visible) { // banco ?>
    <tr id="r_banco"<?= $Page->banco->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pagos_compras_detalle_banco"><?= $Page->banco->caption() ?></span></td>
