...
window.Tabulator || loadjs([
    ew.PATH_BASE + "css/<?= CssFile("tabulator_bootstrap5.css", false) ?>?v=24.16.8",
    ew.PATH_BASE + "js/tabulator.js?v=24.16.8"
], "tabulator");
</script>
<style>
main .tooltip {
...
?>
<main>
<form name="fuserpriv" id="fuserpriv" class="ew-form ew-user-priv-form w-100" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
...
<script>
ew.ready(["load", "tabulator"], ew.PATH_BASE + "js/userpriv.js?v=24.16.8");
</script>
