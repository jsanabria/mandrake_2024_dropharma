...
if(isset($_REQUEST["pedido"])) {
	...
	$sql = "SELECT proveedor, tipo_documento, nota, tasa_dia FROM entradas WHERE id = $pedido;";
	$row = ExecuteRow($sql);
...
<script type="text/javascript">
  ...
  function sendProccess(i) {
    ...
    window.location.href = "ProcesarPedido?pedido=" + i + "&PorDesAct=" + PorDesAct;
  }
    ...
    <div class="col-sm-3">
      <div>
        <div class="row">
          ...
          <div class="col-sm-9 alert alert-info" role="alert">
            <h6>Monto en <?= (strtoupper($moneda)=="BS."?"Bs.":"USD") ?> </h6>
    ...
    <div class="col-sm-3">
      <div>
        <div class="row">
          ...
          <div class="col-sm-9 alert alert-info" role="alert">
            <h6>Monto <?= (strtoupper($moneda)=="BS."?"USD":"Bs.") ?></h6>
...
<script type="text/javascript">
  ...
  function myCalc(i) {
    ...
    var costoFull = parseFloat($("#x" + i + "_costoFull").val());
    var descuento = parseFloat($("#x" + i + "_descuento").val());
    var costo = 0;
    var total = 0;

    costo = costoFull - (costoFull*(descuento/100));
