...
?>
<script>
ew.deepAssign(ew.vars, { tables: { view_in: <?= JsonEncode($Page->toClientVar()) ?> } });
</script>
<script>
...
<?php if ($Page->fabricante->Visible) { // fabricante ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->fabricante->headerCellClass() ?>"><div role="button" data-table="view_in" data-sort="<?= HtmlEncode($Page->fabricante->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->fabricante->getNextSort() ?>">
...
<?php if ($Page->articulo->Visible) { // articulo ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->articulo->headerCellClass() ?>"><div role="button" data-table="view_in" data-sort="<?= HtmlEncode($Page->articulo->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->articulo->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->lote->Visible) { // lote ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->lote->headerCellClass() ?>"><div role="button" data-table="view_in" data-sort="<?= HtmlEncode($Page->lote->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->lote->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->fecha_vencimiento->Visible) { // fecha_vencimiento ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->fecha_vencimiento->headerCellClass() ?>"><div role="button" data-table="view_in" data-sort="<?= HtmlEncode($Page->fecha_vencimiento->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->fecha_vencimiento->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->almacen->Visible) { // almacen ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->almacen->headerCellClass() ?>"><div role="button" data-table="view_in" data-sort="<?= HtmlEncode($Page->almacen->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->almacen->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->cantidad_articulo->Visible) { // cantidad_articulo ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->cantidad_articulo->headerCellClass() ?>"><div role="button" data-table="view_in" data-sort="<?= HtmlEncode($Page->cantidad_articulo->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->cantidad_articulo->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->precio_unidad_sin_desc->Visible) { // precio_unidad_sin_desc ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->precio_unidad_sin_desc->headerCellClass() ?>"><div role="button" data-table="view_in" data-sort="<?= HtmlEncode($Page->precio_unidad_sin_desc->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->precio_unidad_sin_desc->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->descuento->Visible) { // descuento ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->descuento->headerCellClass() ?>"><div role="button" data-table="view_in" data-sort="<?= HtmlEncode($Page->descuento->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->descuento->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->descuento2->Visible) { // descuento2 ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->descuento2->headerCellClass() ?>"><div role="button" data-table="view_in" data-sort="<?= HtmlEncode($Page->descuento2->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->descuento2->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->costo_unidad->Visible) { // costo_unidad ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->costo_unidad->headerCellClass() ?>"><div role="button" data-table="view_in" data-sort="<?= HtmlEncode($Page->costo_unidad->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->costo_unidad->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->costo->Visible) { // costo ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->costo->headerCellClass() ?>"><div role="button" data-table="view_in" data-sort="<?= HtmlEncode($Page->costo->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->costo->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->alicuota->Visible) { // alicuota ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->alicuota->headerCellClass() ?>"><div role="button" data-table="view_in" data-sort="<?= HtmlEncode($Page->alicuota->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->alicuota->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->check_ne->Visible) { // check_ne ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->check_ne->headerCellClass() ?>"><div role="button" data-table="view_in" data-sort="<?= HtmlEncode($Page->check_ne->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->check_ne->getNextSort() ?>">
            <div class="ew-table-header-btn">
