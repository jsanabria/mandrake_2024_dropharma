...
var currentForm;
var fview_audittrail_seniatadd;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fview_audittrail_seniatadd")
        .setPageId("add")
...
$Page->showMessage();
?>
<form name="fview_audittrail_seniatadd" id="fview_audittrail_seniatadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
...
loadjs.ready(["fview_audittrail_seniatadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fview_audittrail_seniatadd", "x_datetime", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->script->Visible) { // script ?>
    <div id="r_script"<?= $Page->script->rowAttributes() ?>>
        <label id="elh_view_audittrail_seniat_script" for="x_script" class="<?= $Page->LeftColumnClass ?>"><?= $Page->script->caption() ?><?= $Page->script->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->script->cellAttributes() ?>>
<span id="el_view_audittrail_seniat_script">
...
<?php if ($Page->user->Visible) { // user ?>
    <div id="r_user"<?= $Page->user->rowAttributes() ?>>
        <label id="elh_view_audittrail_seniat_user" class="<?= $Page->LeftColumnClass ?>"><?= $Page->user->caption() ?><?= $Page->user->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->user->cellAttributes() ?>>
<span id="el_view_audittrail_seniat_user">
<?php
if (IsRTL()) {
...
<selection-list hidden class="form-control" data-table="view_audittrail_seniat" data-field="x_user" data-input="sv_x_user" data-value-separator="<?= $Page->user->displayValueSeparatorAttribute() ?>" name="x_user" id="x_user" value="<?= HtmlEncode($Page->user->CurrentValue) ?>"></selection-list>
<?= $Page->user->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->user->getErrorMessage() ?></div>
<script>
loadjs.ready("fview_audittrail_seniatadd", function() {
    fview_audittrail_seniatadd.createAutoSuggest(Object.assign({"id":"x_user","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->user->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.view_audittrail_seniat.fields.user.autoSuggestOptions));
});
</script>
...
<?php if ($Page->_action->Visible) { // action ?>
    <div id="r__action"<?= $Page->_action->rowAttributes() ?>>
        <label id="elh_view_audittrail_seniat__action" for="x__action" class="<?= $Page->LeftColumnClass ?>"><?= $Page->_action->caption() ?><?= $Page->_action->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->_action->cellAttributes() ?>>
<span id="el_view_audittrail_seniat__action">
...
<?php if ($Page->_table->Visible) { // table ?>
    <div id="r__table"<?= $Page->_table->rowAttributes() ?>>
        <label id="elh_view_audittrail_seniat__table" for="x__table" class="<?= $Page->LeftColumnClass ?>"><?= $Page->_table->caption() ?><?= $Page->_table->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->_table->cellAttributes() ?>>
<span id="el_view_audittrail_seniat__table">
...
<?php if ($Page->field->Visible) { // field ?>
    <div id="r_field"<?= $Page->field->rowAttributes() ?>>
        <label id="elh_view_audittrail_seniat_field" for="x_field" class="<?= $Page->LeftColumnClass ?>"><?= $Page->field->caption() ?><?= $Page->field->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->field->cellAttributes() ?>>
<span id="el_view_audittrail_seniat_field">
<input type="<?= $Page->field->getInputTextType() ?>" name="x_field" id="x_field" data-table="view_audittrail_seniat" data-field="x_field" value="<?= $Page->field->EditValue ?>" size="30" maxlength="255" placeholder="<?= HtmlEncode($Page->field->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->field->formatPattern()) ?>"<?= $Page->field->editAttributes() ?> aria-describedby="x_field_help">
...
<?php if ($Page->keyvalue->Visible) { // keyvalue ?>
    <div id="r_keyvalue"<?= $Page->keyvalue->rowAttributes() ?>>
        <label id="elh_view_audittrail_seniat_keyvalue" for="x_keyvalue" class="<?= $Page->LeftColumnClass ?>"><?= $Page->keyvalue->caption() ?><?= $Page->keyvalue->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->keyvalue->cellAttributes() ?>>
<span id="el_view_audittrail_seniat_keyvalue">
<textarea data-table="view_audittrail_seniat" data-field="x_keyvalue" name="x_keyvalue" id="x_keyvalue" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->keyvalue->getPlaceHolder()) ?>"<?= $Page->keyvalue->editAttributes() ?> aria-describedby="x_keyvalue_help"><?= $Page->keyvalue->EditValue ?></textarea>
...
<?php if ($Page->oldvalue->Visible) { // oldvalue ?>
    <div id="r_oldvalue"<?= $Page->oldvalue->rowAttributes() ?>>
        <label id="elh_view_audittrail_seniat_oldvalue" for="x_oldvalue" class="<?= $Page->LeftColumnClass ?>"><?= $Page->oldvalue->caption() ?><?= $Page->oldvalue->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->oldvalue->cellAttributes() ?>>
<span id="el_view_audittrail_seniat_oldvalue">
<textarea data-table="view_audittrail_seniat" data-field="x_oldvalue" name="x_oldvalue" id="x_oldvalue" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->oldvalue->getPlaceHolder()) ?>"<?= $Page->oldvalue->editAttributes() ?> aria-describedby="x_oldvalue_help"><?= $Page->oldvalue->EditValue ?></textarea>
...
<?php if ($Page->newvalue->Visible) { // newvalue ?>
    <div id="r_newvalue"<?= $Page->newvalue->rowAttributes() ?>>
        <label id="elh_view_audittrail_seniat_newvalue" for="x_newvalue" class="<?= $Page->LeftColumnClass ?>"><?= $Page->newvalue->caption() ?><?= $Page->newvalue->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->newvalue->cellAttributes() ?>>
<span id="el_view_audittrail_seniat_newvalue">
<textarea data-table="view_audittrail_seniat" data-field="x_newvalue" name="x_newvalue" id="x_newvalue" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->newvalue->getPlaceHolder()) ?>"<?= $Page->newvalue->editAttributes() ?> aria-describedby="x_newvalue_help"><?= $Page->newvalue->EditValue ?></textarea>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fview_audittrail_seniatadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fview_audittrail_seniatadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
