...
<?php } ?>
<?php } ?>
<form name="fview_inview" id="fview_inview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->fabricante->Visible) { // fabricante ?>
    <tr id="r_fabricante"<?= $Page->fabricante->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_in_fabricante"><?= $Page->fabricante->caption() ?></span></td>
        <td data-name="fabricante"<?= $Page->fabricante->cellAttributes() ?>>
<span id="el_view_in_fabricante">
...
<?php if ($Page->articulo->Visible) { // articulo ?>
    <tr id="r_articulo"<?= $Page->articulo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_in_articulo"><?= $Page->articulo->caption() ?></span></td>
        <td data-name="articulo"<?= $Page->articulo->cellAttributes() ?>>
<span id="el_view_in_articulo">
...
<?php if ($Page->lote->Visible) { // lote ?>
    <tr id="r_lote"<?= $Page->lote->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_in_lote"><?= $Page->lote->caption() ?></span></td>
        <td data-name="lote"<?= $Page->lote->cellAttributes() ?>>
<span id="el_view_in_lote">
...
<?php if ($Page->fecha_vencimiento->Visible) { // fecha_vencimiento ?>
    <tr id="r_fecha_vencimiento"<?= $Page->fecha_vencimiento->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_in_fecha_vencimiento"><?= $Page->fecha_vencimiento->caption() ?></span></td>
        <td data-name="fecha_vencimiento"<?= $Page->fecha_vencimiento->cellAttributes() ?>>
<span id="el_view_in_fecha_vencimiento">
...
<?php if ($Page->almacen->Visible) { // almacen ?>
    <tr id="r_almacen"<?= $Page->almacen->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_in_almacen"><?= $Page->almacen->caption() ?></span></td>
        <td data-name="almacen"<?= $Page->almacen->cellAttributes() ?>>
<span id="el_view_in_almacen">
...
<?php if ($Page->cantidad_articulo->Visible) { // cantidad_articulo ?>
    <tr id="r_cantidad_articulo"<?= $Page->cantidad_articulo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_in_cantidad_articulo"><?= $Page->cantidad_articulo->caption() ?></span></td>
        <td data-name="cantidad_articulo"<?= $Page->cantidad_articulo->cellAttributes() ?>>
<span id="el_view_in_cantidad_articulo">
...
<?php if ($Page->precio_unidad_sin_desc->Visible) { // precio_unidad_sin_desc ?>
    <tr id="r_precio_unidad_sin_desc"<?= $Page->precio_unidad_sin_desc->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_in_precio_unidad_sin_desc"><?= $Page->precio_unidad_sin_desc->caption() ?></span></td>
        <td data-name="precio_unidad_sin_desc"<?= $Page->precio_unidad_sin_desc->cellAttributes() ?>>
<span id="el_view_in_precio_unidad_sin_desc">
...
<?php if ($Page->descuento->Visible) { // descuento ?>
    <tr id="r_descuento"<?= $Page->descuento->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_in_descuento"><?= $Page->descuento->caption() ?></span></td>
        <td data-name="descuento"<?= $Page->descuento->cellAttributes() ?>>
<span id="el_view_in_descuento">
...
<span id="el_view_in_costo_unidad">
...
<?php if ($Page->costo->Visible) { // costo ?>
    <tr id="r_costo"<?= $Page->costo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_in_costo"><?= $Page->costo->caption() ?></span></td>
        <td data-name="costo"<?= $Page->costo->cellAttributes() ?>>
<span id="el_view_in_costo">
...
<?php if ($Page->alicuota->Visible) { // alicuota ?>
    <tr id="r_alicuota"<?= $Page->alicuota->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_in_alicuota"><?= $Page->alicuota->caption() ?></span></td>
        <td data-name="alicuota"<?= $Page->alicuota->cellAttributes() ?>>
<span id="el_view_in_alicuota">
