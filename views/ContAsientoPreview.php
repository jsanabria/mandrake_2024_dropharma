...
?>
<script>
ew.deepAssign(ew.vars, { tables: { cont_asiento: <?= JsonEncode($Page->toClientVar()) ?> } });
</script>
<script>
...
<?php if ($Page->cuenta->Visible) { // cuenta ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->cuenta->headerCellClass() ?>"><div role="button" data-table="cont_asiento" data-sort="<?= HtmlEncode($Page->cuenta->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->cuenta->getNextSort() ?>">
...
<?php if ($Page->nota->Visible) { // nota ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->nota->headerCellClass() ?>"><div role="button" data-table="cont_asiento" data-sort="<?= HtmlEncode($Page->nota->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->nota->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->referencia->Visible) { // referencia ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->referencia->headerCellClass() ?>"><div role="button" data-table="cont_asiento" data-sort="<?= HtmlEncode($Page->referencia->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->referencia->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->debe->Visible) { // debe ?>
    <?php if (!$Page->debe->Sortable || !$Page->sortUrl($Page->debe)) { ?>
        <th class="<?= $Page->debe->headerCellClass() ?>"><?= $Page->debe->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->debe->headerCellClass() ?>"><div role="button" data-table="cont_asiento" data-sort="<?= HtmlEncode($Page->debe->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->debe->getNextSort() ?>">
            <div class="ew-table-header-btn">
                <span class="ew-table-header-caption"><?= $Page->debe->caption() ?></span>
                <span class="ew-table-header-sort"><?= $Page->debe->getSortIcon() ?></span>
            </div>
        </th>
    <?php } ?>
<?php } ?>
<?php if ($Page->haber->Visible) { // haber ?>
    <?php if (!$Page->haber->Sortable || !$Page->sortUrl($Page->haber)) { ?>
        <th class="<?= $Page->haber->headerCellClass() ?>"><?= $Page->haber->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->haber->headerCellClass() ?>"><div role="button" data-table="cont_asiento" data-sort="<?= HtmlEncode($Page->haber->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->haber->getNextSort() ?>">
            <div class="ew-table-header-btn">
                <span class="ew-table-header-caption"><?= $Page->haber->caption() ?></span>
                <span class="ew-table-header-sort"><?= $Page->haber->getSortIcon() ?></span>
            </div>
        </th>
    <?php } ?>
<?php } ?>
