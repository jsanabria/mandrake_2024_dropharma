...
$Page->showMessage();
?>
<form name="fusuarioadd" id="fusuarioadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
...
<span id="el_usuario_userlevelid">
    <select
        ...
        data-select2-id="fusuarioadd_x_userlevelid"
        <?php } ?>
        data-table="usuario"
...
loadjs.ready("fusuarioadd", function() {
    var options = { name: "x_userlevelid", selectId: "fusuarioadd_x_userlevelid" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fusuarioadd.lists.userlevelid?.lookupOptions.length) {
        options.data = { id: "x_userlevelid", form: "fusuarioadd" };
    } else {
        options.ajax = { id: "x_userlevelid", form: "fusuarioadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_usuario_asesor">
    <select
        ...
        data-select2-id="fusuarioadd_x_asesor"
        data-table="usuario"
        data-field="x_asesor"
...
<script>
loadjs.ready("fusuarioadd", function() {
    var options = { name: "x_asesor", selectId: "fusuarioadd_x_asesor" };
    if (fusuarioadd.lists.asesor?.lookupOptions.length) {
        options.data = { id: "x_asesor", form: "fusuarioadd" };
    } else {
        options.ajax = { id: "x_asesor", form: "fusuarioadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_usuario_cliente">
    <select
        ...
        data-select2-id="fusuarioadd_x_cliente"
        data-table="usuario"
...
<script>
loadjs.ready("fusuarioadd", function() {
    var options = { name: "x_cliente", selectId: "fusuarioadd_x_cliente" };
    if (fusuarioadd.lists.cliente?.lookupOptions.length) {
        options.data = { id: "x_cliente", form: "fusuarioadd" };
    } else {
        options.ajax = { id: "x_cliente", form: "fusuarioadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_usuario_proveedor">
    <select
        ...
        data-select2-id="fusuarioadd_x_proveedor"
        data-table="usuario"
...
<script>
loadjs.ready("fusuarioadd", function() {
    var options = { name: "x_proveedor", selectId: "fusuarioadd_x_proveedor" };
    if (fusuarioadd.lists.proveedor?.lookupOptions.length) {
        options.data = { id: "x_proveedor", form: "fusuarioadd" };
    } else {
        options.ajax = { id: "x_proveedor", form: "fusuarioadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_usuario_activo">
    <select
        ...
        data-select2-id="fusuarioadd_x_activo"
        <?php } ?>
        data-table="usuario"
        data-field="x_activo"
...
<script>
loadjs.ready("fusuarioadd", function() {
    var options = { name: "x_activo", selectId: "fusuarioadd_x_activo" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fusuarioadd.lists.activo?.lookupOptions.length) {
        options.data = { id: "x_activo", form: "fusuarioadd" };
    } else {
        options.ajax = { id: "x_activo", form: "fusuarioadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<?php
    if (in_array("usuario_master2", explode(",", $Page->getCurrentDetailTable())) && $usuario_master2->DetailAdd) {
?>
