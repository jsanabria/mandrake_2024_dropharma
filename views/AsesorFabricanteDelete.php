...
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fasesor_fabricantedelete")
        .setPageId("delete")
        .build();
    window[form.id] = form;
    currentForm = form;
...
$Page->showMessage();
?>
<form name="fasesor_fabricantedelete" id="fasesor_fabricantedelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
