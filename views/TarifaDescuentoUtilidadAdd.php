...
// Page object
$TarifaDescuentoUtilidadAdd = &$Page;
?>
<script>
...
var currentForm;
var ftarifa_descuento_utilidadadd;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("ftarifa_descuento_utilidadadd")
        .setPageId("add")
...
$Page->showMessage();
?>
<form name="ftarifa_descuento_utilidadadd" id="ftarifa_descuento_utilidadadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
...
<span id="el_tarifa_descuento_utilidad_fabricante">
    <select
        ...
        data-select2-id="ftarifa_descuento_utilidadadd_x_fabricante"
...
<script>
loadjs.ready("ftarifa_descuento_utilidadadd", function() {
    var options = { name: "x_fabricante", selectId: "ftarifa_descuento_utilidadadd_x_fabricante" };
    if (ftarifa_descuento_utilidadadd.lists.fabricante?.lookupOptions.length) {
        options.data = { id: "x_fabricante", form: "ftarifa_descuento_utilidadadd" };
    } else {
        options.ajax = { id: "x_fabricante", form: "ftarifa_descuento_utilidadadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="ftarifa_descuento_utilidadadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="ftarifa_descuento_utilidadadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
