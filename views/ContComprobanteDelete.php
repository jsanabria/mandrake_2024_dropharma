...
$Page->showMessage();
?>
<form name="fcont_comprobantedelete" id="fcont_comprobantedelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
