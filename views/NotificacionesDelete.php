...
$Page->showMessage();
?>
<form name="fnotificacionesdelete" id="fnotificacionesdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
