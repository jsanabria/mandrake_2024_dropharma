...
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fcont_centro_costo_mdkadd")
        .setPageId("add")
...
$Page->showMessage();
?>
<form name="fcont_centro_costo_mdkadd" id="fcont_centro_costo_mdkadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
...
<span id="el_cont_centro_costo_mdk_centro_padre_id">
    <select
        ...
        data-select2-id="fcont_centro_costo_mdkadd_x_centro_padre_id"
...
<script>
loadjs.ready("fcont_centro_costo_mdkadd", function() {
    var options = { name: "x_centro_padre_id", selectId: "fcont_centro_costo_mdkadd_x_centro_padre_id" };
    if (fcont_centro_costo_mdkadd.lists.centro_padre_id?.lookupOptions.length) {
        options.data = { id: "x_centro_padre_id", form: "fcont_centro_costo_mdkadd" };
    } else {
        options.ajax = { id: "x_centro_padre_id", form: "fcont_centro_costo_mdkadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fcont_centro_costo_mdkadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fcont_centro_costo_mdkadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
