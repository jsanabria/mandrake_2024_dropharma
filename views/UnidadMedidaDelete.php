...
$Page->showMessage();
?>
<form name="funidad_medidadelete" id="funidad_medidadelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
