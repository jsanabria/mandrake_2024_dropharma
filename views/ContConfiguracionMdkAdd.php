...
var currentForm;
var fcont_configuracion_mdkadd;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fcont_configuracion_mdkadd")
        .setPageId("add")
...
$Page->showMessage();
?>
<form name="fcont_configuracion_mdkadd" id="fcont_configuracion_mdkadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
...
<span id="el_cont_configuracion_mdk_cuenta_id">
    <select
        ...
        data-select2-id="fcont_configuracion_mdkadd_x_cuenta_id"
...
<script>
loadjs.ready("fcont_configuracion_mdkadd", function() {
    var options = { name: "x_cuenta_id", selectId: "fcont_configuracion_mdkadd_x_cuenta_id" };
    if (fcont_configuracion_mdkadd.lists.cuenta_id?.lookupOptions.length) {
        options.data = { id: "x_cuenta_id", form: "fcont_configuracion_mdkadd" };
    } else {
        options.ajax = { id: "x_cuenta_id", form: "fcont_configuracion_mdkadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fcont_configuracion_mdkadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fcont_configuracion_mdkadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
