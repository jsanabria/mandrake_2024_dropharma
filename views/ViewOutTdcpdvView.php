...
<?php } ?>
<?php } ?>
<form name="fview_out_tdcpdvview" id="fview_out_tdcpdvview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->nro_documento->Visible) { // nro_documento ?>
    <tr id="r_nro_documento"<?= $Page->nro_documento->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_nro_documento"><?= $Page->nro_documento->caption() ?></span></td>
...
<?php if ($Page->fecha->Visible) { // fecha ?>
    <tr id="r_fecha"<?= $Page->fecha->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_fecha"><?= $Page->fecha->caption() ?></span></td>
...
<?php if ($Page->cliente->Visible) { // cliente ?>
    <tr id="r_cliente"<?= $Page->cliente->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_cliente"><?= $Page->cliente->caption() ?></span></td>
...
<?php if ($Page->monto_total->Visible) { // monto_total ?>
    <tr id="r_monto_total"<?= $Page->monto_total->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_monto_total"><?= $Page->monto_total->caption() ?></span></td>
        <td data-name="monto_total"<?= $Page->monto_total->cellAttributes() ?>>
<span id="el_view_out_tdcpdv_monto_total">
...
<?php if ($Page->alicuota_iva->Visible) { // alicuota_iva ?>
    <tr id="r_alicuota_iva"<?= $Page->alicuota_iva->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_alicuota_iva"><?= $Page->alicuota_iva->caption() ?></span></td>
        <td data-name="alicuota_iva"<?= $Page->alicuota_iva->cellAttributes() ?>>
<span id="el_view_out_tdcpdv_alicuota_iva">
...
<?php if ($Page->iva->Visible) { // iva ?>
    <tr id="r_iva"<?= $Page->iva->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_iva"><?= $Page->iva->caption() ?></span></td>
        <td data-name="iva"<?= $Page->iva->cellAttributes() ?>>
<span id="el_view_out_tdcpdv_iva">
...
<?php if ($Page->total->Visible) { // total ?>
    <tr id="r_total"<?= $Page->total->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_total"><?= $Page->total->caption() ?></span></td>
...
<?php if ($Page->moneda->Visible) { // moneda ?>
    <tr id="r_moneda"<?= $Page->moneda->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_moneda"><?= $Page->moneda->caption() ?></span></td>
...
<?php if ($Page->descuento->Visible) { // descuento ?>
    <tr id="r_descuento"<?= $Page->descuento->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_descuento"><?= $Page->descuento->caption() ?></span></td>
...
<?php if ($Page->descuento2->Visible) { // descuento2 ?>
    <tr id="r_descuento2"<?= $Page->descuento2->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_descuento2"><?= $Page->descuento2->caption() ?></span></td>
...
<?php if ($Page->asesor->Visible) { // asesor ?>
    <tr id="r_asesor"<?= $Page->asesor->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_asesor"><?= $Page->asesor->caption() ?></span></td>
        <td data-name="asesor"<?= $Page->asesor->cellAttributes() ?>>
<span id="el_view_out_tdcpdv_asesor">
...
<?php if ($Page->lista_pedido->Visible) { // lista_pedido ?>
    <tr id="r_lista_pedido"<?= $Page->lista_pedido->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_lista_pedido"><?= $Page->lista_pedido->caption() ?></span></td>
...
<?php if ($Page->estatus->Visible) { // estatus ?>
    <tr id="r_estatus"<?= $Page->estatus->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_estatus"><?= $Page->estatus->caption() ?></span></td>
...
<?php if ($Page->nota->Visible) { // nota ?>
    <tr id="r_nota"<?= $Page->nota->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_nota"><?= $Page->nota->caption() ?></span></td>
...
<?php if ($Page->_username->Visible) { // username ?>
    <tr id="r__username"<?= $Page->_username->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv__username"><?= $Page->_username->caption() ?></span></td>
...
<?php if ($Page->tasa_dia->Visible) { // tasa_dia ?>
    <tr id="r_tasa_dia"<?= $Page->tasa_dia->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_tasa_dia"><?= $Page->tasa_dia->caption() ?></span></td>
        <td data-name="tasa_dia"<?= $Page->tasa_dia->cellAttributes() ?>>
<span id="el_view_out_tdcpdv_tasa_dia">
...
<?php if ($Page->dias_credito->Visible) { // dias_credito ?>
    <tr id="r_dias_credito"<?= $Page->dias_credito->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_dias_credito"><?= $Page->dias_credito->caption() ?></span></td>
...
<?php if ($Page->fecha_entrega->Visible) { // fecha_entrega ?>
    <tr id="r_fecha_entrega"<?= $Page->fecha_entrega->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_fecha_entrega"><?= $Page->fecha_entrega->caption() ?></span></td>
        <td data-name="fecha_entrega"<?= $Page->fecha_entrega->cellAttributes() ?>>
<span id="el_view_out_tdcpdv_fecha_entrega">
...
<?php if ($Page->fecha_bultos->Visible) { // fecha_bultos ?>
    <tr id="r_fecha_bultos"<?= $Page->fecha_bultos->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_fecha_bultos"><?= $Page->fecha_bultos->caption() ?></span></td>
        <td data-name="fecha_bultos"<?= $Page->fecha_bultos->cellAttributes() ?>>
<span id="el_view_out_tdcpdv_fecha_bultos">
...
<?php if ($Page->user_bultos->Visible) { // user_bultos ?>
    <tr id="r_user_bultos"<?= $Page->user_bultos->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_user_bultos"><?= $Page->user_bultos->caption() ?></span></td>
        <td data-name="user_bultos"<?= $Page->user_bultos->cellAttributes() ?>>
<span id="el_view_out_tdcpdv_user_bultos">
...
<?php if ($Page->fecha_despacho->Visible) { // fecha_despacho ?>
    <tr id="r_fecha_despacho"<?= $Page->fecha_despacho->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_fecha_despacho"><?= $Page->fecha_despacho->caption() ?></span></td>
        <td data-name="fecha_despacho"<?= $Page->fecha_despacho->cellAttributes() ?>>
<span id="el_view_out_tdcpdv_fecha_despacho">
...
<?php if ($Page->user_despacho->Visible) { // user_despacho ?>
    <tr id="r_user_despacho"<?= $Page->user_despacho->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_user_despacho"><?= $Page->user_despacho->caption() ?></span></td>
        <td data-name="user_despacho"<?= $Page->user_despacho->cellAttributes() ?>>
<span id="el_view_out_tdcpdv_user_despacho">
...
<?php if ($Page->consignacion->Visible) { // consignacion ?>
    <tr id="r_consignacion"<?= $Page->consignacion->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_consignacion"><?= $Page->consignacion->caption() ?></span></td>
...
<?php if ($Page->asesor_asignado->Visible) { // asesor_asignado ?>
    <tr id="r_asesor_asignado"<?= $Page->asesor_asignado->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_out_tdcpdv_asesor_asignado"><?= $Page->asesor_asignado->caption() ?></span></td>
