...
$Page->showMessage();
?>
<form name="fasesor_clientedelete" id="fasesor_clientedelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
