...
$Page->showMessage();
?>
<form name="farticuloadd" id="farticuloadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
...
<div class="ew-nav<?= $Page->MultiPages->containerClasses() ?>" id="pages_ArticuloAdd"><!-- multi-page tabs -->
...
<script>
loadjs.ready("farticuloadd", function() {
    farticuloadd.createAutoSuggest(Object.assign({"id":"x_presentacion","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->presentacion->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.articulo.fields.presentacion.autoSuggestOptions));
});
</script>
...
<span id="el_articulo_fabricante">
    <select
        ...
        data-select2-id="farticuloadd_x_fabricante"
        data-table="articulo"
...
<script>
loadjs.ready("farticuloadd", function() {
    var options = { name: "x_fabricante", selectId: "farticuloadd_x_fabricante" };
    if (farticuloadd.lists.fabricante?.lookupOptions.length) {
        options.data = { id: "x_fabricante", form: "farticuloadd" };
    } else {
        options.ajax = { id: "x_fabricante", form: "farticuloadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_articulo_articulo_inventario">
    <select
        ...
        data-select2-id="farticuloadd_x_articulo_inventario"
        <?php } ?>
        data-table="articulo"
...
<script>
loadjs.ready("farticuloadd", function() {
    var options = { name: "x_articulo_inventario", selectId: "farticuloadd_x_articulo_inventario" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (farticuloadd.lists.articulo_inventario?.lookupOptions.length) {
        options.data = { id: "x_articulo_inventario", form: "farticuloadd" };
    } else {
        options.ajax = { id: "x_articulo_inventario", form: "farticuloadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_articulo_activo">
    <select
        ...
        data-select2-id="farticuloadd_x_activo"
        <?php } ?>
        data-table="articulo"
        data-field="x_activo"
        data-page="1"
...
<script>
loadjs.ready("farticuloadd", function() {
    var options = { name: "x_activo", selectId: "farticuloadd_x_activo" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (farticuloadd.lists.activo?.lookupOptions.length) {
        options.data = { id: "x_activo", form: "farticuloadd" };
    } else {
        options.ajax = { id: "x_activo", form: "farticuloadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_articulo_alicuota">
    <select
        ...
        data-select2-id="farticuloadd_x_alicuota"
        <?php } ?>
        data-table="articulo"
...
<script>
loadjs.ready("farticuloadd", function() {
    var options = { name: "x_alicuota", selectId: "farticuloadd_x_alicuota" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (farticuloadd.lists.alicuota?.lookupOptions.length) {
        options.data = { id: "x_alicuota", form: "farticuloadd" };
    } else {
        options.ajax = { id: "x_alicuota", form: "farticuloadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_articulo_categoria">
    <select
        ...
        data-select2-id="farticuloadd_x_categoria"
        <?php } ?>
        data-table="articulo"
...
<script>
loadjs.ready("farticuloadd", function() {
    var options = { name: "x_categoria", selectId: "farticuloadd_x_categoria" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (farticuloadd.lists.categoria?.lookupOptions.length) {
        options.data = { id: "x_categoria", form: "farticuloadd" };
    } else {
        options.ajax = { id: "x_categoria", form: "farticuloadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_articulo_lista_pedido">
    <select
        ...
        data-select2-id="farticuloadd_x_lista_pedido"
        <?php } ?>
        data-table="articulo"
...
<script>
loadjs.ready("farticuloadd", function() {
    var options = { name: "x_lista_pedido", selectId: "farticuloadd_x_lista_pedido" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (farticuloadd.lists.lista_pedido?.lookupOptions.length) {
        options.data = { id: "x_lista_pedido", form: "farticuloadd" };
    } else {
        options.ajax = { id: "x_lista_pedido", form: "farticuloadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_articulo_categoria_madre">
    <select
        ...
        data-select2-id="farticuloadd_x_categoria_madre"
        data-table="articulo"
...
<script>
loadjs.ready("farticuloadd", function() {
    var options = { name: "x_categoria_madre", selectId: "farticuloadd_x_categoria_madre" };
    if (farticuloadd.lists.categoria_madre?.lookupOptions.length) {
        options.data = { id: "x_categoria_madre", form: "farticuloadd" };
    } else {
        options.ajax = { id: "x_categoria_madre", form: "farticuloadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_articulo_sub_categoria">
    <select
        ...
        data-select2-id="farticuloadd_x_sub_categoria"
        data-table="articulo"
...
<script>
loadjs.ready("farticuloadd", function() {
    var options = { name: "x_sub_categoria", selectId: "farticuloadd_x_sub_categoria" };
    if (farticuloadd.lists.sub_categoria?.lookupOptions.length) {
        options.data = { id: "x_sub_categoria", form: "farticuloadd" };
    } else {
        options.ajax = { id: "x_sub_categoria", form: "farticuloadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_articulo_tipo">
    <select
        ...
        data-select2-id="farticuloadd_x_tipo"
        <?php } ?>
        data-table="articulo"
        data-field="x_tipo"
        data-page="3"
...
<script>
loadjs.ready("farticuloadd", function() {
    var options = { name: "x_tipo", selectId: "farticuloadd_x_tipo" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (farticuloadd.lists.tipo?.lookupOptions.length) {
        options.data = { id: "x_tipo", form: "farticuloadd" };
    } else {
        options.ajax = { id: "x_tipo", form: "farticuloadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_articulo_unidad_medida_defecto">
    <select
        ...
        data-select2-id="farticuloadd_x_unidad_medida_defecto"
        <?php } ?>
        data-table="articulo"
...
<script>
loadjs.ready("farticuloadd", function() {
    var options = { name: "x_unidad_medida_defecto", selectId: "farticuloadd_x_unidad_medida_defecto" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (farticuloadd.lists.unidad_medida_defecto?.lookupOptions.length) {
        options.data = { id: "x_unidad_medida_defecto", form: "farticuloadd" };
    } else {
        options.ajax = { id: "x_unidad_medida_defecto", form: "farticuloadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_articulo_cantidad_por_unidad_medida">
    <select
        ...
        data-select2-id="farticuloadd_x_cantidad_por_unidad_medida"
        <?php } ?>
        data-table="articulo"
...
<script>
loadjs.ready("farticuloadd", function() {
    var options = { name: "x_cantidad_por_unidad_medida", selectId: "farticuloadd_x_cantidad_por_unidad_medida" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (farticuloadd.lists.cantidad_por_unidad_medida?.lookupOptions.length) {
        options.data = { id: "x_cantidad_por_unidad_medida", form: "farticuloadd" };
    } else {
        options.ajax = { id: "x_cantidad_por_unidad_medida", form: "farticuloadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_articulo_indexado">
    <select
        ...
        data-select2-id="farticuloadd_x_indexado"
        <?php } ?>
        data-table="articulo"
...
<script>
loadjs.ready("farticuloadd", function() {
    var options = { name: "x_indexado", selectId: "farticuloadd_x_indexado" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (farticuloadd.lists.indexado?.lookupOptions.length) {
        options.data = { id: "x_indexado", form: "farticuloadd" };
    } else {
        options.ajax = { id: "x_indexado", form: "farticuloadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<?php
    if (in_array("articulo_unidad_medida", explode(",", $Page->getCurrentDetailTable())) && $articulo_unidad_medida->DetailAdd) {
?>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="farticuloadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="farticuloadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
