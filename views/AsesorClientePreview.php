...
// Page object
$AsesorClientePreview = &$Page;
?>
<script>
ew.deepAssign(ew.vars, { tables: { asesor_cliente: <?= JsonEncode($Page->toClientVar()) ?> } });
</script>
<script>
...
<?php if ($Page->cliente->Visible) { // cliente ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->cliente->headerCellClass() ?>"><div role="button" data-table="asesor_cliente" data-sort="<?= HtmlEncode($Page->cliente->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->cliente->getNextSort() ?>">
