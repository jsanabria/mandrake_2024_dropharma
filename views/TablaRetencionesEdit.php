...
<?= $Page->Pager->render() ?>
<?php } ?>
<form name="ftabla_retencionesedit" id="ftabla_retencionesedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { tabla_retenciones: currentTable } });
var currentPageID = ew.PAGE_ID = "edit";
var currentForm;
var ftabla_retencionesedit;
...
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="ftabla_retencionesedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
