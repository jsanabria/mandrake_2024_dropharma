...
$Page->showMessage();
?>
<form name="fpagosdelete" id="fpagosdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
...
<?php if ($Page->banco->Visible) { // banco ?>
        <th class="<?= $Page->banco->headerCellClass() ?>"><span id="elh_pagos_banco" class="pagos_banco"><?= $Page->banco->caption() ?></span></th>
<?php } ?>
<?php if ($Page->banco_destino->Visible) { // banco_destino ?>
        <th class="<?= $Page->banco_destino->headerCellClass() ?>"><span id="elh_pagos_banco_destino" class="pagos_banco_destino"><?= $Page->banco_destino->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->moneda->Visible) { // moneda ?>
        <th class="<?= $Page->moneda->headerCellClass() ?>"><span id="elh_pagos_moneda" class="pagos_moneda"><?= $Page->moneda->caption() ?></span></th>
<?php } ?>
