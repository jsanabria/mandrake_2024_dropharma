...
$path = "/home2/dropharm/dropharmadm/ftpexportar/";
...
$sql = "SELECT 
			...
			'MED' AS grupo, 'MEDICINA' AS grupo_des, a.codigo_de_barra, (c.precio*$tasa) AS precio, 
			a.cantidad_en_mano AS existencia1, 0 AS existencia2, 0 AS existencia3, 0 AS existencia4, 
			((c.precio*$tasa) - ((c.precio*$tasa) * (a.descuento/100))) AS oferta, 'NO' AS regulado, 
