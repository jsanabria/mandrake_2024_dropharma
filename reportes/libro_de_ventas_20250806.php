...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->Cell(5, 4);
		$this->Cell(8, 4, "", "LTR", 0, 'R');
		$this->Cell(15, 4, "", "LTR", 0, 'L');
		$this->Cell(15, 4, "", "LTR", 0, 'L');
		$this->Cell(50, 4, "", "LTR", 0, 'L');
		$this->Cell(20, 4, "", "LTR", 0, 'C');
		...
		$this->Cell(17, 4, "TOTAL", "LTR", 0, 'R');
		$this->Cell(17, 4, "TOTAL", "LTR", 0, 'R');
		$this->Cell(61, 4, "", 1, 0, 'C');
		$this->Ln(4);

		$this->Cell(5, 4);
		$this->Cell(8, 4, "ID", "LBR", 0, 'L');
		$this->Cell(15, 4, "FECHA", "LBR", 0, 'L');
		$this->Cell(15, 4, "RIF", "LBR", 0, 'L');
		$this->Cell(50, 4, "NOMBRE O RAZON SOCIAL", "LBR", 0, 'L');
		$this->Cell(20, 4, "COMPROBANTE", "LBR", 0, 'C');
...
while($row = mysqli_fetch_array($rs))
{
	...
	$pdf->Cell(5, 4);
	$pdf->Cell(8, 4, $items+1, 0, 0, 'R');
	$pdf->Cell(15, 4, $row["fecha"], 0, 0, 'L');
	$pdf->Cell(15, 4, (trim($row["estatus"])=="ANULADO" ? "" : $row["ci_rif"]), 0, 0, 'L');
	$pdf->Cell(50, 4, (trim($row["estatus"])=="ANULADO" ? "ANULADA" : substr($row["cliente"], 0, 35)), 0, 0, 'L');
	$pdf->Cell(20, 4, $row["comprobante"], 0, 0, 'C');
	...
	$pdf->Cell(17, 4, strtolower($row["asesor"]), 0, 0, 'R');
