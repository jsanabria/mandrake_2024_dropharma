...
while($row = mysqli_fetch_array($rs))
{
	...
	$pdf->Cell(25, 3, number_format(($GLOBALS["moneda_default"]=="USD" ? $row["precio"]*$tasa_dia : $row["precio"]), 2, ",", "."), 0, 0, 'R');
	$pdf->Cell(17, 3, number_format(($GLOBALS["moneda_default"]=="USD" ? $row["precio"] : $row["precio"]/$tasa_dia), 2, ",", "."), 0, 0, 'R');
