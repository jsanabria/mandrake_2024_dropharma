...
class PDF extends FPDF
{
	...
	function EndReport($Total, $granTotal, $items, $xfecha, $yfecha)
	{
		...
		$this->Cell(250, 5, "MONTO TOTAL: "  . number_format($granTotal, 2, ".", ","), 0, 0, 'R');
		...
		while($row = mysqli_fetch_array($rs)) {
			$this->Ln();
			$this->Cell(220, 5, "ESTATUS: "  . $row["estatus"], 0, 0, 'R');
...
$sql = "SELECT 
			...
			a.iva, if(a.DOCUMENTO='NC', (-1)*a.total, a.total) total, a.estatus, a.moneda, a.id 
		FROM 
			salidas AS a 
