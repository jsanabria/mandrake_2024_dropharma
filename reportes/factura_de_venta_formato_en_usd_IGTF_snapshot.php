...
class PDF extends FPDF
{
	...
	function EndReport($id_invoice)
	{
        ...
        $this->SetFont('Arial','B',7);
        $this->Cell(10, 3, "", 0, 0, 'L');
        $this->Cell(125, 3, utf8_decode("IGTF Sujeto a Pago Recibido (Efectivo $) segun Art 1 GO 42339 17/03/2022."), 0, 0, 'L');
        $this->Cell(65, 3, utf8_decode("Tasa BCV del Dia: " . number_format($tasa_dia, 2, ",", ".")), 0, 0, 'R');
